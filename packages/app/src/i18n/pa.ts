export const dict = {
  ...
  "toast.file.notFound.title": "فائل نہیں لبھی",
  "notes.empty.title": "کوئی نوٹ کھلا نہیں",
  "notes.empty.description": "ایکسپلورر توں کوئی فائل چُنو یا Markdown نوٹ بناؤ۔",
  "notes.empty.create": "نوٹ بناؤ",
  "notes.create.prompt": "نوٹ دا ناں",
  "notes.create.defaultName": "بے ناں نوٹ",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "نوٹ بناؤ",
  "dialog.note.create.name.label": "نوٹ دا ناں",
  "dialog.note.create.name.placeholder": "میرے خیال",
  "dialog.note.create.confirm": "بناؤ",
  "dialog.note.create.error.exists": "ایس ناں دا نوٹ پہلاں توں موجود اے۔",
  "dialog.file.rename.title": "فائل دا ناں بدلو",
  "dialog.file.rename.name.label": "نواں ناں",
  "dialog.file.rename.confirm": "ناں بدلو",
  "dialog.file.rename.error.exists": "ایس ناں دی فائل پہلاں توں موجود اے۔",
  "dialog.file.delete.title": "فائل مکاؤ",
  "dialog.file.delete.description": "کی تسیں سچمچ «{{name}}» مکاؤنا چاہندے او؟ ایہ کم واپس نہیں ہو سکدا۔",
  "dialog.file.delete.confirm": "مکاؤ",
  "dialog.file.create.title": "نویں فائل",
  "dialog.file.create.name.label": "فائل دا ناں",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "بناؤ",
  "dialog.file.create.error.exists": "ایس ناں دی فائل پہلاں توں موجود اے۔",
  "dialog.directory.create.title": "نواں فولڈر",
  "dialog.directory.create.name.label": "فولڈر دا ناں",
  "dialog.directory.create.name.placeholder": "میرا فولڈر",
  "dialog.directory.create.confirm": "بناؤ",
  "dialog.directory.create.error.exists": "ایس ناں دا فولڈر پہلاں توں موجود اے۔",
  "dialog.directory.create.defaultName": "نواں فولڈر",
  "dialog.directory.rename.title": "فولڈر دا ناں بدلو",
  "dialog.directory.delete.title": "فولڈر مکاؤ",
  "dialog.directory.delete.description": "«{{name}}» تے اوہدا سارا مواد مکاؤ؟ ایہ کم واپس نہیں ہو سکدا۔",
  "dialog.directory.delete.confirm": "مکاؤ",
  "fileTree.action.rename": "ناں بدلو",
  "fileTree.action.delete": "مکاؤ",
  "fileTree.action.newFile": "نویں فائل",
  "fileTree.action.newDirectory": "نواں فولڈر",
  "fileTree.action.newSubDirectory": "نواں ذیلی فولڈر",
  "toast.file.rename.failed.title": "فائل دا ناں بدلن وچ ناکامی",
  "toast.file.delete.failed.title": "فائل مکاؤن وچ ناکامی",
  "toast.file.create.failed.title": "فائل بناؤن وچ ناکامی",
  "toast.directory.create.failed.title": "فولڈر بناؤن وچ ناکامی",
  "toast.directory.delete.failed.title": "فولڈر مکاؤن وچ ناکامی",
  "toast.directory.rename.failed.title": "فولڈر دا ناں بدلن وچ ناکامی",
  "settings.general.section.voice": "آواز",
  "settings.general.voice.deepgramKey.title": "Deepgram API کنجی",
  "settings.general.voice.deepgramKey.description": "پرامپٹ وچ بولی گئی گل نوں لکھت وچ بدلن لئی Deepgram ورتو۔",
  "settings.general.voice.deepgramKey.placeholder": "Deepgram کنجی چپکاؤ",
  "settings.general.voice.language.title": "آواز دی بولی",
  "settings.general.voice.language.description": "لکھت وچ بدلن لئی ورتیا جان والا Deepgram بولی کوڈ۔",
  "settings.general.voice.model.title": "آواز دا ماڈل",
  "settings.general.voice.model.description": "لکھت وچ بدلن لئی ورتیا جان والا Deepgram ماڈل۔",
  "settings.general.section.support": "خرابی دسو",
  "settings.support.row.bugEmail.title": "ای میل راہیں",
  "settings.support.row.bugEmail.description": "اپنی تنصیب دی معلومات نال Prisme ٹیم نوں سنیہا گھلو۔",
  "settings.support.row.bugEmail.action": "ای میل لکھو",
  "settings.support.row.bugIssue.title": "GitHub تے",
  "settings.support.row.bugIssue.description": "پہلاں توں بھریا GitHub فارم کھولو (GitHub کھاتا لوڑیدا اے)۔",
  "settings.support.row.bugIssue.action": "GitHub کھولو",
  "voice.action.start": "بولنا شروع کرو",
  "voice.action.stop": "بولنا روکو",
  "voice.state.recording": "ریکارڈنگ ہو رہی اے",
  "voice.error.missingKey.title": "Deepgram کنجی لوڑیدی اے",
  "voice.error.missingKey.description": "آواز نال لکھن لئی ترتیباں وچ اپنی Deepgram API کنجی شامل کرو۔",
  "voice.error.connection.title": "آواز دا کنکشن ناکام ہویا",
  "voice.error.connection.description": "Deepgram نال کنکشن ٹُٹ گیا۔",
  "voice.error.microphone.title": "مائیکروفون دستیاب نہیں",
  "voice.error.microphone.description": "Prisme تہاڈے مائیکروفون تک نہیں پہنچ سکیا۔",
}
