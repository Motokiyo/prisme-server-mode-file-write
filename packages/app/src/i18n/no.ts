...
export const dict = {
  ...
  "toast.file.notFound.title": "Fant ikke filen",
  "notes.empty.title": "Ingen notat åpent",
  "notes.empty.description": "Velg en fil i utforskeren, eller opprett et Markdown-notat.",
  "notes.empty.create": "Opprett notat",
  "notes.create.prompt": "Notatnavn",
  "notes.create.defaultName": "Notat uten tittel",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Opprett notat",
  "dialog.note.create.name.label": "Notatnavn",
  "dialog.note.create.name.placeholder": "Mine idéer",
  "dialog.note.create.confirm": "Opprett",
  "dialog.note.create.error.exists": "Det finnes allerede et notat med dette navnet.",
  "dialog.file.rename.title": "Gi filen nytt navn",
  "dialog.file.rename.name.label": "Nytt navn",
  "dialog.file.rename.confirm": "Gi nytt navn",
  "dialog.file.rename.error.exists": "Det finnes allerede en fil med dette navnet.",
  "dialog.file.delete.title": "Slett fil",
  "dialog.file.delete.description": "Er du sikker på at du vil slette «{{name}}»? Denne handlingen kan ikke angres.",
  "dialog.file.delete.confirm": "Slett",
  "dialog.file.create.title": "Ny fil",
  "dialog.file.create.name.label": "Filnavn",
  "dialog.file.create.name.placeholder": "eksempel.md",
  "dialog.file.create.confirm": "Opprett",
  "dialog.file.create.error.exists": "Det finnes allerede en fil med dette navnet.",
  "dialog.directory.create.title": "Ny mappe",
  "dialog.directory.create.name.label": "Mappenavn",
  "dialog.directory.create.name.placeholder": "Min mappe",
  "dialog.directory.create.confirm": "Opprett",
  "dialog.directory.create.error.exists": "Det finnes allerede en mappe med dette navnet.",
  "dialog.directory.create.defaultName": "Ny mappe",
  "dialog.directory.rename.title": "Gi mappen nytt navn",
  "dialog.directory.delete.title": "Slett mappe",
  "dialog.directory.delete.description": "Vil du slette «{{name}}» og hele innholdet? Denne handlingen kan ikke angres.",
  "dialog.directory.delete.confirm": "Slett",
  "fileTree.action.rename": "Gi nytt navn",
  "fileTree.action.delete": "Slett",
  "fileTree.action.newFile": "Ny fil",
  "fileTree.action.newDirectory": "Ny mappe",
  "fileTree.action.newSubDirectory": "Ny undermappe",
  "toast.file.rename.failed.title": "Kunne ikke gi filen nytt navn",
  "toast.file.delete.failed.title": "Kunne ikke slette filen",
  "toast.file.create.failed.title": "Kunne ikke opprette filen",
  "toast.directory.create.failed.title": "Kunne ikke opprette mappen",
  "toast.directory.delete.failed.title": "Kunne ikke slette mappen",
  "toast.directory.rename.failed.title": "Kunne ikke gi mappen nytt navn",
  "settings.general.section.voice": "Stemme",
  "settings.general.voice.deepgramKey.title": "Deepgram API-nøkkel",
  "settings.general.voice.deepgramKey.description": "Bruk Deepgram til å transkribere diktering i ledeteksten.",
  "settings.general.voice.deepgramKey.placeholder": "Lim inn en Deepgram-nøkkel",
  "settings.general.voice.language.title": "Stemmespråk",
  "settings.general.voice.language.description": "Deepgram-språkkode som brukes til transkripsjon.",
  "settings.general.voice.model.title": "Stemmemodell",
  "settings.general.voice.model.description": "Deepgram-modell som brukes til transkripsjon.",
  "settings.general.section.support": "Del en feil",
  "settings.support.row.bugEmail.title": "Via e-post",
  "settings.support.row.bugEmail.description": "Send en melding til Prisme-teamet med informasjon om installasjonen din.",
  "settings.support.row.bugEmail.action": "Skriv e-post",
  "settings.support.row.bugIssue.title": "På GitHub",
  "settings.support.row.bugIssue.description": "Åpne et forhåndsutfylt GitHub-skjema (GitHub-konto kreves).",
  "settings.support.row.bugIssue.action": "Åpne GitHub",
  "voice.action.start": "Start diktering",
  "voice.action.stop": "Stopp diktering",
  "voice.state.recording": "Tar opp",
  "voice.error.missingKey.title": "Deepgram-nøkkel kreves",
  "voice.error.missingKey.description": "Legg til Deepgram API-nøkkelen din i Innstillinger for å bruke taleinndata.",
  "voice.error.connection.title": "Stemmetilkoblingen mislyktes",
  "voice.error.connection.description": "Tilkoblingen til Deepgram ble avbrutt.",
  "voice.error.microphone.title": "Mikrofonen er utilgjengelig",
  "voice.error.microphone.description": "Prisme fikk ikke tilgang til mikrofonen din.",
