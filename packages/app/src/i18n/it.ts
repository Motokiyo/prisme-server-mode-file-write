export const dict = {
  ...
  "toast.file.notFound.title": "File non trovato",
  "notes.empty.title": "Nessuna nota aperta",
  "notes.empty.description": "Scegli un file nell'esplora risorse o crea una nota Markdown.",
  "notes.empty.create": "Crea nota",
  "notes.create.prompt": "Nome della nota",
  "notes.create.defaultName": "Nota senza titolo",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Crea nota",
  "dialog.note.create.name.label": "Nome della nota",
  "dialog.note.create.name.placeholder": "Le mie idee",
  "dialog.note.create.confirm": "Crea",
  "dialog.note.create.error.exists": "Esiste già una nota con questo nome.",
  "dialog.file.rename.title": "Rinomina file",
  "dialog.file.rename.name.label": "Nuovo nome",
  "dialog.file.rename.confirm": "Rinomina",
  "dialog.file.rename.error.exists": "Esiste già un file con questo nome.",
  "dialog.file.delete.title": "Elimina file",
  "dialog.file.delete.description": "Vuoi davvero eliminare «{{name}}»? Questa azione è irreversibile.",
  "dialog.file.delete.confirm": "Elimina",
  "dialog.file.create.title": "Nuovo file",
  "dialog.file.create.name.label": "Nome del file",
  "dialog.file.create.name.placeholder": "esempio.md",
  "dialog.file.create.confirm": "Crea",
  "dialog.file.create.error.exists": "Esiste già un file con questo nome.",
  "dialog.directory.create.title": "Nuova cartella",
  "dialog.directory.create.name.label": "Nome della cartella",
  "dialog.directory.create.name.placeholder": "La mia cartella",
  "dialog.directory.create.confirm": "Crea",
  "dialog.directory.create.error.exists": "Esiste già una cartella con questo nome.",
  "dialog.directory.create.defaultName": "Nuova cartella",
  "dialog.directory.rename.title": "Rinomina cartella",
  "dialog.directory.delete.title": "Elimina cartella",
  "dialog.directory.delete.description": "Eliminare «{{name}}» e tutto il suo contenuto? Questa azione è irreversibile.",
  "dialog.directory.delete.confirm": "Elimina",
  "fileTree.action.rename": "Rinomina",
  "fileTree.action.delete": "Elimina",
  "fileTree.action.newFile": "Nuovo file",
  "fileTree.action.newDirectory": "Nuova cartella",
  "fileTree.action.newSubDirectory": "Nuova sottocartella",
  "toast.file.rename.failed.title": "Impossibile rinominare il file",
  "toast.file.delete.failed.title": "Impossibile eliminare il file",
  "toast.file.create.failed.title": "Impossibile creare il file",
  "toast.directory.create.failed.title": "Impossibile creare la cartella",
  "toast.directory.delete.failed.title": "Impossibile eliminare la cartella",
  "toast.directory.rename.failed.title": "Impossibile rinominare la cartella",
  "settings.general.section.voice": "Voce",
  "settings.general.voice.deepgramKey.title": "Chiave API Deepgram",
  "settings.general.voice.deepgramKey.description": "Usa Deepgram per trascrivere la dettatura nel prompt.",
  "settings.general.voice.deepgramKey.placeholder": "Incolla una chiave Deepgram",
  "settings.general.voice.language.title": "Lingua della voce",
  "settings.general.voice.language.description": "Codice lingua Deepgram usato per la trascrizione.",
  "settings.general.voice.model.title": "Modello vocale",
  "settings.general.voice.model.description": "Modello Deepgram usato per la trascrizione.",
  "settings.general.section.support": "Segnala un bug",
  "settings.support.row.bugEmail.title": "Via email",
  "settings.support.row.bugEmail.description": "Invia un messaggio al team Prisme con le informazioni della tua installazione.",
  "settings.support.row.bugEmail.action": "Scrivi un'email",
  "settings.support.row.bugIssue.title": "Su GitHub",
  "settings.support.row.bugIssue.description": "Apri un modulo GitHub precompilato (account GitHub richiesto).",
  "settings.support.row.bugIssue.action": "Apri GitHub",
  "voice.action.start": "Avvia dettatura",
  "voice.action.stop": "Interrompi dettatura",
  "voice.state.recording": "Registrazione",
  "voice.error.missingKey.title": "Chiave Deepgram richiesta",
  "voice.error.missingKey.description": "Aggiungi la tua chiave API Deepgram nelle impostazioni per usare l'input vocale.",
  "voice.error.connection.title": "Connessione vocale non riuscita",
  "voice.error.connection.description": "La connessione a Deepgram è stata interrotta.",
  "voice.error.microphone.title": "Microfono non disponibile",
  "voice.error.microphone.description": "Prisme non è riuscito ad accedere al microfono.",
}
