export const dict = {
  ...
  // Prisme: notes, file tree, voice dictation, bug reporting
  "toast.file.notFound.title": "Το αρχείο δεν βρέθηκε",
  "notes.empty.title": "Καμία ανοιχτή σημείωση",
  "notes.empty.description": "Επιλέξτε ένα αρχείο από την εξερεύνηση ή δημιουργήστε μια σημείωση Markdown.",
  "notes.empty.create": "Δημιουργία σημείωσης",
  "notes.create.prompt": "Όνομα σημείωσης",
  "notes.create.defaultName": "Σημείωση χωρίς τίτλο",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Δημιουργία σημείωσης",
  "dialog.note.create.name.label": "Όνομα σημείωσης",
  "dialog.note.create.name.placeholder": "Οι ιδέες μου",
  "dialog.note.create.confirm": "Δημιουργία",
  "dialog.note.create.error.exists": "Υπάρχει ήδη σημείωση με αυτό το όνομα.",
  "dialog.file.rename.title": "Μετονομασία αρχείου",
  "dialog.file.rename.name.label": "Νέο όνομα",
  "dialog.file.rename.confirm": "Μετονομασία",
  "dialog.file.rename.error.exists": "Υπάρχει ήδη αρχείο με αυτό το όνομα.",
  "dialog.file.delete.title": "Διαγραφή αρχείου",
  "dialog.file.delete.description": "Είστε βέβαιοι ότι θέλετε να διαγράψετε το «{{name}}»; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί.",
  "dialog.file.delete.confirm": "Διαγραφή",
  "dialog.file.create.title": "Νέο αρχείο",
  "dialog.file.create.name.label": "Όνομα αρχείου",
  "dialog.file.create.name.placeholder": "paradeigma.md",
  "dialog.file.create.confirm": "Δημιουργία",
  "dialog.file.create.error.exists": "Υπάρχει ήδη αρχείο με αυτό το όνομα.",
  "dialog.directory.create.title": "Νέος φάκελος",
  "dialog.directory.create.name.label": "Όνομα φακέλου",
  "dialog.directory.create.name.placeholder": "Ο φάκελός μου",
  "dialog.directory.create.confirm": "Δημιουργία",
  "dialog.directory.create.error.exists": "Υπάρχει ήδη φάκελος με αυτό το όνομα.",
  "dialog.directory.create.defaultName": "Νέος φάκελος",
  "dialog.directory.rename.title": "Μετονομασία φακέλου",
  "dialog.directory.delete.title": "Διαγραφή φακέλου",
  "dialog.directory.delete.description": "Να διαγραφεί το «{{name}}» και όλο το περιεχόμενό του; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί.",
  "dialog.directory.delete.confirm": "Διαγραφή",
  "fileTree.action.rename": "Μετονομασία",
  "fileTree.action.delete": "Διαγραφή",
  "fileTree.action.newFile": "Νέο αρχείο",
  "fileTree.action.newDirectory": "Νέος φάκελος",
  "fileTree.action.newSubDirectory": "Νέος υποφάκελος",
  "toast.file.rename.failed.title": "Η μετονομασία του αρχείου απέτυχε",
  "toast.file.delete.failed.title": "Η διαγραφή του αρχείου απέτυχε",
  "toast.file.create.failed.title": "Η δημιουργία του αρχείου απέτυχε",
  "toast.directory.create.failed.title": "Η δημιουργία του φακέλου απέτυχε",
  "toast.directory.delete.failed.title": "Η διαγραφή του φακέλου απέτυχε",
  "toast.directory.rename.failed.title": "Η μετονομασία του φακέλου απέτυχε",
  "settings.general.section.voice": "Φωνή",
  "settings.general.voice.deepgramKey.title": "Κλειδί API Deepgram",
  "settings.general.voice.deepgramKey.description": "Χρήση του Deepgram για απομαγνητοφώνηση της υπαγόρευσης στο πεδίο εντολών.",
  "settings.general.voice.deepgramKey.placeholder": "Επικολλήστε ένα κλειδί Deepgram",
  "settings.general.voice.language.title": "Γλώσσα φωνής",
  "settings.general.voice.language.description": "Κωδικός γλώσσας Deepgram που χρησιμοποιείται για την απομαγνητοφώνηση.",
  "settings.general.voice.model.title": "Μοντέλο φωνής",
  "settings.general.voice.model.description": "Μοντέλο Deepgram που χρησιμοποιείται για την απομαγνητοφώνηση.",
  "settings.general.section.support": "Αναφορά σφάλματος",
  "settings.support.row.bugEmail.title": "Με email",
  "settings.support.row.bugEmail.description": "Στείλτε ένα μήνυμα στην ομάδα Prisme με τα στοιχεία της εγκατάστασής σας.",
  "settings.support.row.bugEmail.action": "Σύνταξη email",
  "settings.support.row.bugIssue.title": "Στο GitHub",
  "settings.support.row.bugIssue.description": "Άνοιγμα προσυμπληρωμένης φόρμας GitHub (απαιτείται λογαριασμός GitHub).",
  "settings.support.row.bugIssue.action": "Άνοιγμα GitHub",
  "voice.action.start": "Έναρξη υπαγόρευσης",
  "voice.action.stop": "Διακοπή υπαγόρευσης",
  "voice.state.recording": "Γίνεται εγγραφή",
  "voice.error.missingKey.title": "Απαιτείται κλειδί Deepgram",
  "voice.error.missingKey.description": "Προσθέστε το κλειδί API Deepgram στις ρυθμίσεις για να χρησιμοποιήσετε τη φωνητική εισαγωγή.",
  "voice.error.connection.title": "Η φωνητική σύνδεση απέτυχε",
  "voice.error.connection.description": "Η σύνδεση με το Deepgram διακόπηκε.",
  "voice.error.microphone.title": "Το μικρόφωνο δεν είναι διαθέσιμο",
  "voice.error.microphone.description": "Το Prisme δεν μπόρεσε να αποκτήσει πρόσβαση στο μικρόφωνό σας.",
}
