export const dict = {
  ...
  "toast.file.notFound.title": "Fișierul nu a fost găsit",
  "notes.empty.title": "Nicio notiță deschisă",
  "notes.empty.description": "Alegeți un fișier din explorator sau creați o notiță Markdown.",
  "notes.empty.create": "Creează notiță",
  "notes.create.prompt": "Numele notiței",
  "notes.create.defaultName": "Notiță fără titlu",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Creează notiță",
  "dialog.note.create.name.label": "Numele notiței",
  "dialog.note.create.name.placeholder": "Ideile mele",
  "dialog.note.create.confirm": "Creează",
  "dialog.note.create.error.exists": "Există deja o notiță cu acest nume.",
  "dialog.file.rename.title": "Redenumește fișierul",
  "dialog.file.rename.name.label": "Nume nou",
  "dialog.file.rename.confirm": "Redenumește",
  "dialog.file.rename.error.exists": "Există deja un fișier cu acest nume.",
  "dialog.file.delete.title": "Șterge fișierul",
  "dialog.file.delete.description": "Sigur doriți să ștergeți „{{name}}”? Această acțiune nu poate fi anulată.",
  "dialog.file.delete.confirm": "Șterge",
  "dialog.file.create.title": "Fișier nou",
  "dialog.file.create.name.label": "Numele fișierului",
  "dialog.file.create.name.placeholder": "exemplu.md",
  "dialog.file.create.confirm": "Creează",
  "dialog.file.create.error.exists": "Există deja un fișier cu acest nume.",
  "dialog.directory.create.title": "Folder nou",
  "dialog.directory.create.name.label": "Numele folderului",
  "dialog.directory.create.name.placeholder": "Folderul meu",
  "dialog.directory.create.confirm": "Creează",
  "dialog.directory.create.error.exists": "Există deja un folder cu acest nume.",
  "dialog.directory.create.defaultName": "Folder nou",
  "dialog.directory.rename.title": "Redenumește folderul",
  "dialog.directory.delete.title": "Șterge folderul",
  "dialog.directory.delete.description": "Ștergeți „{{name}}” și tot conținutul său? Această acțiune nu poate fi anulată.",
  "dialog.directory.delete.confirm": "Șterge",
  "fileTree.action.rename": "Redenumește",
  "fileTree.action.delete": "Șterge",
  "fileTree.action.newFile": "Fișier nou",
  "fileTree.action.newDirectory": "Folder nou",
  "fileTree.action.newSubDirectory": "Subfolder nou",
  "toast.file.rename.failed.title": "Fișierul nu a putut fi redenumit",
  "toast.file.delete.failed.title": "Fișierul nu a putut fi șters",
  "toast.file.create.failed.title": "Fișierul nu a putut fi creat",
  "toast.directory.create.failed.title": "Folderul nu a putut fi creat",
  "toast.directory.delete.failed.title": "Folderul nu a putut fi șters",
  "toast.directory.rename.failed.title": "Folderul nu a putut fi redenumit",
  "settings.general.section.voice": "Voce",
  "settings.general.voice.deepgramKey.title": "Cheie API Deepgram",
  "settings.general.voice.deepgramKey.description": "Folosește Deepgram pentru a transcrie dictarea din prompt.",
  "settings.general.voice.deepgramKey.placeholder": "Lipiți o cheie Deepgram",
  "settings.general.voice.language.title": "Limba vocii",
  "settings.general.voice.language.description": "Codul de limbă Deepgram folosit pentru transcriere.",
  "settings.general.voice.model.title": "Model vocal",
  "settings.general.voice.model.description": "Modelul Deepgram folosit pentru transcriere.",
  "settings.general.section.support": "Raportează o eroare",
  "settings.support.row.bugEmail.title": "Prin e-mail",
  "settings.support.row.bugEmail.description": "Trimiteți echipei Prisme un mesaj cu informațiile despre instalarea dumneavoastră.",
  "settings.support.row.bugEmail.action": "Compune e-mail",
  "settings.support.row.bugIssue.title": "Pe GitHub",
  "settings.support.row.bugIssue.description": "Deschide un formular GitHub precompletat (este necesar un cont GitHub).",
  "settings.support.row.bugIssue.action": "Deschide GitHub",
  "voice.action.start": "Pornește dictarea",
  "voice.action.stop": "Oprește dictarea",
  "voice.state.recording": "Se înregistrează",
  "voice.error.missingKey.title": "Este necesară o cheie Deepgram",
  "voice.error.missingKey.description": "Adăugați cheia API Deepgram în setări pentru a folosi introducerea vocală.",
  "voice.error.connection.title": "Conexiunea vocală a eșuat",
  "voice.error.connection.description": "Conexiunea cu Deepgram a fost întreruptă.",
  "voice.error.microphone.title": "Microfon indisponibil",
  "voice.error.microphone.description": "Prisme nu a putut accesa microfonul.",
}
