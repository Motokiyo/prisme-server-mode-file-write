export const dict: Record<string, string> = {
  ...
  "toast.file.notFound.title": "ফাইল পাওয়া যায়নি",
  "notes.empty.title": "কোনো নোট খোলা নেই",
  "notes.empty.description": "এক্সপ্লোরার থেকে একটি ফাইল বেছে নিন বা একটি Markdown নোট তৈরি করুন।",
  "notes.empty.create": "নোট তৈরি করুন",
  "notes.create.prompt": "নোটের নাম",
  "notes.create.defaultName": "শিরোনামহীন নোট",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "নোট তৈরি করুন",
  "dialog.note.create.name.label": "নোটের নাম",
  "dialog.note.create.name.placeholder": "আমার ভাবনা",
  "dialog.note.create.confirm": "তৈরি করুন",
  "dialog.note.create.error.exists": "এই নামে একটি নোট ইতিমধ্যে রয়েছে।",
  "dialog.file.rename.title": "ফাইলের নাম পরিবর্তন করুন",
  "dialog.file.rename.name.label": "নতুন নাম",
  "dialog.file.rename.confirm": "নাম পরিবর্তন করুন",
  "dialog.file.rename.error.exists": "এই নামে একটি ফাইল ইতিমধ্যে রয়েছে।",
  "dialog.file.delete.title": "ফাইল মুছুন",
  "dialog.file.delete.description": "আপনি কি নিশ্চিতভাবে “{{name}}” মুছতে চান? এই কাজটি ফেরানো যাবে না।",
  "dialog.file.delete.confirm": "মুছে দিন",
  "dialog.file.create.title": "নতুন ফাইল",
  "dialog.file.create.name.label": "ফাইলের নাম",
  "dialog.file.create.name.placeholder": "udaharan.md",
  "dialog.file.create.confirm": "তৈরি করুন",
  "dialog.file.create.error.exists": "এই নামে একটি ফাইল ইতিমধ্যে রয়েছে।",
  "dialog.directory.create.title": "নতুন ফোল্ডার",
  "dialog.directory.create.name.label": "ফোল্ডারের নাম",
  "dialog.directory.create.name.placeholder": "আমার ফোল্ডার",
  "dialog.directory.create.confirm": "তৈরি করুন",
  "dialog.directory.create.error.exists": "এই নামে একটি ফোল্ডার ইতিমধ্যে রয়েছে।",
  "dialog.directory.create.defaultName": "নতুন ফোল্ডার",
  "dialog.directory.rename.title": "ফোল্ডারের নাম পরিবর্তন করুন",
  "dialog.directory.delete.title": "ফোল্ডার মুছুন",
  "dialog.directory.delete.description": "“{{name}}” এবং এর সমস্ত বিষয়বস্তু মুছবেন? এই কাজটি ফেরানো যাবে না।",
  "dialog.directory.delete.confirm": "মুছে দিন",
  "fileTree.action.rename": "নাম পরিবর্তন করুন",
  "fileTree.action.delete": "মুছে দিন",
  "fileTree.action.newFile": "নতুন ফাইল",
  "fileTree.action.newDirectory": "নতুন ফোল্ডার",
  "fileTree.action.newSubDirectory": "নতুন সাবফোল্ডার",
  "toast.file.rename.failed.title": "ফাইলের নাম পরিবর্তন করা যায়নি",
  "toast.file.delete.failed.title": "ফাইল মোছা যায়নি",
  "toast.file.create.failed.title": "ফাইল তৈরি করা যায়নি",
  "toast.directory.create.failed.title": "ফোল্ডার তৈরি করা যায়নি",
  "toast.directory.delete.failed.title": "ফোল্ডার মোছা যায়নি",
  "toast.directory.rename.failed.title": "ফোল্ডারের নাম পরিবর্তন করা যায়নি",
  "settings.general.section.voice": "কণ্ঠস্বর",
  "settings.general.voice.deepgramKey.title": "Deepgram API কী",
  "settings.general.voice.deepgramKey.description": "প্রম্পটে বলা কথা লিখতে Deepgram ব্যবহার করুন।",
  "settings.general.voice.deepgramKey.placeholder": "একটি Deepgram কী পেস্ট করুন",
  "settings.general.voice.language.title": "কণ্ঠের ভাষা",
  "settings.general.voice.language.description": "প্রতিলিপির জন্য ব্যবহৃত Deepgram ভাষা কোড।",
  "settings.general.voice.model.title": "কণ্ঠ মডেল",
  "settings.general.voice.model.description": "প্রতিলিপির জন্য ব্যবহৃত Deepgram মডেল।",
  "settings.general.section.support": "ত্রুটি জানান",
  "settings.support.row.bugEmail.title": "ইমেলের মাধ্যমে",
  "settings.support.row.bugEmail.description": "আপনার ইনস্টলেশনের তথ্যসহ Prisme দলকে একটি বার্তা পাঠান।",
  "settings.support.row.bugEmail.action": "ইমেল লিখুন",
  "settings.support.row.bugIssue.title": "GitHub-এ",
  "settings.support.row.bugIssue.description": "আগে থেকে পূরণ করা GitHub ফর্ম খুলুন (GitHub অ্যাকাউন্ট প্রয়োজন)।",
  "settings.support.row.bugIssue.action": "GitHub খুলুন",
  "voice.action.start": "শ্রুতিলিখন শুরু করুন",
  "voice.action.stop": "শ্রুতিলিখন বন্ধ করুন",
  "voice.state.recording": "রেকর্ড হচ্ছে",
  "voice.error.missingKey.title": "Deepgram কী প্রয়োজন",
  "voice.error.missingKey.description": "কণ্ঠস্বরে ইনপুট দিতে সেটিংসে আপনার Deepgram API কী যোগ করুন।",
  "voice.error.connection.title": "কণ্ঠ সংযোগ ব্যর্থ হয়েছে",
  "voice.error.connection.description": "Deepgram-এর সঙ্গে সংযোগ বিচ্ছিন্ন হয়েছে।",
  "voice.error.microphone.title": "মাইক্রোফোন অনুপলব্ধ",
  "voice.error.microphone.description": "Prisme আপনার মাইক্রোফোন ব্যবহার করতে পারেনি।",
}
