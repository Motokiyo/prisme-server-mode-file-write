export const dict = {
  ...
  "toast.file.notFound.title": "ไม่พบไฟล์",
  "notes.empty.title": "ไม่มีบันทึกที่เปิดอยู่",
  "notes.empty.description": "เลือกไฟล์จากตัวสำรวจ หรือสร้างบันทึก Markdown",
  "notes.empty.create": "สร้างบันทึก",
  "notes.create.prompt": "ชื่อบันทึก",
  "notes.create.defaultName": "บันทึกที่ไม่มีชื่อ",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "สร้างบันทึก",
  "dialog.note.create.name.label": "ชื่อบันทึก",
  "dialog.note.create.name.placeholder": "ไอเดียของฉัน",
  "dialog.note.create.confirm": "สร้าง",
  "dialog.note.create.error.exists": "มีบันทึกชื่อนี้อยู่แล้ว",
  "dialog.file.rename.title": "เปลี่ยนชื่อไฟล์",
  "dialog.file.rename.name.label": "ชื่อใหม่",
  "dialog.file.rename.confirm": "เปลี่ยนชื่อ",
  "dialog.file.rename.error.exists": "มีไฟล์ชื่อนี้อยู่แล้ว",
  "dialog.file.delete.title": "ลบไฟล์",
  "dialog.file.delete.description": "คุณแน่ใจหรือไม่ว่าต้องการลบ “{{name}}” การกระทำนี้ไม่สามารถย้อนกลับได้",
  "dialog.file.delete.confirm": "ลบ",
  "dialog.file.create.title": "ไฟล์ใหม่",
  "dialog.file.create.name.label": "ชื่อไฟล์",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "สร้าง",
  "dialog.file.create.error.exists": "มีไฟล์ชื่อนี้อยู่แล้ว",
  "dialog.directory.create.title": "โฟลเดอร์ใหม่",
  "dialog.directory.create.name.label": "ชื่อโฟลเดอร์",
  "dialog.directory.create.name.placeholder": "โฟลเดอร์ของฉัน",
  "dialog.directory.create.confirm": "สร้าง",
  "dialog.directory.create.error.exists": "มีโฟลเดอร์ชื่อนี้อยู่แล้ว",
  "dialog.directory.create.defaultName": "โฟลเดอร์ใหม่",
  "dialog.directory.rename.title": "เปลี่ยนชื่อโฟลเดอร์",
  "dialog.directory.delete.title": "ลบโฟลเดอร์",
  "dialog.directory.delete.description": "ลบ “{{name}}” และเนื้อหาทั้งหมดหรือไม่ การกระทำนี้ไม่สามารถย้อนกลับได้",
  "dialog.directory.delete.confirm": "ลบ",
  "fileTree.action.rename": "เปลี่ยนชื่อ",
  "fileTree.action.delete": "ลบ",
  "fileTree.action.newFile": "ไฟล์ใหม่",
  "fileTree.action.newDirectory": "โฟลเดอร์ใหม่",
  "fileTree.action.newSubDirectory": "โฟลเดอร์ย่อยใหม่",
  "toast.file.rename.failed.title": "เปลี่ยนชื่อไฟล์ไม่สำเร็จ",
  "toast.file.delete.failed.title": "ลบไฟล์ไม่สำเร็จ",
  "toast.file.create.failed.title": "สร้างไฟล์ไม่สำเร็จ",
  "toast.directory.create.failed.title": "สร้างโฟลเดอร์ไม่สำเร็จ",
  "toast.directory.delete.failed.title": "ลบโฟลเดอร์ไม่สำเร็จ",
  "toast.directory.rename.failed.title": "เปลี่ยนชื่อโฟลเดอร์ไม่สำเร็จ",
  "settings.general.section.voice": "เสียง",
  "settings.general.voice.deepgramKey.title": "คีย์ API ของ Deepgram",
  "settings.general.voice.deepgramKey.description": "ใช้ Deepgram เพื่อถอดเสียงการบอกข้อความในพรอมต์",
  "settings.general.voice.deepgramKey.placeholder": "วางคีย์ Deepgram",
  "settings.general.voice.language.title": "ภาษาของเสียง",
  "settings.general.voice.language.description": "รหัสภาษาของ Deepgram ที่ใช้ในการถอดเสียง",
  "settings.general.voice.model.title": "โมเดลเสียง",
  "settings.general.voice.model.description": "โมเดลของ Deepgram ที่ใช้ในการถอดเสียง",
  "settings.general.section.support": "แจ้งข้อบกพร่อง",
  "settings.support.row.bugEmail.title": "ทางอีเมล",
  "settings.support.row.bugEmail.description": "ส่งข้อความถึงทีม Prisme พร้อมข้อมูลการติดตั้งของคุณ",
  "settings.support.row.bugEmail.action": "เขียนอีเมล",
  "settings.support.row.bugIssue.title": "บน GitHub",
  "settings.support.row.bugIssue.description": "เปิดแบบฟอร์ม GitHub ที่กรอกไว้ล่วงหน้า (ต้องมีบัญชี GitHub)",
  "settings.support.row.bugIssue.action": "เปิด GitHub",
  "voice.action.start": "เริ่มบอกข้อความ",
  "voice.action.stop": "หยุดบอกข้อความ",
  "voice.state.recording": "กำลังบันทึกเสียง",
  "voice.error.missingKey.title": "ต้องใช้คีย์ Deepgram",
  "voice.error.missingKey.description": "เพิ่มคีย์ API ของ Deepgram ในการตั้งค่าเพื่อใช้การป้อนข้อมูลด้วยเสียง",
  "voice.error.connection.title": "การเชื่อมต่อเสียงล้มเหลว",
  "voice.error.connection.description": "การเชื่อมต่อกับ Deepgram ถูกขัดจังหวะ",
  "voice.error.microphone.title": "ไม่สามารถใช้ไมโครโฟนได้",
  "voice.error.microphone.description": "Prisme ไม่สามารถเข้าถึงไมโครโฟนของคุณได้",
}
