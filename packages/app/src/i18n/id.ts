export const dict = {
  ...
  "toast.file.notFound.title": "Berkas tidak ditemukan",
  "notes.empty.title": "Tidak ada catatan yang terbuka",
  "notes.empty.description": "Pilih berkas di penjelajah atau buat catatan Markdown.",
  "notes.empty.create": "Buat catatan",
  "notes.create.prompt": "Nama catatan",
  "notes.create.defaultName": "Catatan tanpa judul",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Buat catatan",
  "dialog.note.create.name.label": "Nama catatan",
  "dialog.note.create.name.placeholder": "Ide saya",
  "dialog.note.create.confirm": "Buat",
  "dialog.note.create.error.exists": "Catatan dengan nama ini sudah ada.",
  "dialog.file.rename.title": "Ganti nama berkas",
  "dialog.file.rename.name.label": "Nama baru",
  "dialog.file.rename.confirm": "Ganti nama",
  "dialog.file.rename.error.exists": "Berkas dengan nama ini sudah ada.",
  "dialog.file.delete.title": "Hapus berkas",
  "dialog.file.delete.description": "Yakin ingin menghapus “{{name}}”? Tindakan ini tidak dapat dibatalkan.",
  "dialog.file.delete.confirm": "Hapus",
  "dialog.file.create.title": "Berkas baru",
  "dialog.file.create.name.label": "Nama berkas",
  "dialog.file.create.name.placeholder": "contoh.md",
  "dialog.file.create.confirm": "Buat",
  "dialog.file.create.error.exists": "Berkas dengan nama ini sudah ada.",
  "dialog.directory.create.title": "Folder baru",
  "dialog.directory.create.name.label": "Nama folder",
  "dialog.directory.create.name.placeholder": "Folder saya",
  "dialog.directory.create.confirm": "Buat",
  "dialog.directory.create.error.exists": "Folder dengan nama ini sudah ada.",
  "dialog.directory.create.defaultName": "Folder baru",
  "dialog.directory.rename.title": "Ganti nama folder",
  "dialog.directory.delete.title": "Hapus folder",
  "dialog.directory.delete.description": "Hapus “{{name}}” beserta seluruh isinya? Tindakan ini tidak dapat dibatalkan.",
  "dialog.directory.delete.confirm": "Hapus",
  "fileTree.action.rename": "Ganti nama",
  "fileTree.action.delete": "Hapus",
  "fileTree.action.newFile": "Berkas baru",
  "fileTree.action.newDirectory": "Folder baru",
  "fileTree.action.newSubDirectory": "Subfolder baru",
  "toast.file.rename.failed.title": "Gagal mengganti nama berkas",
  "toast.file.delete.failed.title": "Gagal menghapus berkas",
  "toast.file.create.failed.title": "Gagal membuat berkas",
  "toast.directory.create.failed.title": "Gagal membuat folder",
  "toast.directory.delete.failed.title": "Gagal menghapus folder",
  "toast.directory.rename.failed.title": "Gagal mengganti nama folder",
  "settings.general.section.voice": "Suara",
  "settings.general.voice.deepgramKey.title": "Kunci API Deepgram",
  "settings.general.voice.deepgramKey.description": "Gunakan Deepgram untuk mentranskripsi dikte pada prompt.",
  "settings.general.voice.deepgramKey.placeholder": "Tempel kunci Deepgram",
  "settings.general.voice.language.title": "Bahasa suara",
  "settings.general.voice.language.description": "Kode bahasa Deepgram yang dipakai untuk transkripsi.",
  "settings.general.voice.model.title": "Model suara",
  "settings.general.voice.model.description": "Model Deepgram yang dipakai untuk transkripsi.",
  "settings.general.section.support": "Laporkan bug",
  "settings.support.row.bugEmail.title": "Lewat email",
  "settings.support.row.bugEmail.description": "Kirim pesan ke tim Prisme beserta informasi instalasi Anda.",
  "settings.support.row.bugEmail.action": "Tulis email",
  "settings.support.row.bugIssue.title": "Di GitHub",
  "settings.support.row.bugIssue.description": "Buka formulir GitHub yang sudah terisi (perlu akun GitHub).",
  "settings.support.row.bugIssue.action": "Buka GitHub",
  "voice.action.start": "Mulai dikte",
  "voice.action.stop": "Hentikan dikte",
  "voice.state.recording": "Merekam",
  "voice.error.missingKey.title": "Kunci Deepgram diperlukan",
  "voice.error.missingKey.description": "Tambahkan kunci API Deepgram Anda di Pengaturan untuk memakai masukan suara.",
  "voice.error.connection.title": "Koneksi suara gagal",
  "voice.error.connection.description": "Koneksi ke Deepgram terputus.",
