export const dict = {
  ...
  "toast.file.notFound.title": "Không tìm thấy tệp",
  "notes.empty.title": "Chưa mở ghi chú nào",
  "notes.empty.description": "Chọn một tệp trong trình duyệt tệp hoặc tạo một ghi chú Markdown.",
  "notes.empty.create": "Tạo ghi chú",
  "notes.create.prompt": "Tên ghi chú",
  "notes.create.defaultName": "Ghi chú không có tiêu đề",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Tạo ghi chú",
  "dialog.note.create.name.label": "Tên ghi chú",
  "dialog.note.create.name.placeholder": "Ý tưởng của tôi",
  "dialog.note.create.confirm": "Tạo",
  "dialog.note.create.error.exists": "Đã tồn tại một ghi chú trùng tên.",
  "dialog.file.rename.title": "Đổi tên tệp",
  "dialog.file.rename.name.label": "Tên mới",
  "dialog.file.rename.confirm": "Đổi tên",
  "dialog.file.rename.error.exists": "Đã tồn tại một tệp trùng tên.",
  "dialog.file.delete.title": "Xóa tệp",
  "dialog.file.delete.description": "Bạn có chắc muốn xóa “{{name}}” không? Hành động này không thể hoàn tác.",
  "dialog.file.delete.confirm": "Xóa",
  "dialog.file.create.title": "Tệp mới",
  "dialog.file.create.name.label": "Tên tệp",
  "dialog.file.create.name.placeholder": "vidu.md",
  "dialog.file.create.confirm": "Tạo",
  "dialog.file.create.error.exists": "Đã tồn tại một tệp trùng tên.",
  "dialog.directory.create.title": "Thư mục mới",
  "dialog.directory.create.name.label": "Tên thư mục",
  "dialog.directory.create.name.placeholder": "Thư mục của tôi",
  "dialog.directory.create.confirm": "Tạo",
  "dialog.directory.create.error.exists": "Đã tồn tại một thư mục trùng tên.",
  "dialog.directory.create.defaultName": "Thư mục mới",
  "dialog.directory.rename.title": "Đổi tên thư mục",
  "dialog.directory.delete.title": "Xóa thư mục",
  "dialog.directory.delete.description": "Xóa “{{name}}” và toàn bộ nội dung bên trong? Hành động này không thể hoàn tác.",
  "dialog.directory.delete.confirm": "Xóa",
  "fileTree.action.rename": "Đổi tên",
  "fileTree.action.delete": "Xóa",
  "fileTree.action.newFile": "Tệp mới",
  "fileTree.action.newDirectory": "Thư mục mới",
  "fileTree.action.newSubDirectory": "Thư mục con mới",
  "toast.file.rename.failed.title": "Không thể đổi tên tệp",
  "toast.file.delete.failed.title": "Không thể xóa tệp",
  "toast.file.create.failed.title": "Không thể tạo tệp",
  "toast.directory.create.failed.title": "Không thể tạo thư mục",
  "toast.directory.delete.failed.title": "Không thể xóa thư mục",
  "toast.directory.rename.failed.title": "Không thể đổi tên thư mục",
  "settings.general.section.voice": "Giọng nói",
  "settings.general.voice.deepgramKey.title": "Khóa API Deepgram",
  "settings.general.voice.deepgramKey.description": "Dùng Deepgram để chuyển lời đọc trong ô nhập thành văn bản.",
  "settings.general.voice.deepgramKey.placeholder": "Dán khóa Deepgram",
  "settings.general.voice.language.title": "Ngôn ngữ giọng nói",
  "settings.general.voice.language.description": "Mã ngôn ngữ Deepgram dùng để chuyển lời nói thành văn bản.",
  "settings.general.voice.model.title": "Mô hình giọng nói",
  "settings.general.voice.model.description": "Mô hình Deepgram dùng để chuyển lời nói thành văn bản.",
  "settings.general.section.support": "Báo lỗi",
  "settings.support.row.bugEmail.title": "Qua email",
  "settings.support.row.bugEmail.description": "Gửi tin nhắn cho nhóm Prisme kèm thông tin cài đặt của bạn.",
  "settings.support.row.bugEmail.action": "Soạn email",
  "settings.support.row.bugIssue.title": "Trên GitHub",
  "settings.support.row.bugIssue.description": "Mở biểu mẫu GitHub đã điền sẵn (cần tài khoản GitHub).",
  "settings.support.row.bugIssue.action": "Mở GitHub",
  "voice.action.start": "Bắt đầu đọc chính tả",
  "voice.action.stop": "Dừng đọc chính tả",
  "voice.state.recording": "Đang ghi âm",
  "voice.error.missingKey.title": "Cần có khóa Deepgram",
  "voice.error.missingKey.description": "Thêm khóa API Deepgram trong Cài đặt để dùng nhập liệu bằng giọng nói.",
  "voice.error.connection.title": "Kết nối giọng nói thất bại",
  "voice.error.connection.description": "Kết nối tới Deepgram đã bị gián đoạn.",
  "voice.error.microphone.title": "Micrô không khả dụng",
  "voice.error.microphone.description": "Prisme không thể truy cập micrô của bạn.",
}
