export const dict: Record<string, string> = {
  ...
  "toast.file.notFound.title": "ගොනුව හමු නොවීය",
  "notes.empty.title": "විවෘත සටහනක් නැත",
  "notes.empty.description": "ගවේෂකයෙන් ගොනුවක් තෝරන්න හෝ Markdown සටහනක් සාදන්න.",
  "notes.empty.create": "සටහනක් සාදන්න",
  "notes.create.prompt": "සටහනේ නම",
  "notes.create.defaultName": "නම් නොකළ සටහන",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "සටහනක් සාදන්න",
  "dialog.note.create.name.label": "සටහනේ නම",
  "dialog.note.create.name.placeholder": "මගේ අදහස්",
  "dialog.note.create.confirm": "සාදන්න",
  "dialog.note.create.error.exists": "මෙම නමින් සටහනක් දැනටමත් තිබේ.",
  "dialog.file.rename.title": "ගොනුව නැවත නම් කරන්න",
  "dialog.file.rename.name.label": "නව නම",
  "dialog.file.rename.confirm": "නැවත නම් කරන්න",
  "dialog.file.rename.error.exists": "මෙම නමින් ගොනුවක් දැනටමත් තිබේ.",
  "dialog.file.delete.title": "ගොනුව මකන්න",
  "dialog.file.delete.description": "ඔබට “{{name}}” මැකීමට අවශ්‍ය බව විශ්වාසද? මෙම ක්‍රියාව අහෝසි කළ නොහැක.",
  "dialog.file.delete.confirm": "මකන්න",
  "dialog.file.create.title": "නව ගොනුව",
  "dialog.file.create.name.label": "ගොනුවේ නම",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "සාදන්න",
  "dialog.file.create.error.exists": "මෙම නමින් ගොනුවක් දැනටමත් තිබේ.",
  "dialog.directory.create.title": "නව ෆෝල්ඩරය",
  "dialog.directory.create.name.label": "ෆෝල්ඩරයේ නම",
  "dialog.directory.create.name.placeholder": "මගේ ෆෝල්ඩරය",
  "dialog.directory.create.confirm": "සාදන්න",
  "dialog.directory.create.error.exists": "මෙම නමින් ෆෝල්ඩරයක් දැනටමත් තිබේ.",
  "dialog.directory.create.defaultName": "නව ෆෝල්ඩරය",
  "dialog.directory.rename.title": "ෆෝල්ඩරය නැවත නම් කරන්න",
  "dialog.directory.delete.title": "ෆෝල්ඩරය මකන්න",
  "dialog.directory.delete.description": "“{{name}}” සහ එහි සියලු අන්තර්ගතය මකන්නද? මෙම ක්‍රියාව අහෝසි කළ නොහැක.",
  "dialog.directory.delete.confirm": "මකන්න",
  "fileTree.action.rename": "නැවත නම් කරන්න",
  "fileTree.action.delete": "මකන්න",
  "fileTree.action.newFile": "නව ගොනුව",
  "fileTree.action.newDirectory": "නව ෆෝල්ඩරය",
  "fileTree.action.newSubDirectory": "නව උපෆෝල්ඩරය",
  "toast.file.rename.failed.title": "ගොනුව නැවත නම් කිරීමට නොහැකි විය",
  "toast.file.delete.failed.title": "ගොනුව මැකීමට නොහැකි විය",
  "toast.file.create.failed.title": "ගොනුව සෑදීමට නොහැකි විය",
  "toast.directory.create.failed.title": "ෆෝල්ඩරය සෑදීමට නොහැකි විය",
  "toast.directory.delete.failed.title": "ෆෝල්ඩරය මැකීමට නොහැකි විය",
  "toast.directory.rename.failed.title": "ෆෝල්ඩරය නැවත නම් කිරීමට නොහැකි විය",
  "settings.general.section.voice": "හඬ",
  "settings.general.voice.deepgramKey.title": "Deepgram API යතුර",
  "settings.general.voice.deepgramKey.description": "විමසුමේ කථනය පෙළට පරිවර්තනය කිරීමට Deepgram භාවිත කරන්න.",
  "settings.general.voice.deepgramKey.placeholder": "Deepgram යතුරක් අලවන්න",
  "settings.general.voice.language.title": "හඬේ භාෂාව",
  "settings.general.voice.language.description": "පිටපත් කිරීම සඳහා භාවිත වන Deepgram භාෂා කේතය.",
  "settings.general.voice.model.title": "හඬ ආකෘතිය",
  "settings.general.voice.model.description": "පිටපත් කිරීම සඳහා භාවිත වන Deepgram ආකෘතිය.",
  "settings.general.section.support": "දෝෂයක් වාර්තා කරන්න",
  "settings.support.row.bugEmail.title": "විද්‍යුත් තැපෑලෙන්",
  "settings.support.row.bugEmail.description": "ඔබේ ස්ථාපන තොරතුරු සමඟ Prisme කණ්ඩායමට පණිවිඩයක් යවන්න.",
  "settings.support.row.bugEmail.action": "විද්‍යුත් තැපෑලක් ලියන්න",
  "settings.support.row.bugIssue.title": "GitHub හි",
  "settings.support.row.bugIssue.description": "පෙර පුරවන ලද GitHub පෝරමයක් විවෘත කරන්න (GitHub ගිණුමක් අවශ්‍යයි).",
  "settings.support.row.bugIssue.action": "GitHub විවෘත කරන්න",
  "voice.action.start": "හඬ ලිවීම අරඹන්න",
  "voice.action.stop": "හඬ ලිවීම නවත්වන්න",
  "voice.state.recording": "පටිගත වෙමින්",
  "voice.error.missingKey.title": "Deepgram යතුර අවශ්‍යයි",
  "voice.error.missingKey.description": "හඬ ආදානය භාවිත කිරීමට සැකසීම්වල ඔබේ Deepgram API යතුර එක් කරන්න.",
  "voice.error.connection.title": "හඬ සම්බන්ධතාවය අසාර්ථක විය",
  "voice.error.connection.description": "Deepgram සම්බන්ධතාවය බිඳ වැටිණි.",
  "voice.error.microphone.title": "මයික්‍රොෆෝනය නොමැත",
  "voice.error.microphone.description": "Prisme හට ඔබේ මයික්‍රොෆෝනයට ප්‍රවේශ විය නොහැකි විය.",
}
