export const dict = {
  ...
  "toast.file.notFound.title": "Fails nav atrasts",
  "notes.empty.title": "Nav atvērta neviena piezīme",
  "notes.empty.description": "Izvēlieties failu pārlūkā vai izveidojiet Markdown piezīmi.",
  "notes.empty.create": "Izveidot piezīmi",
  "notes.create.prompt": "Piezīmes nosaukums",
  "notes.create.defaultName": "Piezīme bez nosaukuma",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Izveidot piezīmi",
  "dialog.note.create.name.label": "Piezīmes nosaukums",
  "dialog.note.create.name.placeholder": "Manas idejas",
  "dialog.note.create.confirm": "Izveidot",
  "dialog.note.create.error.exists": "Piezīme ar šādu nosaukumu jau pastāv.",
  "dialog.file.rename.title": "Pārdēvēt failu",
  "dialog.file.rename.name.label": "Jauns nosaukums",
  "dialog.file.rename.confirm": "Pārdēvēt",
  "dialog.file.rename.error.exists": "Fails ar šādu nosaukumu jau pastāv.",
  "dialog.file.delete.title": "Dzēst failu",
  "dialog.file.delete.description": "Vai tiešām vēlaties dzēst “{{name}}”? Šo darbību nevar atsaukt.",
  "dialog.file.delete.confirm": "Dzēst",
  "dialog.file.create.title": "Jauns fails",
  "dialog.file.create.name.label": "Faila nosaukums",
  "dialog.file.create.name.placeholder": "piemers.md",
  "dialog.file.create.confirm": "Izveidot",
  "dialog.file.create.error.exists": "Fails ar šādu nosaukumu jau pastāv.",
  "dialog.directory.create.title": "Jauna mape",
  "dialog.directory.create.name.label": "Mapes nosaukums",
  "dialog.directory.create.name.placeholder": "Mana mape",
  "dialog.directory.create.confirm": "Izveidot",
  "dialog.directory.create.error.exists": "Mape ar šādu nosaukumu jau pastāv.",
  "dialog.directory.create.defaultName": "Jauna mape",
  "dialog.directory.rename.title": "Pārdēvēt mapi",
  "dialog.directory.delete.title": "Dzēst mapi",
  "dialog.directory.delete.description": "Dzēst “{{name}}” un visu tās saturu? Šo darbību nevar atsaukt.",
  "dialog.directory.delete.confirm": "Dzēst",
  "fileTree.action.rename": "Pārdēvēt",
  "fileTree.action.delete": "Dzēst",
  "fileTree.action.newFile": "Jauns fails",
  "fileTree.action.newDirectory": "Jauna mape",
  "fileTree.action.newSubDirectory": "Jauna apakšmape",
  "toast.file.rename.failed.title": "Neizdevās pārdēvēt failu",
  "toast.file.delete.failed.title": "Neizdevās izdzēst failu",
  "toast.file.create.failed.title": "Neizdevās izveidot failu",
  "toast.directory.create.failed.title": "Neizdevās izveidot mapi",
  "toast.directory.delete.failed.title": "Neizdevās izdzēst mapi",
  "toast.directory.rename.failed.title": "Neizdevās pārdēvēt mapi",
  "settings.general.section.voice": "Balss",
  "settings.general.voice.deepgramKey.title": "Deepgram API atslēga",
  "settings.general.voice.deepgramKey.description": "Izmantot Deepgram, lai transkribētu diktēšanu uzvednē.",
  "settings.general.voice.deepgramKey.placeholder": "Ielīmējiet Deepgram atslēgu",
  "settings.general.voice.language.title": "Balss valoda",
  "settings.general.voice.language.description": "Transkripcijai izmantotais Deepgram valodas kods.",
  "settings.general.voice.model.title": "Balss modelis",
  "settings.general.voice.model.description": "Transkripcijai izmantotais Deepgram modelis.",
  "settings.general.section.support": "Ziņot par kļūdu",
  "settings.support.row.bugEmail.title": "Pa e-pastu",
  "settings.support.row.bugEmail.description": "Nosūtiet Prisme komandai ziņojumu ar informāciju par savu instalāciju.",
  "settings.support.row.bugEmail.action": "Rakstīt e-pastu",
  "settings.support.row.bugIssue.title": "GitHub vietnē",
  "settings.support.row.bugIssue.description": "Atvērt iepriekš aizpildītu GitHub veidlapu (nepieciešams GitHub konts).",
  "settings.support.row.bugIssue.action": "Atvērt GitHub",
  "voice.action.start": "Sākt diktēšanu",
  "voice.action.stop": "Apturēt diktēšanu",
  "voice.state.recording": "Notiek ierakstīšana",
  "voice.error.missingKey.title": "Nepieciešama Deepgram atslēga",
  "voice.error.missingKey.description": "Pievienojiet savu Deepgram API atslēgu iestatījumos, lai izmantotu balss ievadi.",
  "voice.error.connection.title": "Neizdevās izveidot balss savienojumu",
  "voice.error.connection.description": "Savienojums ar Deepgram tika pārtraukts.",
  "voice.error.microphone.title": "Mikrofons nav pieejams",
  "voice.error.microphone.description": "Prisme nevarēja piekļūt jūsu mikrofonam.",
}
