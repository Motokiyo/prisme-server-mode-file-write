export const dict = {
  ...
  "toast.file.notFound.title": "ፋይሉ አልተገኘም",
  "notes.empty.title": "የተከፈተ ማስታወሻ የለም",
  "notes.empty.description": "ከአሳሹ ውስጥ ፋይል ይምረጡ ወይም የMarkdown ማስታወሻ ይፍጠሩ።",
  "notes.empty.create": "ማስታወሻ ፍጠር",
  "notes.create.prompt": "የማስታወሻ ስም",
  "notes.create.defaultName": "ርዕስ የሌለው ማስታወሻ",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "ማስታወሻ ፍጠር",
  "dialog.note.create.name.label": "የማስታወሻ ስም",
  "dialog.note.create.name.placeholder": "ሐሳቦቼ",
  "dialog.note.create.confirm": "ፍጠር",
  "dialog.note.create.error.exists": "በዚህ ስም ማስታወሻ አስቀድሞ አለ።",
  "dialog.file.rename.title": "የፋይሉን ስም ቀይር",
  "dialog.file.rename.name.label": "አዲስ ስም",
  "dialog.file.rename.confirm": "ስም ቀይር",
  "dialog.file.rename.error.exists": "በዚህ ስም ፋይል አስቀድሞ አለ።",
  "dialog.file.delete.title": "ፋይሉን ሰርዝ",
  "dialog.file.delete.description": "“{{name}}” መሰረዝ እንደሚፈልጉ እርግጠኛ ነዎት? ይህ እርምጃ መመለስ አይቻልም።",
  "dialog.file.delete.confirm": "ሰርዝ",
  "dialog.file.create.title": "አዲስ ፋይል",
  "dialog.file.create.name.label": "የፋይል ስም",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "ፍጠር",
  "dialog.file.create.error.exists": "በዚህ ስም ፋይል አስቀድሞ አለ።",
  "dialog.directory.create.title": "አዲስ አቃፊ",
  "dialog.directory.create.name.label": "የአቃፊ ስም",
  "dialog.directory.create.name.placeholder": "የእኔ አቃፊ",
  "dialog.directory.create.confirm": "ፍጠር",
  "dialog.directory.create.error.exists": "በዚህ ስም አቃፊ አስቀድሞ አለ።",
  "dialog.directory.create.defaultName": "አዲስ አቃፊ",
  "dialog.directory.rename.title": "የአቃፊውን ስም ቀይር",
  "dialog.directory.delete.title": "አቃፊውን ሰርዝ",
  "dialog.directory.delete.description": "“{{name}}” እና ሁሉንም ይዘቱን ይሰረዝ? ይህ እርምጃ መመለስ አይቻልም።",
  "dialog.directory.delete.confirm": "ሰርዝ",
  "fileTree.action.rename": "ስም ቀይር",
  "fileTree.action.delete": "ሰርዝ",
  "fileTree.action.newFile": "አዲስ ፋይል",
  "fileTree.action.newDirectory": "አዲስ አቃፊ",
  "fileTree.action.newSubDirectory": "አዲስ ንዑስ አቃፊ",
  "toast.file.rename.failed.title": "የፋይሉን ስም መቀየር አልተቻለም",
  "toast.file.delete.failed.title": "ፋይሉን መሰረዝ አልተቻለም",
  "toast.file.create.failed.title": "ፋይሉን መፍጠር አልተቻለም",
  "toast.directory.create.failed.title": "አቃፊውን መፍጠር አልተቻለም",
  "toast.directory.delete.failed.title": "አቃፊውን መሰረዝ አልተቻለም",
  "toast.directory.rename.failed.title": "የአቃፊውን ስም መቀየር አልተቻለም",
  "settings.general.section.voice": "ድምፅ",
  "settings.general.voice.deepgramKey.title": "የDeepgram API ቁልፍ",
  "settings.general.voice.deepgramKey.description": "በጥያቄው ውስጥ የሚነገረውን ወደ ጽሑፍ ለመቀየር Deepgram ይጠቀሙ።",
  "settings.general.voice.deepgramKey.placeholder": "የDeepgram ቁልፍ ይለጥፉ",
  "settings.general.voice.language.title": "የድምፅ ቋንቋ",
  "settings.general.voice.language.description": "ለግልባጭ የሚያገለግል የDeepgram ቋንቋ ኮድ።",
  "settings.general.voice.model.title": "የድምፅ ሞዴል",
  "settings.general.voice.model.description": "ለግልባጭ የሚያገለግል የDeepgram ሞዴል።",
  "settings.general.section.support": "ስህተት አሳውቅ",
  "settings.support.row.bugEmail.title": "በኢሜይል",
  "settings.support.row.bugEmail.description": "ከመጫኛ መረጃዎ ጋር ለPrisme ቡድን መልእክት ይላኩ።",
  "settings.support.row.bugEmail.action": "ኢሜይል ጻፍ",
  "settings.support.row.bugIssue.title": "በGitHub ላይ",
  "settings.support.row.bugIssue.description": "አስቀድሞ የተሞላ የGitHub ቅጽ ክፈት (የGitHub መለያ ያስፈልጋል)።",
  "settings.support.row.bugIssue.action": "GitHub ክፈት",
  "voice.action.start": "ንባብ ጀምር",
  "voice.action.stop": "ንባብ አቁም",
  "voice.state.recording": "በመቅዳት ላይ",
  "voice.error.missingKey.title": "የDeepgram ቁልፍ ያስፈልጋል",
  "voice.error.missingKey.description": "በድምፅ ለማስገባት በቅንብሮች ውስጥ የDeepgram API ቁልፍዎን ያክሉ።",
  "voice.error.connection.title": "የድምፅ ግንኙነት አልተሳካም",
  "voice.error.connection.description": "ከDeepgram ጋር የነበረው ግንኙነት ተቋርጧል።",
  "voice.error.microphone.title": "ማይክሮፎን አይገኝም",
  "voice.error.microphone.description": "Prisme ወደ ማይክሮፎንዎ መድረስ አልቻለም።",
}
