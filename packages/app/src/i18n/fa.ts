export const dict = {
  ...
  "toast.file.notFound.title": "فایل پیدا نشد",
  "notes.empty.title": "هیچ یادداشتی باز نیست",
  "notes.empty.description": "فایلی را از مرورگر فایل انتخاب کنید یا یک یادداشت Markdown بسازید.",
  "notes.empty.create": "ایجاد یادداشت",
  "notes.create.prompt": "نام یادداشت",
  "notes.create.defaultName": "یادداشت بدون عنوان",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "ایجاد یادداشت",
  "dialog.note.create.name.label": "نام یادداشت",
  "dialog.note.create.name.placeholder": "ایده‌های من",
  "dialog.note.create.confirm": "ایجاد",
  "dialog.note.create.error.exists": "یادداشتی با این نام از قبل وجود دارد.",
  "dialog.file.rename.title": "تغییر نام فایل",
  "dialog.file.rename.name.label": "نام جدید",
  "dialog.file.rename.confirm": "تغییر نام",
  "dialog.file.rename.error.exists": "فایلی با این نام از قبل وجود دارد.",
  "dialog.file.delete.title": "حذف فایل",
  "dialog.file.delete.description": "آیا مطمئنید که می‌خواهید «{{name}}» را حذف کنید؟ این عمل قابل بازگشت نیست.",
  "dialog.file.delete.confirm": "حذف",
  "dialog.file.create.title": "فایل جدید",
  "dialog.file.create.name.label": "نام فایل",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "ایجاد",
  "dialog.file.create.error.exists": "فایلی با این نام از قبل وجود دارد.",
  "dialog.directory.create.title": "پوشه جدید",
  "dialog.directory.create.name.label": "نام پوشه",
  "dialog.directory.create.name.placeholder": "پوشه من",
  "dialog.directory.create.confirm": "ایجاد",
  "dialog.directory.create.error.exists": "پوشه‌ای با این نام از قبل وجود دارد.",
  "dialog.directory.create.defaultName": "پوشه جدید",
  "dialog.directory.rename.title": "تغییر نام پوشه",
  "dialog.directory.delete.title": "حذف پوشه",
  "dialog.directory.delete.description": "«{{name}}» و تمام محتوای آن حذف شود؟ این عمل قابل بازگشت نیست.",
  "dialog.directory.delete.confirm": "حذف",
  "fileTree.action.rename": "تغییر نام",
  "fileTree.action.delete": "حذف",
  "fileTree.action.newFile": "فایل جدید",
  "fileTree.action.newDirectory": "پوشه جدید",
  "fileTree.action.newSubDirectory": "زیرپوشه جدید",
  "toast.file.rename.failed.title": "تغییر نام فایل ناموفق بود",
  "toast.file.delete.failed.title": "حذف فایل ناموفق بود",
  "toast.file.create.failed.title": "ایجاد فایل ناموفق بود",
  "toast.directory.create.failed.title": "ایجاد پوشه ناموفق بود",
  "toast.directory.delete.failed.title": "حذف پوشه ناموفق بود",
  "toast.directory.rename.failed.title": "تغییر نام پوشه ناموفق بود",
  "settings.general.section.voice": "صدا",
  "settings.general.voice.deepgramKey.title": "کلید API دیپ‌گرم",
  "settings.general.voice.deepgramKey.description": "استفاده از Deepgram برای رونویسی گفتار در کادر درخواست.",
  "settings.general.voice.deepgramKey.placeholder": "کلید Deepgram را جای‌گذاری کنید",
  "settings.general.voice.language.title": "زبان گفتار",
  "settings.general.voice.language.description": "کد زبان Deepgram که برای رونویسی استفاده می‌شود.",
  "settings.general.voice.model.title": "مدل گفتار",
  "settings.general.voice.model.description": "مدل Deepgram که برای رونویسی استفاده می‌شود.",
  "settings.general.section.support": "گزارش اشکال",
  "settings.support.row.bugEmail.title": "از طریق ایمیل",
  "settings.support.row.bugEmail.description": "پیامی همراه با اطلاعات نصب خود به تیم Prisme بفرستید.",
  "settings.support.row.bugEmail.action": "نوشتن ایمیل",
  "settings.support.row.bugIssue.title": "در گیت‌هاب",
  "settings.support.row.bugIssue.description": "باز کردن فرم از پیش پرشدهٔ GitHub (به حساب GitHub نیاز دارد).",
  "settings.support.row.bugIssue.action": "باز کردن گیت‌هاب",
  "voice.action.start": "شروع گفتار",
  "voice.action.stop": "توقف گفتار",
  "voice.state.recording": "در حال ضبط",
  "voice.error.missingKey.title": "کلید Deepgram لازم است",
  "voice.error.missingKey.description": "برای استفاده از ورودی صوتی، کلید API دیپ‌گرم خود را در تنظیمات اضافه کنید.",
  "voice.error.connection.title": "اتصال صوتی ناموفق بود",
  "voice.error.connection.description": "اتصال به Deepgram قطع شد.",
  "voice.error.microphone.title": "میکروفون در دسترس نیست",
  "voice.error.microphone.description": "Prisme نتوانست به میکروفون شما دسترسی پیدا کند.",
}
