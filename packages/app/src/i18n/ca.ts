export const dict = {
  ...
  "toast.file.notFound.title": "Fitxer no trobat",
  "notes.empty.title": "Cap nota oberta",
  "notes.empty.description": "Trieu un fitxer a l'explorador o creeu una nota Markdown.",
  "notes.empty.create": "Crea una nota",
  "notes.create.prompt": "Nom de la nota",
  "notes.create.defaultName": "Nota sense títol",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Crea una nota",
  "dialog.note.create.name.label": "Nom de la nota",
  "dialog.note.create.name.placeholder": "Les meves idees",
  "dialog.note.create.confirm": "Crea",
  "dialog.note.create.error.exists": "Ja existeix una nota amb aquest nom.",
  "dialog.file.rename.title": "Canvia el nom del fitxer",
  "dialog.file.rename.name.label": "Nom nou",
  "dialog.file.rename.confirm": "Canvia el nom",
  "dialog.file.rename.error.exists": "Ja existeix un fitxer amb aquest nom.",
  "dialog.file.delete.title": "Suprimeix el fitxer",
  "dialog.file.delete.description": "Segur que voleu suprimir «{{name}}»? Aquesta acció no es pot desfer.",
  "dialog.file.delete.confirm": "Suprimeix",
  "dialog.file.create.title": "Fitxer nou",
  "dialog.file.create.name.label": "Nom del fitxer",
  "dialog.file.create.name.placeholder": "exemple.md",
  "dialog.file.create.confirm": "Crea",
  "dialog.file.create.error.exists": "Ja existeix un fitxer amb aquest nom.",
  "dialog.directory.create.title": "Carpeta nova",
  "dialog.directory.create.name.label": "Nom de la carpeta",
  "dialog.directory.create.name.placeholder": "La meva carpeta",
  "dialog.directory.create.confirm": "Crea",
  "dialog.directory.create.error.exists": "Ja existeix una carpeta amb aquest nom.",
  "dialog.directory.create.defaultName": "Carpeta nova",
  "dialog.directory.rename.title": "Canvia el nom de la carpeta",
  "dialog.directory.delete.title": "Suprimeix la carpeta",
  "dialog.directory.delete.description": "Voleu suprimir «{{name}}» i tot el seu contingut? Aquesta acció no es pot desfer.",
  "dialog.directory.delete.confirm": "Suprimeix",
  "fileTree.action.rename": "Canvia el nom",
  "fileTree.action.delete": "Suprimeix",
  "fileTree.action.newFile": "Fitxer nou",
  "fileTree.action.newDirectory": "Carpeta nova",
  "fileTree.action.newSubDirectory": "Subcarpeta nova",
  "toast.file.rename.failed.title": "No s'ha pogut canviar el nom del fitxer",
  "toast.file.delete.failed.title": "No s'ha pogut suprimir el fitxer",
  "toast.file.create.failed.title": "No s'ha pogut crear el fitxer",
  "toast.directory.create.failed.title": "No s'ha pogut crear la carpeta",
  "toast.directory.delete.failed.title": "No s'ha pogut suprimir la carpeta",
  "toast.directory.rename.failed.title": "No s'ha pogut canviar el nom de la carpeta",
  "settings.general.section.voice": "Veu",
  "settings.general.voice.deepgramKey.title": "Clau d'API de Deepgram",
  "settings.general.voice.deepgramKey.description": "Utilitza Deepgram per transcriure el dictat del prompt.",
  "settings.general.voice.deepgramKey.placeholder": "Enganxeu una clau de Deepgram",
  "settings.general.voice.language.title": "Idioma de la veu",
  "settings.general.voice.language.description": "Codi d'idioma de Deepgram utilitzat per a la transcripció.",
  "settings.general.voice.model.title": "Model de veu",
  "settings.general.voice.model.description": "Model de Deepgram utilitzat per a la transcripció.",
  "settings.general.section.support": "Informa d'un error",
  "settings.support.row.bugEmail.title": "Per correu",
  "settings.support.row.bugEmail.description": "Envieu un missatge a l'equip de Prisme amb la informació de la vostra instal·lació.",
  "settings.support.row.bugEmail.action": "Redacta un correu",
  "settings.support.row.bugIssue.title": "A GitHub",
  "settings.support.row.bugIssue.description": "Obre un formulari de GitHub predefinit (cal un compte de GitHub).",
  "settings.support.row.bugIssue.action": "Obre GitHub",
  "voice.action.start": "Inicia el dictat",
  "voice.action.stop": "Atura el dictat",
  "voice.state.recording": "Enregistrant",
  "voice.error.missingKey.title": "Cal una clau de Deepgram",
  "voice.error.missingKey.description": "Afegiu la vostra clau d'API de Deepgram a la configuració per fer servir l'entrada de veu.",
  "voice.error.connection.title": "Ha fallat la connexió de veu",
  "voice.error.connection.description": "La connexió amb Deepgram s'ha interromput.",
  "voice.error.microphone.title": "Micròfon no disponible",
  "voice.error.microphone.description": "Prisme no ha pogut accedir al micròfon.",
}
