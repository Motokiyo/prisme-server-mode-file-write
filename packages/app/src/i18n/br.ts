export const dict = {
  ...
  "toast.file.notFound.title": "Arquivo não encontrado",
  "notes.empty.title": "Nenhuma nota aberta",
  "notes.empty.description": "Escolha um arquivo no explorador ou crie uma nota Markdown.",
  "notes.empty.create": "Criar nota",
  "notes.create.prompt": "Nome da nota",
  "notes.create.defaultName": "Nota sem título",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Criar nota",
  "dialog.note.create.name.label": "Nome da nota",
  "dialog.note.create.name.placeholder": "Minhas ideias",
  "dialog.note.create.confirm": "Criar",
  "dialog.note.create.error.exists": "Já existe uma nota com este nome.",
  "dialog.file.rename.title": "Renomear arquivo",
  "dialog.file.rename.name.label": "Novo nome",
  "dialog.file.rename.confirm": "Renomear",
  "dialog.file.rename.error.exists": "Já existe um arquivo com este nome.",
  "dialog.file.delete.title": "Excluir arquivo",
  "dialog.file.delete.description": "Tem certeza de que deseja excluir “{{name}}”? Esta ação não pode ser desfeita.",
  "dialog.file.delete.confirm": "Excluir",
  "dialog.file.create.title": "Novo arquivo",
  "dialog.file.create.name.label": "Nome do arquivo",
  "dialog.file.create.name.placeholder": "exemplo.md",
  "dialog.file.create.confirm": "Criar",
  "dialog.file.create.error.exists": "Já existe um arquivo com este nome.",
  "dialog.directory.create.title": "Nova pasta",
  "dialog.directory.create.name.label": "Nome da pasta",
  "dialog.directory.create.name.placeholder": "Minha pasta",
  "dialog.directory.create.confirm": "Criar",
  "dialog.directory.create.error.exists": "Já existe uma pasta com este nome.",
  "dialog.directory.create.defaultName": "Nova pasta",
  "dialog.directory.rename.title": "Renomear pasta",
  "dialog.directory.delete.title": "Excluir pasta",
  "dialog.directory.delete.description": "Excluir “{{name}}” e todo o seu conteúdo? Esta ação não pode ser desfeita.",
  "dialog.directory.delete.confirm": "Excluir",
  "fileTree.action.rename": "Renomear",
  "fileTree.action.delete": "Excluir",
  "fileTree.action.newFile": "Novo arquivo",
  "fileTree.action.newDirectory": "Nova pasta",
  "fileTree.action.newSubDirectory": "Nova subpasta",
  "toast.file.rename.failed.title": "Falha ao renomear o arquivo",
  "toast.file.delete.failed.title": "Falha ao excluir o arquivo",
  "toast.file.create.failed.title": "Falha ao criar o arquivo",
  "toast.directory.create.failed.title": "Falha ao criar a pasta",
  "toast.directory.delete.failed.title": "Falha ao excluir a pasta",
  "toast.directory.rename.failed.title": "Falha ao renomear a pasta",
  "settings.general.section.voice": "Voz",
  "settings.general.voice.deepgramKey.title": "Chave de API do Deepgram",
  "settings.general.voice.deepgramKey.description": "Usar o Deepgram para transcrever o ditado no prompt.",
  "settings.general.voice.deepgramKey.placeholder": "Cole uma chave do Deepgram",
  "settings.general.voice.language.title": "Idioma da voz",
  "settings.general.voice.language.description": "Código de idioma do Deepgram usado na transcrição.",
  "settings.general.voice.model.title": "Modelo de voz",
  "settings.general.voice.model.description": "Modelo do Deepgram usado na transcrição.",
  "settings.general.section.support": "Relatar um bug",
  "settings.support.row.bugEmail.title": "Por e-mail",
  "settings.support.row.bugEmail.description": "Envie uma mensagem à equipe Prisme com as informações da sua instalação.",
  "settings.support.row.bugEmail.action": "Escrever e-mail",
  "settings.support.row.bugIssue.title": "No GitHub",
  "settings.support.row.bugIssue.description": "Abrir um formulário do GitHub pré-preenchido (conta do GitHub necessária).",
  "settings.support.row.bugIssue.action": "Abrir o GitHub",
  "voice.action.start": "Iniciar ditado",
  "voice.action.stop": "Parar ditado",
  "voice.state.recording": "Gravando",
  "voice.error.missingKey.title": "Chave do Deepgram necessária",
  "voice.error.missingKey.description": "Adicione sua chave de API do Deepgram nas configurações para usar a entrada por voz.",
  "voice.error.connection.title": "Falha na conexão de voz",
  "voice.error.connection.description": "A conexão com o Deepgram foi interrompida.",
  "voice.error.microphone.title": "Microfone indisponível",
  "voice.error.microphone.description": "O Prisme não conseguiu acessar seu microfone.",
}
