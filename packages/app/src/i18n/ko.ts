export const dict = {
  ...
  "toast.file.notFound.title": "파일을 찾을 수 없음",
  "notes.empty.title": "열려 있는 노트 없음",
  "notes.empty.description": "탐색기에서 파일을 선택하거나 Markdown 노트를 만드세요.",
  "notes.empty.create": "노트 만들기",
  "notes.create.prompt": "노트 이름",
  "notes.create.defaultName": "제목 없는 노트",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "노트 만들기",
  "dialog.note.create.name.label": "노트 이름",
  "dialog.note.create.name.placeholder": "내 아이디어",
  "dialog.note.create.confirm": "만들기",
  "dialog.note.create.error.exists": "같은 이름의 노트가 이미 있습니다.",
  "dialog.file.rename.title": "파일 이름 바꾸기",
  "dialog.file.rename.name.label": "새 이름",
  "dialog.file.rename.confirm": "이름 바꾸기",
  "dialog.file.rename.error.exists": "같은 이름의 파일이 이미 있습니다.",
  "dialog.file.delete.title": "파일 삭제",
  "dialog.file.delete.description": "“{{name}}”을(를) 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.",
  "dialog.file.delete.confirm": "삭제",
  "dialog.file.create.title": "새 파일",
  "dialog.file.create.name.label": "파일 이름",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "만들기",
  "dialog.file.create.error.exists": "같은 이름의 파일이 이미 있습니다.",
  "dialog.directory.create.title": "새 폴더",
  "dialog.directory.create.name.label": "폴더 이름",
  "dialog.directory.create.name.placeholder": "내 폴더",
  "dialog.directory.create.confirm": "만들기",
  "dialog.directory.create.error.exists": "같은 이름의 폴더가 이미 있습니다.",
  "dialog.directory.create.defaultName": "새 폴더",
  "dialog.directory.rename.title": "폴더 이름 바꾸기",
  "dialog.directory.delete.title": "폴더 삭제",
  "dialog.directory.delete.description": "“{{name}}”와(과) 모든 내용을 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.",
  "dialog.directory.delete.confirm": "삭제",
  "fileTree.action.rename": "이름 바꾸기",
  "fileTree.action.delete": "삭제",
  "fileTree.action.newFile": "새 파일",
  "fileTree.action.newDirectory": "새 폴더",
  "fileTree.action.newSubDirectory": "새 하위 폴더",
  "toast.file.rename.failed.title": "파일 이름을 바꾸지 못했습니다",
  "toast.file.delete.failed.title": "파일을 삭제하지 못했습니다",
  "toast.file.create.failed.title": "파일을 만들지 못했습니다",
  "toast.directory.create.failed.title": "폴더를 만들지 못했습니다",
  "toast.directory.delete.failed.title": "폴더를 삭제하지 못했습니다",
  "toast.directory.rename.failed.title": "폴더 이름을 바꾸지 못했습니다",
  "settings.general.section.voice": "음성",
  "settings.general.voice.deepgramKey.title": "Deepgram API 키",
  "settings.general.voice.deepgramKey.description": "Deepgram을 사용해 프롬프트 받아쓰기를 전사합니다.",
  "settings.general.voice.deepgramKey.placeholder": "Deepgram 키를 붙여넣으세요",
  "settings.general.voice.language.title": "음성 언어",
  "settings.general.voice.language.description": "전사에 사용되는 Deepgram 언어 코드입니다.",
  "settings.general.voice.model.title": "음성 모델",
  "settings.general.voice.model.description": "전사에 사용되는 Deepgram 모델입니다.",
  "settings.general.section.support": "버그 공유",
  "settings.support.row.bugEmail.title": "이메일로",
  "settings.support.row.bugEmail.description": "설치 정보와 함께 Prisme 팀에 메시지를 보냅니다.",
  "settings.support.row.bugEmail.action": "이메일 작성",
  "settings.support.row.bugIssue.title": "GitHub에서",
  "settings.support.row.bugIssue.description": "미리 채워진 GitHub 양식을 엽니다(GitHub 계정 필요).",
  "settings.support.row.bugIssue.action": "GitHub 열기",
  "voice.action.start": "받아쓰기 시작",
  "voice.action.stop": "받아쓰기 중지",
  "voice.state.recording": "녹음 중",
  "voice.error.missingKey.title": "Deepgram 키 필요",
  "voice.error.missingKey.description": "음성 입력을 사용하려면 설정에서 Deepgram API 키를 추가하세요.",
  "voice.error.connection.title": "음성 연결 실패",
  "voice.error.connection.description": "Deepgram 연결이 중단되었습니다.",
  "voice.error.microphone.title": "마이크를 사용할 수 없음",
  "voice.error.microphone.description": "Prisme이 마이크에 접근하지 못했습니다.",
}
