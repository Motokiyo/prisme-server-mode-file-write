export const dict = {
  ...
  "toast.file.notFound.title": "ファイルが見つかりません",
  "notes.empty.title": "開いているノートがありません",
  "notes.empty.description": "エクスプローラーでファイルを選択するか、Markdown ノートを作成してください。",
  "notes.empty.create": "ノートを作成",
  "notes.create.prompt": "ノート名",
  "notes.create.defaultName": "無題のノート",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "ノートを作成",
  "dialog.note.create.name.label": "ノート名",
  "dialog.note.create.name.placeholder": "アイデア",
  "dialog.note.create.confirm": "作成",
  "dialog.note.create.error.exists": "同じ名前のノートがすでに存在します。",
  "dialog.file.rename.title": "ファイル名を変更",
  "dialog.file.rename.name.label": "新しい名前",
  "dialog.file.rename.confirm": "名前を変更",
  "dialog.file.rename.error.exists": "同じ名前のファイルがすでに存在します。",
  "dialog.file.delete.title": "ファイルを削除",
  "dialog.file.delete.description": "「{{name}}」を削除してもよろしいですか？この操作は取り消せません。",
  "dialog.file.delete.confirm": "削除",
  "dialog.file.create.title": "新規ファイル",
  "dialog.file.create.name.label": "ファイル名",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "作成",
  "dialog.file.create.error.exists": "同じ名前のファイルがすでに存在します。",
  "dialog.directory.create.title": "新規フォルダー",
  "dialog.directory.create.name.label": "フォルダー名",
  "dialog.directory.create.name.placeholder": "マイフォルダー",
  "dialog.directory.create.confirm": "作成",
  "dialog.directory.create.error.exists": "同じ名前のフォルダーがすでに存在します。",
  "dialog.directory.create.defaultName": "新規フォルダー",
  "dialog.directory.rename.title": "フォルダー名を変更",
  "dialog.directory.delete.title": "フォルダーを削除",
  "dialog.directory.delete.description": "「{{name}}」とその内容をすべて削除しますか？この操作は取り消せません。",
  "dialog.directory.delete.confirm": "削除",
  "fileTree.action.rename": "名前を変更",
  "fileTree.action.delete": "削除",
  "fileTree.action.newFile": "新規ファイル",
  "fileTree.action.newDirectory": "新規フォルダー",
  "fileTree.action.newSubDirectory": "新規サブフォルダー",
  "toast.file.rename.failed.title": "ファイル名の変更に失敗しました",
  "toast.file.delete.failed.title": "ファイルの削除に失敗しました",
  "toast.file.create.failed.title": "ファイルの作成に失敗しました",
  "toast.directory.create.failed.title": "フォルダーの作成に失敗しました",
  "toast.directory.delete.failed.title": "フォルダーの削除に失敗しました",
  "toast.directory.rename.failed.title": "フォルダー名の変更に失敗しました",
  "settings.general.section.voice": "音声",
  "settings.general.voice.deepgramKey.title": "Deepgram API キー",
  "settings.general.voice.deepgramKey.description": "Deepgram を使ってプロンプトの音声入力を文字起こしします。",
  "settings.general.voice.deepgramKey.placeholder": "Deepgram のキーを貼り付け",
  "settings.general.voice.language.title": "音声の言語",
  "settings.general.voice.language.description": "文字起こしに使用する Deepgram の言語コード。",
  "settings.general.voice.model.title": "音声モデル",
  "settings.general.voice.model.description": "文字起こしに使用する Deepgram のモデル。",
  "settings.general.section.support": "不具合を報告",
  "settings.support.row.bugEmail.title": "メールで",
  "settings.support.row.bugEmail.description": "インストール情報を添えて Prisme チームにメッセージを送信します。",
  "settings.support.row.bugEmail.action": "メールを作成",
  "settings.support.row.bugIssue.title": "GitHub で",
  "settings.support.row.bugIssue.description": "入力済みの GitHub フォームを開きます（GitHub アカウントが必要です）。",
  "settings.support.row.bugIssue.action": "GitHub を開く",
  "voice.action.start": "音声入力を開始",
  "voice.action.stop": "音声入力を停止",
  "voice.state.recording": "録音中",
  "voice.error.missingKey.title": "Deepgram キーが必要です",
  "voice.error.missingKey.description": "音声入力を使用するには、設定で Deepgram API キーを追加してください。",
  "voice.error.connection.title": "音声接続に失敗しました",
  "voice.error.connection.description": "Deepgram との接続が中断されました。",
  "voice.error.microphone.title": "マイクを利用できません",
  "voice.error.microphone.description": "Prisme はマイクにアクセスできませんでした。",
}
