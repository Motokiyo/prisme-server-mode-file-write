export const dict = {
  ...
  "toast.file.notFound.title": "Tiedostoa ei löytynyt",
  "notes.empty.title": "Ei avattua muistiinpanoa",
  "notes.empty.description": "Valitse tiedosto resurssienhallinnasta tai luo Markdown-muistiinpano.",
  "notes.empty.create": "Luo muistiinpano",
  "notes.create.prompt": "Muistiinpanon nimi",
  "notes.create.defaultName": "Nimetön muistiinpano",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Luo muistiinpano",
  "dialog.note.create.name.label": "Muistiinpanon nimi",
  "dialog.note.create.name.placeholder": "Ideani",
  "dialog.note.create.confirm": "Luo",
  "dialog.note.create.error.exists": "Tämänniminen muistiinpano on jo olemassa.",
  "dialog.file.rename.title": "Nimeä tiedosto uudelleen",
  "dialog.file.rename.name.label": "Uusi nimi",
  "dialog.file.rename.confirm": "Nimeä uudelleen",
  "dialog.file.rename.error.exists": "Tämänniminen tiedosto on jo olemassa.",
  "dialog.file.delete.title": "Poista tiedosto",
  "dialog.file.delete.description": "Haluatko varmasti poistaa kohteen ”{{name}}”? Toimintoa ei voi kumota.",
  "dialog.file.delete.confirm": "Poista",
  "dialog.file.create.title": "Uusi tiedosto",
  "dialog.file.create.name.label": "Tiedoston nimi",
  "dialog.file.create.name.placeholder": "esimerkki.md",
  "dialog.file.create.confirm": "Luo",
  "dialog.file.create.error.exists": "Tämänniminen tiedosto on jo olemassa.",
  "dialog.directory.create.title": "Uusi kansio",
  "dialog.directory.create.name.label": "Kansion nimi",
  "dialog.directory.create.name.placeholder": "Oma kansio",
  "dialog.directory.create.confirm": "Luo",
  "dialog.directory.create.error.exists": "Tämänniminen kansio on jo olemassa.",
  "dialog.directory.create.defaultName": "Uusi kansio",
  "dialog.directory.rename.title": "Nimeä kansio uudelleen",
  "dialog.directory.delete.title": "Poista kansio",
  "dialog.directory.delete.description": "Poistetaanko ”{{name}}” ja koko sen sisältö? Toimintoa ei voi kumota.",
  "dialog.directory.delete.confirm": "Poista",
  "fileTree.action.rename": "Nimeä uudelleen",
  "fileTree.action.delete": "Poista",
  "fileTree.action.newFile": "Uusi tiedosto",
  "fileTree.action.newDirectory": "Uusi kansio",
  "fileTree.action.newSubDirectory": "Uusi alikansio",
  "toast.file.rename.failed.title": "Tiedoston nimeäminen uudelleen epäonnistui",
  "toast.file.delete.failed.title": "Tiedoston poistaminen epäonnistui",
  "toast.file.create.failed.title": "Tiedoston luominen epäonnistui",
  "toast.directory.create.failed.title": "Kansion luominen epäonnistui",
  "toast.directory.delete.failed.title": "Kansion poistaminen epäonnistui",
  "toast.directory.rename.failed.title": "Kansion nimeäminen uudelleen epäonnistui",
  "settings.general.section.voice": "Ääni",
  "settings.general.voice.deepgramKey.title": "Deepgramin API-avain",
  "settings.general.voice.deepgramKey.description": "Käytä Deepgramia kehotteen sanelun litterointiin.",
  "settings.general.voice.deepgramKey.placeholder": "Liitä Deepgram-avain",
  "settings.general.voice.language.title": "Sanelun kieli",
  "settings.general.voice.language.description": "Litteroinnissa käytettävä Deepgramin kielikoodi.",
  "settings.general.voice.model.title": "Sanelumalli",
  "settings.general.voice.model.description": "Litteroinnissa käytettävä Deepgram-malli.",
  "settings.general.section.support": "Ilmoita virheestä",
  "settings.support.row.bugEmail.title": "Sähköpostitse",
  "settings.support.row.bugEmail.description": "Lähetä Prisme-tiimille viesti, joka sisältää asennuksesi tiedot.",
  "settings.support.row.bugEmail.action": "Kirjoita sähköposti",
  "settings.support.row.bugIssue.title": "GitHubissa",
  "settings.support.row.bugIssue.description": "Avaa esitäytetty GitHub-lomake (vaatii GitHub-tilin).",
  "settings.support.row.bugIssue.action": "Avaa GitHub",
  "voice.action.start": "Aloita sanelu",
  "voice.action.stop": "Lopeta sanelu",
  "voice.state.recording": "Tallentaa",
  "voice.error.missingKey.title": "Deepgram-avain vaaditaan",
  "voice.error.missingKey.description": "Lisää Deepgramin API-avaimesi asetuksiin, jotta voit käyttää puhesyöttöä.",
  "voice.error.connection.title": "Puheyhteys epäonnistui",
  "voice.error.connection.description": "Yhteys Deepgramiin katkesi.",
  "voice.error.microphone.title": "Mikrofoni ei ole käytettävissä",
  "voice.error.microphone.description": "Prisme ei voinut käyttää mikrofoniasi.",
}
