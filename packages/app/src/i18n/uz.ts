export const dict = {
  ...
  "toast.file.notFound.title": "Fayl topilmadi",
  "notes.empty.title": "Ochiq eslatma yoʻq",
  "notes.empty.description": "Tadqiqotchidan fayl tanlang yoki Markdown eslatmasi yarating.",
  "notes.empty.create": "Eslatma yaratish",
  "notes.create.prompt": "Eslatma nomi",
  "notes.create.defaultName": "Nomsiz eslatma",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Eslatma yaratish",
  "dialog.note.create.name.label": "Eslatma nomi",
  "dialog.note.create.name.placeholder": "Mening gʻoyalarim",
  "dialog.note.create.confirm": "Yaratish",
  "dialog.note.create.error.exists": "Bu nomdagi eslatma allaqachon mavjud.",
  "dialog.file.rename.title": "Fayl nomini oʻzgartirish",
  "dialog.file.rename.name.label": "Yangi nom",
  "dialog.file.rename.confirm": "Nomini oʻzgartirish",
  "dialog.file.rename.error.exists": "Bu nomdagi fayl allaqachon mavjud.",
  "dialog.file.delete.title": "Faylni oʻchirish",
  "dialog.file.delete.description": "“{{name}}” faylini oʻchirmoqchimisiz? Bu amalni qaytarib boʻlmaydi.",
  "dialog.file.delete.confirm": "Oʻchirish",
  "dialog.file.create.title": "Yangi fayl",
  "dialog.file.create.name.label": "Fayl nomi",
  "dialog.file.create.name.placeholder": "namuna.md",
  "dialog.file.create.confirm": "Yaratish",
  "dialog.file.create.error.exists": "Bu nomdagi fayl allaqachon mavjud.",
  "dialog.directory.create.title": "Yangi jild",
  "dialog.directory.create.name.label": "Jild nomi",
  "dialog.directory.create.name.placeholder": "Mening jildim",
  "dialog.directory.create.confirm": "Yaratish",
  "dialog.directory.create.error.exists": "Bu nomdagi jild allaqachon mavjud.",
  "dialog.directory.create.defaultName": "Yangi jild",
  "dialog.directory.rename.title": "Jild nomini oʻzgartirish",
  "dialog.directory.delete.title": "Jildni oʻchirish",
  "dialog.directory.delete.description": "“{{name}}” jildi va uning barcha mazmuni oʻchirilsinmi? Bu amalni qaytarib boʻlmaydi.",
  "dialog.directory.delete.confirm": "Oʻchirish",
  "fileTree.action.rename": "Nomini oʻzgartirish",
  "fileTree.action.delete": "Oʻchirish",
  "fileTree.action.newFile": "Yangi fayl",
  "fileTree.action.newDirectory": "Yangi jild",
  "fileTree.action.newSubDirectory": "Yangi ichki jild",
  "toast.file.rename.failed.title": "Fayl nomini oʻzgartirib boʻlmadi",
  "toast.file.delete.failed.title": "Faylni oʻchirib boʻlmadi",
  "toast.file.create.failed.title": "Faylni yaratib boʻlmadi",
  "toast.directory.create.failed.title": "Jildni yaratib boʻlmadi",
  "toast.directory.delete.failed.title": "Jildni oʻchirib boʻlmadi",
  "toast.directory.rename.failed.title": "Jild nomini oʻzgartirib boʻlmadi",
  "settings.general.section.voice": "Ovoz",
  "settings.general.voice.deepgramKey.title": "Deepgram API kaliti",
  "settings.general.voice.deepgramKey.description": "Soʻrov maydonidagi diktovkani matnga aylantirish uchun Deepgram’dan foydalaning.",
  "settings.general.voice.deepgramKey.placeholder": "Deepgram kalitini joylashtiring",
  "settings.general.voice.language.title": "Ovoz tili",
  "settings.general.voice.language.description": "Matnga aylantirishda ishlatiladigan Deepgram til kodi.",
  "settings.general.voice.model.title": "Ovoz modeli",
  "settings.general.voice.model.description": "Matnga aylantirishda ishlatiladigan Deepgram modeli.",
  "settings.general.section.support": "Xatolik haqida xabar berish",
  "settings.support.row.bugEmail.title": "Elektron pochta orqali",
  "settings.support.row.bugEmail.description": "Oʻrnatish maʼlumotlaringiz bilan Prisme jamoasiga xabar yuboring.",
  "settings.support.row.bugEmail.action": "Xat yozish",
  "settings.support.row.bugIssue.title": "GitHub’da",
  "settings.support.row.bugIssue.description": "Oldindan toʻldirilgan GitHub shaklini oching (GitHub hisobi kerak).",
  "settings.support.row.bugIssue.action": "GitHub’ni ochish",
  "voice.action.start": "Diktovkani boshlash",
  "voice.action.stop": "Diktovkani toʻxtatish",
  "voice.state.recording": "Yozib olinmoqda",
  "voice.error.missingKey.title": "Deepgram kaliti kerak",
  "voice.error.missingKey.description": "Ovozli kiritishdan foydalanish uchun sozlamalarga Deepgram API kalitingizni qoʻshing.",
  "voice.error.connection.title": "Ovozli ulanish amalga oshmadi",
  "voice.error.connection.description": "Deepgram bilan ulanish uzildi.",
  "voice.error.microphone.title": "Mikrofon mavjud emas",
  "voice.error.microphone.description": "Prisme mikrofoningizga kira olmadi.",
}
