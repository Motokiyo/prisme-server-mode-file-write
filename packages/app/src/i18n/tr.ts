...
export const dict = {
  ...
  "toast.file.notFound.title": "Dosya bulunamadı",
  "notes.empty.title": "Açık not yok",
  "notes.empty.description": "Gezginden bir dosya seçin ya da bir Markdown notu oluşturun.",
  "notes.empty.create": "Not oluştur",
  "notes.create.prompt": "Not adı",
  "notes.create.defaultName": "Adsız not",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Not oluştur",
  "dialog.note.create.name.label": "Not adı",
  "dialog.note.create.name.placeholder": "Fikirlerim",
  "dialog.note.create.confirm": "Oluştur",
  "dialog.note.create.error.exists": "Bu ada sahip bir not zaten var.",
  "dialog.file.rename.title": "Dosyayı yeniden adlandır",
  "dialog.file.rename.name.label": "Yeni ad",
  "dialog.file.rename.confirm": "Yeniden adlandır",
  "dialog.file.rename.error.exists": "Bu ada sahip bir dosya zaten var.",
  "dialog.file.delete.title": "Dosyayı sil",
  "dialog.file.delete.description": "“{{name}}” dosyasını silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.",
  "dialog.file.delete.confirm": "Sil",
  "dialog.file.create.title": "Yeni dosya",
  "dialog.file.create.name.label": "Dosya adı",
  "dialog.file.create.name.placeholder": "ornek.md",
  "dialog.file.create.confirm": "Oluştur",
  "dialog.file.create.error.exists": "Bu ada sahip bir dosya zaten var.",
  "dialog.directory.create.title": "Yeni klasör",
  "dialog.directory.create.name.label": "Klasör adı",
  "dialog.directory.create.name.placeholder": "Klasörüm",
  "dialog.directory.create.confirm": "Oluştur",
  "dialog.directory.create.error.exists": "Bu ada sahip bir klasör zaten var.",
  "dialog.directory.create.defaultName": "Yeni klasör",
  "dialog.directory.rename.title": "Klasörü yeniden adlandır",
  "dialog.directory.delete.title": "Klasörü sil",
  "dialog.directory.delete.description": "“{{name}}” klasörü ve tüm içeriği silinsin mi? Bu işlem geri alınamaz.",
  "dialog.directory.delete.confirm": "Sil",
  "fileTree.action.rename": "Yeniden adlandır",
  "fileTree.action.delete": "Sil",
  "fileTree.action.newFile": "Yeni dosya",
  "fileTree.action.newDirectory": "Yeni klasör",
  "fileTree.action.newSubDirectory": "Yeni alt klasör",
  "toast.file.rename.failed.title": "Dosya yeniden adlandırılamadı",
  "toast.file.delete.failed.title": "Dosya silinemedi",
  "toast.file.create.failed.title": "Dosya oluşturulamadı",
  "toast.directory.create.failed.title": "Klasör oluşturulamadı",
  "toast.directory.delete.failed.title": "Klasör silinemedi",
  "toast.directory.rename.failed.title": "Klasör yeniden adlandırılamadı",
  "settings.general.section.voice": "Ses",
  "settings.general.voice.deepgramKey.title": "Deepgram API anahtarı",
  "settings.general.voice.deepgramKey.description": "İstem alanındaki dikteyi yazıya dökmek için Deepgram kullanın.",
  "settings.general.voice.deepgramKey.placeholder": "Bir Deepgram anahtarı yapıştırın",
  "settings.general.voice.language.title": "Ses dili",
  "settings.general.voice.language.description": "Yazıya dökme için kullanılan Deepgram dil kodu.",
  "settings.general.voice.model.title": "Ses modeli",
  "settings.general.voice.model.description": "Yazıya dökme için kullanılan Deepgram modeli.",
  "settings.general.section.support": "Hata bildir",
  "settings.support.row.bugEmail.title": "E-posta ile",
  "settings.support.row.bugEmail.description": "Kurulum bilgilerinizle birlikte Prisme ekibine bir mesaj gönderin.",
  "settings.support.row.bugEmail.action": "E-posta yaz",
  "settings.support.row.bugIssue.title": "GitHub'da",
  "settings.support.row.bugIssue.description": "Önceden doldurulmuş bir GitHub formu açın (GitHub hesabı gerekir).",
  "settings.support.row.bugIssue.action": "GitHub'ı aç",
  "voice.action.start": "Dikteyi başlat",
  "voice.action.stop": "Dikteyi durdur",
  "voice.state.recording": "Kaydediliyor",
  "voice.error.missingKey.title": "Deepgram anahtarı gerekli",
  "voice.error.missingKey.description": "Sesli girişi kullanmak için ayarlarda Deepgram API anahtarınızı ekleyin.",
  "voice.error.connection.title": "Ses bağlantısı başarısız",
  "voice.error.connection.description": "Deepgram bağlantısı kesildi.",
  "voice.error.microphone.title": "Mikrofon kullanılamıyor",
  "voice.error.microphone.description": "Prisme mikrofonunuza erişemedi.",
