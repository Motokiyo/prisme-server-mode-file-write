...
export const dict = {
  ...
  "dialog.file.rename.confirm": "Preimenovati",
  "dialog.file.rename.error.exists": "Datoteka s ovim nazivom već postoji.",
  "dialog.file.delete.title": "Izbriši datoteku",
  "dialog.file.delete.description": "Jeste li sigurni da želite izbrisati „{{name}}”? Ova se radnja ne može poništiti.",
  ...
  "dialog.file.create.confirm": "Stvori",
  "dialog.file.create.error.exists": "Datoteka s ovim nazivom već postoji.",
  "dialog.directory.create.title": "Nova mapa",
  "dialog.directory.create.name.label": "Naziv mape",
  "dialog.directory.create.name.placeholder": "Moja mapa",
  "dialog.directory.create.confirm": "Stvori",
  "dialog.directory.create.error.exists": "Mapa s ovim nazivom već postoji.",
  "dialog.directory.create.defaultName": "Nova mapa",
  "dialog.directory.rename.title": "Preimenuj mapu",
  "dialog.directory.delete.title": "Izbriši mapu",
  "dialog.directory.delete.description": "Izbrisati „{{name}}” i sav njezin sadržaj? Ova se radnja ne može poništiti.",
  "dialog.directory.delete.confirm": "Izbriši",
  "fileTree.action.rename": "Preimenovati",
  "fileTree.action.delete": "Izbriši",
  "fileTree.action.newFile": "Nova datoteka",
  "fileTree.action.newDirectory": "Nova mapa",
  "fileTree.action.newSubDirectory": "Nova podmapa",
  ...
  "toast.file.create.failed.title": "Datoteku nije bilo moguće stvoriti",
  "toast.directory.create.failed.title": "Mapu nije bilo moguće stvoriti",
  "toast.directory.delete.failed.title": "Mapu nije bilo moguće izbrisati",
  "toast.directory.rename.failed.title": "Mapu nije bilo moguće preimenovati",
  ...
  "settings.support.row.bugIssue.description": "Otvori unaprijed ispunjen GitHub obrazac (potreban je GitHub račun).",
  ...
  "voice.error.missingKey.description": "Dodajte svoj Deepgram API ključ u postavkama kako biste koristili glasovni unos.",
