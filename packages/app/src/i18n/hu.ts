...
export const dict = {
  ...
  "toast.file.notFound.title": "A fájl nem található",
  "notes.empty.title": "Nincs megnyitott jegyzet",
  "notes.empty.description": "Válasszon ki egy fájlt a böngészőben, vagy hozzon létre egy Markdown jegyzetet.",
  "notes.empty.create": "Jegyzet létrehozása",
  "notes.create.prompt": "Jegyzet neve",
  "notes.create.defaultName": "Névtelen jegyzet",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Jegyzet létrehozása",
  "dialog.note.create.name.label": "Jegyzet neve",
  "dialog.note.create.name.placeholder": "Ötleteim",
  "dialog.note.create.confirm": "Létrehozás",
  "dialog.note.create.error.exists": "Már létezik ilyen nevű jegyzet.",
  "dialog.file.rename.title": "Fájl átnevezése",
  "dialog.file.rename.name.label": "Új név",
  "dialog.file.rename.confirm": "Átnevezés",
  "dialog.file.rename.error.exists": "Már létezik ilyen nevű fájl.",
  "dialog.file.delete.title": "Fájl törlése",
  "dialog.file.delete.description": "Biztosan törli a(z) „{{name}}” fájlt? Ez a művelet nem vonható vissza.",
  "dialog.file.delete.confirm": "Törlés",
  "dialog.file.create.title": "Új fájl",
  "dialog.file.create.name.label": "Fájlnév",
  "dialog.file.create.name.placeholder": "pelda.md",
  "dialog.file.create.confirm": "Létrehozás",
  "dialog.file.create.error.exists": "Már létezik ilyen nevű fájl.",
  "dialog.directory.create.title": "Új mappa",
  "dialog.directory.create.name.label": "Mappa neve",
  "dialog.directory.create.name.placeholder": "Saját mappa",
  "dialog.directory.create.confirm": "Létrehozás",
  "dialog.directory.create.error.exists": "Már létezik ilyen nevű mappa.",
  "dialog.directory.create.defaultName": "Új mappa",
  "dialog.directory.rename.title": "Mappa átnevezése",
  "dialog.directory.delete.title": "Mappa törlése",
  "dialog.directory.delete.description": "Törli a(z) „{{name}}” mappát és a teljes tartalmát? Ez a művelet nem vonható vissza.",
  "dialog.directory.delete.confirm": "Törlés",
  "fileTree.action.rename": "Átnevezés",
  "fileTree.action.delete": "Törlés",
  "fileTree.action.newFile": "Új fájl",
  "fileTree.action.newDirectory": "Új mappa",
  "fileTree.action.newSubDirectory": "Új almappa",
  "toast.file.rename.failed.title": "A fájl átnevezése nem sikerült",
  "toast.file.delete.failed.title": "A fájl törlése nem sikerült",
  "toast.file.create.failed.title": "A fájl létrehozása nem sikerült",
  "toast.directory.create.failed.title": "A mappa létrehozása nem sikerült",
  "toast.directory.delete.failed.title": "A mappa törlése nem sikerült",
  "toast.directory.rename.failed.title": "A mappa átnevezése nem sikerült",
  "settings.general.section.voice": "Hang",
  "settings.general.voice.deepgramKey.title": "Deepgram API-kulcs",
  "settings.general.voice.deepgramKey.description": "A Deepgram használata a promptban elhangzó diktálás leiratozásához.",
  "settings.general.voice.deepgramKey.placeholder": "Illesszen be egy Deepgram-kulcsot",
  "settings.general.voice.language.title": "Hang nyelve",
  "settings.general.voice.language.description": "A leiratozáshoz használt Deepgram nyelvi kód.",
  "settings.general.voice.model.title": "Hangmodell",
  "settings.general.voice.model.description": "A leiratozáshoz használt Deepgram modell.",
  "settings.general.section.support": "Hiba jelentése",
  "settings.support.row.bugEmail.title": "E-mailben",
  "settings.support.row.bugEmail.description": "Küldjön üzenetet a Prisme csapatának a telepítés adataival együtt.",
  "settings.support.row.bugEmail.action": "E-mail írása",
  "settings.support.row.bugIssue.title": "GitHubon",
  "settings.support.row.bugIssue.description": "Előre kitöltött GitHub-űrlap megnyitása (GitHub-fiók szükséges).",
  "settings.support.row.bugIssue.action": "GitHub megnyitása",
  "voice.action.start": "Diktálás indítása",
  "voice.action.stop": "Diktálás leállítása",
  "voice.state.recording": "Felvétel folyamatban",
  "voice.error.missingKey.title": "Deepgram-kulcs szükséges",
  "voice.error.missingKey.description": "A hangbevitel használatához adja hozzá Deepgram API-kulcsát a beállításokban.",
  "voice.error.connection.title": "A hangkapcsolat sikertelen",
  "voice.error.connection.description": "A Deepgram-kapcsolat megszakadt.",
  "voice.error.microphone.title": "A mikrofon nem érhető el",
  "voice.error.microphone.description": "A Prisme nem tudott hozzáférni a mikrofonjához.",
}
