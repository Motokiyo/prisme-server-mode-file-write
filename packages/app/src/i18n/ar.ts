export const dict = {
  ...
  "toast.file.notFound.title": "لم يتم العثور على الملف",
  "notes.empty.title": "لا توجد ملاحظة مفتوحة",
  "notes.empty.description": "اختر ملفًا من المستكشف أو أنشئ ملاحظة Markdown.",
  "notes.empty.create": "إنشاء ملاحظة",
  "notes.create.prompt": "اسم الملاحظة",
  "notes.create.defaultName": "ملاحظة بدون عنوان",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "إنشاء ملاحظة",
  "dialog.note.create.name.label": "اسم الملاحظة",
  "dialog.note.create.name.placeholder": "أفكاري",
  "dialog.note.create.confirm": "إنشاء",
  "dialog.note.create.error.exists": "توجد ملاحظة بهذا الاسم بالفعل.",
  "dialog.file.rename.title": "إعادة تسمية الملف",
  "dialog.file.rename.name.label": "الاسم الجديد",
  "dialog.file.rename.confirm": "إعادة تسمية",
  "dialog.file.rename.error.exists": "يوجد ملف بهذا الاسم بالفعل.",
  "dialog.file.delete.title": "حذف الملف",
  "dialog.file.delete.description": "هل أنت متأكد من حذف «{{name}}»؟ لا يمكن التراجع عن هذا الإجراء.",
  "dialog.file.delete.confirm": "حذف",
  "dialog.file.create.title": "ملف جديد",
  "dialog.file.create.name.label": "اسم الملف",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "إنشاء",
  "dialog.file.create.error.exists": "يوجد ملف بهذا الاسم بالفعل.",
  "dialog.directory.create.title": "مجلد جديد",
  "dialog.directory.create.name.label": "اسم المجلد",
  "dialog.directory.create.name.placeholder": "مجلدي",
  "dialog.directory.create.confirm": "إنشاء",
  "dialog.directory.create.error.exists": "يوجد مجلد بهذا الاسم بالفعل.",
  "dialog.directory.create.defaultName": "مجلد جديد",
  "dialog.directory.rename.title": "إعادة تسمية المجلد",
  "dialog.directory.delete.title": "حذف المجلد",
  "dialog.directory.delete.description": "حذف «{{name}}» وكل محتوياته؟ لا يمكن التراجع عن هذا الإجراء.",
  "dialog.directory.delete.confirm": "حذف",
  "fileTree.action.rename": "إعادة تسمية",
  "fileTree.action.delete": "حذف",
  "fileTree.action.newFile": "ملف جديد",
  "fileTree.action.newDirectory": "مجلد جديد",
  "fileTree.action.newSubDirectory": "مجلد فرعي جديد",
  "toast.file.rename.failed.title": "تعذّرت إعادة تسمية الملف",
  "toast.file.delete.failed.title": "تعذّر حذف الملف",
  "toast.file.create.failed.title": "تعذّر إنشاء الملف",
  "toast.directory.create.failed.title": "تعذّر إنشاء المجلد",
  "toast.directory.delete.failed.title": "تعذّر حذف المجلد",
  "toast.directory.rename.failed.title": "تعذّرت إعادة تسمية المجلد",
  "settings.general.section.voice": "الصوت",
  "settings.general.voice.deepgramKey.title": "مفتاح Deepgram API",
  "settings.general.voice.deepgramKey.description": "استخدام Deepgram لتفريغ الإملاء الصوتي في حقل الطلب.",
  "settings.general.voice.deepgramKey.placeholder": "الصق مفتاح Deepgram",
  "settings.general.voice.language.title": "لغة الصوت",
  "settings.general.voice.language.description": "رمز اللغة في Deepgram المستخدم للتفريغ النصي.",
  "settings.general.voice.model.title": "النموذج الصوتي",
  "settings.general.voice.model.description": "نموذج Deepgram المستخدم للتفريغ النصي.",
  "settings.general.section.support": "الإبلاغ عن خلل",
  "settings.support.row.bugEmail.title": "عبر البريد الإلكتروني",
  "settings.support.row.bugEmail.description": "أرسل رسالة إلى فريق Prisme مرفقة بمعلومات التثبيت لديك.",
  "settings.support.row.bugEmail.action": "كتابة بريد إلكتروني",
  "settings.support.row.bugIssue.title": "على GitHub",
  "settings.support.row.bugIssue.description": "فتح نموذج GitHub مُعبّأ مسبقًا (يتطلب حساب GitHub).",
  "settings.support.row.bugIssue.action": "فتح GitHub",
  "voice.action.start": "بدء الإملاء",
  "voice.action.stop": "إيقاف الإملاء",
  "voice.state.recording": "جارٍ التسجيل",
  "voice.error.missingKey.title": "مفتاح Deepgram مطلوب",
  "voice.error.missingKey.description": "أضف مفتاح Deepgram API في الإعدادات لاستخدام الإدخال الصوتي.",
  "voice.error.connection.title": "فشل الاتصال الصوتي",
  "voice.error.connection.description": "تم قطع الاتصال بـ Deepgram.",
  "voice.error.microphone.title": "الميكروفون غير متاح",
  "voice.error.microphone.description": "تعذّر على Prisme الوصول إلى الميكروفون.",
}
