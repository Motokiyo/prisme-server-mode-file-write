export const dict = {
  ...
  "toast.file.notFound.title": "फ़ाइल नहीं मिली",
  "notes.empty.title": "कोई नोट खुला नहीं है",
  "notes.empty.description": "एक्सप्लोरर से कोई फ़ाइल चुनें या Markdown नोट बनाएँ।",
  "notes.empty.create": "नोट बनाएँ",
  "notes.create.prompt": "नोट का नाम",
  "notes.create.defaultName": "बिना शीर्षक वाला नोट",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "नोट बनाएँ",
  "dialog.note.create.name.label": "नोट का नाम",
  "dialog.note.create.name.placeholder": "मेरे विचार",
  "dialog.note.create.confirm": "बनाएँ",
  "dialog.note.create.error.exists": "इस नाम का नोट पहले से मौजूद है।",
  "dialog.file.rename.title": "फ़ाइल का नाम बदलें",
  "dialog.file.rename.name.label": "नया नाम",
  "dialog.file.rename.confirm": "नाम बदलें",
  "dialog.file.rename.error.exists": "इस नाम की फ़ाइल पहले से मौजूद है।",
  "dialog.file.delete.title": "फ़ाइल हटाएँ",
  "dialog.file.delete.description": "क्या आप वाकई “{{name}}” को हटाना चाहते हैं? यह क्रिया पूर्ववत नहीं की जा सकती।",
  "dialog.file.delete.confirm": "हटाएँ",
  "dialog.file.create.title": "नई फ़ाइल",
  "dialog.file.create.name.label": "फ़ाइल का नाम",
  "dialog.file.create.name.placeholder": "udaharan.md",
  "dialog.file.create.confirm": "बनाएँ",
  "dialog.file.create.error.exists": "इस नाम की फ़ाइल पहले से मौजूद है।",
  "dialog.directory.create.title": "नया फ़ोल्डर",
  "dialog.directory.create.name.label": "फ़ोल्डर का नाम",
  "dialog.directory.create.name.placeholder": "मेरा फ़ोल्डर",
  "dialog.directory.create.confirm": "बनाएँ",
  "dialog.directory.create.error.exists": "इस नाम का फ़ोल्डर पहले से मौजूद है।",
  "dialog.directory.create.defaultName": "नया फ़ोल्डर",
  "dialog.directory.rename.title": "फ़ोल्डर का नाम बदलें",
  "dialog.directory.delete.title": "फ़ोल्डर हटाएँ",
  "dialog.directory.delete.description": "“{{name}}” और उसकी सारी सामग्री हटाएँ? यह क्रिया पूर्ववत नहीं की जा सकती।",
  "dialog.directory.delete.confirm": "हटाएँ",
  "fileTree.action.rename": "नाम बदलें",
  "fileTree.action.delete": "हटाएँ",
  "fileTree.action.newFile": "नई फ़ाइल",
  "fileTree.action.newDirectory": "नया फ़ोल्डर",
  "fileTree.action.newSubDirectory": "नया उपफ़ोल्डर",
  "toast.file.rename.failed.title": "फ़ाइल का नाम बदलने में विफल",
  "toast.file.delete.failed.title": "फ़ाइल हटाने में विफल",
  "toast.file.create.failed.title": "फ़ाइल बनाने में विफल",
  "toast.directory.create.failed.title": "फ़ोल्डर बनाने में विफल",
  "toast.directory.delete.failed.title": "फ़ोल्डर हटाने में विफल",
  "toast.directory.rename.failed.title": "फ़ोल्डर का नाम बदलने में विफल",
  "settings.general.section.voice": "आवाज़",
  "settings.general.voice.deepgramKey.title": "Deepgram API कुंजी",
  "settings.general.voice.deepgramKey.description": "प्रॉम्प्ट में बोले गए शब्दों को लिखने के लिए Deepgram का उपयोग करें।",
  "settings.general.voice.deepgramKey.placeholder": "Deepgram कुंजी चिपकाएँ",
  "settings.general.voice.language.title": "आवाज़ की भाषा",
  "settings.general.voice.language.description": "प्रतिलेखन के लिए उपयोग किया जाने वाला Deepgram भाषा कोड।",
  "settings.general.voice.model.title": "आवाज़ मॉडल",
  "settings.general.voice.model.description": "प्रतिलेखन के लिए उपयोग किया जाने वाला Deepgram मॉडल।",
  "settings.general.section.support": "बग की सूचना दें",
  "settings.support.row.bugEmail.title": "ईमेल द्वारा",
  "settings.support.row.bugEmail.description": "अपनी इंस्टॉलेशन जानकारी के साथ Prisme टीम को संदेश भेजें।",
  "settings.support.row.bugEmail.action": "ईमेल लिखें",
  "settings.support.row.bugIssue.title": "GitHub पर",
  "settings.support.row.bugIssue.description": "पहले से भरा हुआ GitHub फ़ॉर्म खोलें (GitHub खाता आवश्यक)।",
  "settings.support.row.bugIssue.action": "GitHub खोलें",
  "voice.action.start": "श्रुतलेख शुरू करें",
  "voice.action.stop": "श्रुतलेख रोकें",
  "voice.state.recording": "रिकॉर्ड हो रहा है",
  "voice.error.missingKey.title": "Deepgram कुंजी आवश्यक",
  "voice.error.missingKey.description": "आवाज़ से इनपुट करने के लिए सेटिंग्स में अपनी Deepgram API कुंजी जोड़ें।",
  "voice.error.connection.title": "आवाज़ कनेक्शन विफल",
  "voice.error.connection.description": "Deepgram से कनेक्शन बाधित हो गया।",
  "voice.error.microphone.title": "माइक्रोफ़ोन अनुपलब्ध",
  "voice.error.microphone.description": "Prisme आपके माइक्रोफ़ोन तक नहीं पहुँच सका।",
}
