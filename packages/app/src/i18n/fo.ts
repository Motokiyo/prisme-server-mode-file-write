export const dict = {
  ...
  "toast.file.notFound.title": "Fílan fanst ikki",
  "notes.empty.title": "Eingin notat opin",
  "notes.empty.description": "Vel eina fílu í kannaranum ella stovna eitt Markdown-notat.",
  "notes.empty.create": "Stovna notat",
  "notes.create.prompt": "Navn á notati",
  "notes.create.defaultName": "Ónevnt notat",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Stovna notat",
  "dialog.note.create.name.label": "Navn á notati",
  "dialog.note.create.name.placeholder": "Mínar hugsanir",
  "dialog.note.create.confirm": "Stovna",
  "dialog.note.create.error.exists": "Eitt notat við hesum navni er longu til.",
  "dialog.file.rename.title": "Umnevn fílu",
  "dialog.file.rename.name.label": "Nýtt navn",
  "dialog.file.rename.confirm": "Umnevna",
  "dialog.file.rename.error.exists": "Ein fíla við hesum navni er longu til.",
  "dialog.file.delete.title": "Strika fílu",
  "dialog.file.delete.description": "Ert tú vísur í, at tú vilt strika „{{name}}“? Hendan gerðin kann ikki gerast aftur.",
  "dialog.file.delete.confirm": "Strika",
  "dialog.file.create.title": "Nýggj fíla",
  "dialog.file.create.name.label": "Fílunavn",
  "dialog.file.create.name.placeholder": "doemi.md",
  "dialog.file.create.confirm": "Stovna",
  "dialog.file.create.error.exists": "Ein fíla við hesum navni er longu til.",
  "dialog.directory.create.title": "Nýggj mappa",
  "dialog.directory.create.name.label": "Mappunavn",
  "dialog.directory.create.name.placeholder": "Mín mappa",
  "dialog.directory.create.confirm": "Stovna",
  "dialog.directory.create.error.exists": "Ein mappa við hesum navni er longu til.",
  "dialog.directory.create.defaultName": "Nýggj mappa",
  "dialog.directory.rename.title": "Umnevn mappu",
  "dialog.directory.delete.title": "Strika mappu",
  "dialog.directory.delete.description": "Strika „{{name}}“ og alt innihaldið? Hendan gerðin kann ikki gerast aftur.",
  "dialog.directory.delete.confirm": "Strika",
  "fileTree.action.rename": "Umnevna",
  "fileTree.action.delete": "Strika",
  "fileTree.action.newFile": "Nýggj fíla",
  "fileTree.action.newDirectory": "Nýggj mappa",
  "fileTree.action.newSubDirectory": "Nýggj undirmappa",
  "toast.file.rename.failed.title": "Fekk ikki umnevnt fíluna",
  "toast.file.delete.failed.title": "Fekk ikki strikað fíluna",
  "toast.file.create.failed.title": "Fekk ikki stovnað fíluna",
  "toast.directory.create.failed.title": "Fekk ikki stovnað mappuna",
  "toast.directory.delete.failed.title": "Fekk ikki strikað mappuna",
  "toast.directory.rename.failed.title": "Fekk ikki umnevnt mappuna",
  "settings.general.section.voice": "Rødd",
  "settings.general.voice.deepgramKey.title": "Deepgram API-lykil",
  "settings.general.voice.deepgramKey.description": "Brúka Deepgram at umskriva diktering í promptinum.",
  "settings.general.voice.deepgramKey.placeholder": "Set inn ein Deepgram-lykil",
  "settings.general.voice.language.title": "Mál hjá røddini",
  "settings.general.voice.language.description": "Deepgram málkota, sum verður brúkt til umskriving.",
  "settings.general.voice.model.title": "Roddarlíkan",
  "settings.general.voice.model.description": "Deepgram-líkan, sum verður brúkt til umskriving.",
  "settings.general.section.support": "Deil ein feil",
  "settings.support.row.bugEmail.title": "Við teldupost",
  "settings.support.row.bugEmail.description": "Send Prisme-toyminum eini boð við upplýsingum um innleggingina hjá tær.",
  "settings.support.row.bugEmail.action": "Skriva teldupost",
  "settings.support.row.bugIssue.title": "Á GitHub",
  "settings.support.row.bugIssue.description": "Opna eina fyrifylta GitHub-oydublað (GitHub-konta kravd).",
  "settings.support.row.bugIssue.action": "Opna GitHub",
  "voice.action.start": "Byrja diktering",
  "voice.action.stop": "Steðga diktering",
  "voice.state.recording": "Tekur upp",
  "voice.error.missingKey.title": "Deepgram-lykil kravdur",
  "voice.error.missingKey.description": "Legg Deepgram API-lykilin hjá tær í innstillingarnar fyri at brúka roddinntak.",
  "voice.error.connection.title": "Roddsambandið miseydnaðist",
  "voice.error.connection.description": "Sambandið til Deepgram varð avbrotið.",
  "voice.error.microphone.title": "Mikrofonur ikki tøkur",
  "voice.error.microphone.description": "Prisme fekk ikki atgongd til mikrofonin hjá tær.",
}
