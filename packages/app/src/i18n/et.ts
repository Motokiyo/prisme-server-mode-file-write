export const dict = {
  ...
  "toast.file.notFound.title": "Faili ei leitud",
  "notes.empty.title": "Ühtegi märkmet pole avatud",
  "notes.empty.description": "Vali failihaldurist fail või loo Markdown-märge.",
  "notes.empty.create": "Loo märge",
  "notes.create.prompt": "Märkme nimi",
  "notes.create.defaultName": "Pealkirjata märge",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Loo märge",
  "dialog.note.create.name.label": "Märkme nimi",
  "dialog.note.create.name.placeholder": "Minu ideed",
  "dialog.note.create.confirm": "Loo",
  "dialog.note.create.error.exists": "Selle nimega märge on juba olemas.",
  "dialog.file.rename.title": "Nimeta fail ümber",
  "dialog.file.rename.name.label": "Uus nimi",
  "dialog.file.rename.confirm": "Nimeta ümber",
  "dialog.file.rename.error.exists": "Selle nimega fail on juba olemas.",
  "dialog.file.delete.title": "Kustuta fail",
  "dialog.file.delete.description": "Kas soovid kindlasti kustutada „{{name}}“? Seda toimingut ei saa tagasi võtta.",
  "dialog.file.delete.confirm": "Kustuta",
  "dialog.file.create.title": "Uus fail",
  "dialog.file.create.name.label": "Faili nimi",
  "dialog.file.create.name.placeholder": "naide.md",
  "dialog.file.create.confirm": "Loo",
  "dialog.file.create.error.exists": "Selle nimega fail on juba olemas.",
  "dialog.directory.create.title": "Uus kaust",
  "dialog.directory.create.name.label": "Kausta nimi",
  "dialog.directory.create.name.placeholder": "Minu kaust",
  "dialog.directory.create.confirm": "Loo",
  "dialog.directory.create.error.exists": "Selle nimega kaust on juba olemas.",
  "dialog.directory.create.defaultName": "Uus kaust",
  "dialog.directory.rename.title": "Nimeta kaust ümber",
  "dialog.directory.delete.title": "Kustuta kaust",
  "dialog.directory.delete.description": "Kas kustutada „{{name}}“ ja kogu selle sisu? Seda toimingut ei saa tagasi võtta.",
  "dialog.directory.delete.confirm": "Kustuta",
  "fileTree.action.rename": "Nimeta ümber",
  "fileTree.action.delete": "Kustuta",
  "fileTree.action.newFile": "Uus fail",
  "fileTree.action.newDirectory": "Uus kaust",
  "fileTree.action.newSubDirectory": "Uus alamkaust",
  "toast.file.rename.failed.title": "Faili ümbernimetamine ebaõnnestus",
  "toast.file.delete.failed.title": "Faili kustutamine ebaõnnestus",
  "toast.file.create.failed.title": "Faili loomine ebaõnnestus",
  "toast.directory.create.failed.title": "Kausta loomine ebaõnnestus",
  "toast.directory.delete.failed.title": "Kausta kustutamine ebaõnnestus",
  "toast.directory.rename.failed.title": "Kausta ümbernimetamine ebaõnnestus",
  "settings.general.section.voice": "Hääl",
  "settings.general.voice.deepgramKey.title": "Deepgrami API-võti",
  "settings.general.voice.deepgramKey.description": "Kasuta Deepgrami viiba dikteerimise transkribeerimiseks.",
  "settings.general.voice.deepgramKey.placeholder": "Kleebi Deepgrami võti",
  "settings.general.voice.language.title": "Hääle keel",
  "settings.general.voice.language.description": "Transkribeerimisel kasutatav Deepgrami keelekood.",
  "settings.general.voice.model.title": "Häälemudel",
  "settings.general.voice.model.description": "Transkribeerimisel kasutatav Deepgrami mudel.",
  "settings.general.section.support": "Teata veast",
  "settings.support.row.bugEmail.title": "E-postiga",
  "settings.support.row.bugEmail.description": "Saada Prisme'i meeskonnale sõnum koos oma paigalduse teabega.",
  "settings.support.row.bugEmail.action": "Koosta e-kiri",
  "settings.support.row.bugIssue.title": "GitHubis",
  "settings.support.row.bugIssue.description": "Ava eeltäidetud GitHubi vorm (vajalik on GitHubi konto).",
  "settings.support.row.bugIssue.action": "Ava GitHub",
  "voice.action.start": "Alusta dikteerimist",
  "voice.action.stop": "Lõpeta dikteerimine",
  "voice.state.recording": "Salvestab",
  "voice.error.missingKey.title": "Vajalik on Deepgrami võti",
  "voice.error.missingKey.description": "Häälsisestuse kasutamiseks lisa seadetes oma Deepgrami API-võti.",
  "voice.error.connection.title": "Hääleühendus ebaõnnestus",
  "voice.error.connection.description": "Ühendus Deepgramiga katkes.",
  "voice.error.microphone.title": "Mikrofon pole saadaval",
  "voice.error.microphone.description": "Prisme ei pääsenud sinu mikrofonile ligi.",
}
