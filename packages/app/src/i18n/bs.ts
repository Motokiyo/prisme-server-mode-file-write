export const dict = {
  ...
  "toast.file.notFound.title": "Datoteka nije pronađena",
  "notes.empty.title": "Nijedna bilješka nije otvorena",
  "notes.empty.description": "Odaberite datoteku u pregledniku ili kreirajte Markdown bilješku.",
  "notes.empty.create": "Kreiraj bilješku",
  "notes.create.prompt": "Naziv bilješke",
  "notes.create.defaultName": "Bilješka bez naslova",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Kreiraj bilješku",
  "dialog.note.create.name.label": "Naziv bilješke",
  "dialog.note.create.name.placeholder": "Moje ideje",
  "dialog.note.create.confirm": "Kreiraj",
  "dialog.note.create.error.exists": "Bilješka s ovim nazivom već postoji.",
  "dialog.file.rename.title": "Preimenuj datoteku",
  "dialog.file.rename.name.label": "Novi naziv",
  "dialog.file.rename.confirm": "Preimenuj",
  "dialog.file.rename.error.exists": "Datoteka s ovim nazivom već postoji.",
  "dialog.file.delete.title": "Izbriši datoteku",
  "dialog.file.delete.description": "Jeste li sigurni da želite izbrisati „{{name}}”? Ova radnja se ne može poništiti.",
  "dialog.file.delete.confirm": "Izbriši",
  "dialog.file.create.title": "Nova datoteka",
  "dialog.file.create.name.label": "Naziv datoteke",
  "dialog.file.create.name.placeholder": "primjer.md",
  "dialog.file.create.confirm": "Kreiraj",
  "dialog.file.create.error.exists": "Datoteka s ovim nazivom već postoji.",
  "dialog.directory.create.title": "Nova fascikla",
  "dialog.directory.create.name.label": "Naziv fascikle",
  "dialog.directory.create.name.placeholder": "Moja fascikla",
  "dialog.directory.create.confirm": "Kreiraj",
  "dialog.directory.create.error.exists": "Fascikla s ovim nazivom već postoji.",
  "dialog.directory.create.defaultName": "Nova fascikla",
  "dialog.directory.rename.title": "Preimenuj fasciklu",
  "dialog.directory.delete.title": "Izbriši fasciklu",
  "dialog.directory.delete.description": "Izbrisati „{{name}}” i sav njen sadržaj? Ova radnja se ne može poništiti.",
  "dialog.directory.delete.confirm": "Izbriši",
  "fileTree.action.rename": "Preimenuj",
  "fileTree.action.delete": "Izbriši",
  "fileTree.action.newFile": "Nova datoteka",
  "fileTree.action.newDirectory": "Nova fascikla",
  "fileTree.action.newSubDirectory": "Nova podfascikla",
  "toast.file.rename.failed.title": "Datoteku nije bilo moguće preimenovati",
  "toast.file.delete.failed.title": "Datoteku nije bilo moguće izbrisati",
  "toast.file.create.failed.title": "Datoteku nije bilo moguće kreirati",
  "toast.directory.create.failed.title": "Fasciklu nije bilo moguće kreirati",
  "toast.directory.delete.failed.title": "Fasciklu nije bilo moguće izbrisati",
  "toast.directory.rename.failed.title": "Fasciklu nije bilo moguće preimenovati",
  "settings.general.section.voice": "Glas",
  "settings.general.voice.deepgramKey.title": "Deepgram API ključ",
  "settings.general.voice.deepgramKey.description": "Koristi Deepgram za transkripciju diktiranja u upitu.",
  "settings.general.voice.deepgramKey.placeholder": "Zalijepite Deepgram ključ",
  "settings.general.voice.language.title": "Jezik glasa",
  "settings.general.voice.language.description": "Deepgram kod jezika koji se koristi za transkripciju.",
  "settings.general.voice.model.title": "Glasovni model",
  "settings.general.voice.model.description": "Deepgram model koji se koristi za transkripciju.",
  "settings.general.section.support": "Prijavi grešku",
  "settings.support.row.bugEmail.title": "E-poštom",
  "settings.support.row.bugEmail.description": "Pošaljite timu Prisme poruku s podacima o svojoj instalaciji.",
  "settings.support.row.bugEmail.action": "Napiši e-poruku",
  "settings.support.row.bugIssue.title": "Na GitHubu",
  "settings.support.row.bugIssue.description": "Otvori unaprijed popunjen GitHub obrazac (potreban je GitHub račun).",
  "settings.support.row.bugIssue.action": "Otvori GitHub",
  "voice.action.start": "Pokreni diktiranje",
  "voice.action.stop": "Zaustavi diktiranje",
  "voice.state.recording": "Snimanje",
  "voice.error.missingKey.title": "Potreban je Deepgram ključ",
  "voice.error.missingKey.description": "Dodajte svoj Deepgram API ključ u postavkama da biste koristili glasovni unos.",
  "voice.error.connection.title": "Glasovna veza nije uspjela",
  "voice.error.connection.description": "Veza s Deepgramom je prekinuta.",
  "voice.error.microphone.title": "Mikrofon nije dostupan",
  "voice.error.microphone.description": "Prisme nije mogao pristupiti vašem mikrofonu.",
}
