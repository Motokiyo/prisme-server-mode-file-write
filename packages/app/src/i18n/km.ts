export const dict = {
  ...
  "toast.file.notFound.title": "រកមិនឃើញឯកសារ",
  "notes.empty.title": "គ្មានកំណត់ចំណាំបើកទេ",
  "notes.empty.description": "ជ្រើសរើសឯកសារពីកម្មវិធីរុករក ឬបង្កើតកំណត់ចំណាំ Markdown។",
  "notes.empty.create": "បង្កើតកំណត់ចំណាំ",
  "notes.create.prompt": "ឈ្មោះកំណត់ចំណាំ",
  "notes.create.defaultName": "កំណត់ចំណាំគ្មានចំណងជើង",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "បង្កើតកំណត់ចំណាំ",
  "dialog.note.create.name.label": "ឈ្មោះកំណត់ចំណាំ",
  "dialog.note.create.name.placeholder": "គំនិតរបស់ខ្ញុំ",
  "dialog.note.create.confirm": "បង្កើត",
  "dialog.note.create.error.exists": "មានកំណត់ចំណាំឈ្មោះនេះរួចហើយ។",
  "dialog.file.rename.title": "ប្តូរឈ្មោះឯកសារ",
  "dialog.file.rename.name.label": "ឈ្មោះថ្មី",
  "dialog.file.rename.confirm": "ប្តូរឈ្មោះ",
  "dialog.file.rename.error.exists": "មានឯកសារឈ្មោះនេះរួចហើយ។",
  "dialog.file.delete.title": "លុបឯកសារ",
  "dialog.file.delete.description": "តើអ្នកប្រាកដទេថាចង់លុប «{{name}}»? សកម្មភាពនេះមិនអាចត្រឡប់វិញបានទេ។",
  "dialog.file.delete.confirm": "លុប",
  "dialog.file.create.title": "ឯកសារថ្មី",
  "dialog.file.create.name.label": "ឈ្មោះឯកសារ",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "បង្កើត",
  "dialog.file.create.error.exists": "មានឯកសារឈ្មោះនេះរួចហើយ។",
  "dialog.directory.create.title": "ថតថ្មី",
  "dialog.directory.create.name.label": "ឈ្មោះថត",
  "dialog.directory.create.name.placeholder": "ថតរបស់ខ្ញុំ",
  "dialog.directory.create.confirm": "បង្កើត",
  "dialog.directory.create.error.exists": "មានថតឈ្មោះនេះរួចហើយ។",
  "dialog.directory.create.defaultName": "ថតថ្មី",
  "dialog.directory.rename.title": "ប្តូរឈ្មោះថត",
  "dialog.directory.delete.title": "លុបថត",
  "dialog.directory.delete.description": "លុប «{{name}}» និងមាតិកាទាំងអស់របស់វា? សកម្មភាពនេះមិនអាចត្រឡប់វិញបានទេ។",
  "dialog.directory.delete.confirm": "លុប",
  "fileTree.action.rename": "ប្តូរឈ្មោះ",
  "fileTree.action.delete": "លុប",
  "fileTree.action.newFile": "ឯកសារថ្មី",
  "fileTree.action.newDirectory": "ថតថ្មី",
  "fileTree.action.newSubDirectory": "ថតរងថ្មី",
  "toast.file.rename.failed.title": "បរាជ័យក្នុងការប្តូរឈ្មោះឯកសារ",
  "toast.file.delete.failed.title": "បរាជ័យក្នុងការលុបឯកសារ",
  "toast.file.create.failed.title": "បរាជ័យក្នុងការបង្កើតឯកសារ",
  "toast.directory.create.failed.title": "បរាជ័យក្នុងការបង្កើតថត",
  "toast.directory.delete.failed.title": "បរាជ័យក្នុងការលុបថត",
  "toast.directory.rename.failed.title": "បរាជ័យក្នុងការប្តូរឈ្មោះថត",
  "settings.general.section.voice": "សំឡេង",
  "settings.general.voice.deepgramKey.title": "សោ API របស់ Deepgram",
  "settings.general.voice.deepgramKey.description": "ប្រើ Deepgram ដើម្បីបម្លែងការនិយាយក្នុងប្រអប់បញ្ចូលទៅជាអក្សរ។",
  "settings.general.voice.deepgramKey.placeholder": "បិទភ្ជាប់សោ Deepgram",
  "settings.general.voice.language.title": "ភាសាសំឡេង",
  "settings.general.voice.language.description": "លេខកូដភាសា Deepgram ដែលប្រើសម្រាប់ការបម្លែងជាអក្សរ។",
  "settings.general.voice.model.title": "ម៉ូដែលសំឡេង",
  "settings.general.voice.model.description": "ម៉ូដែល Deepgram ដែលប្រើសម្រាប់ការបម្លែងជាអក្សរ។",
  "settings.general.section.support": "រាយការណ៍កំហុស",
  "settings.support.row.bugEmail.title": "តាមអ៊ីមែល",
  "settings.support.row.bugEmail.description": "ផ្ញើសាររទៅក្រុម Prisme ជាមួយព័ត៌មានអំពីការដំឡើងរបស់អ្នក។",
  "settings.support.row.bugEmail.action": "សរសេរអ៊ីមែល",
  "settings.support.row.bugIssue.title": "នៅលើ GitHub",
  "settings.support.row.bugIssue.description": "បើកទម្រង់ GitHub ដែលបំពេញរួច (ត្រូវការគណនី GitHub)។",
  "settings.support.row.bugIssue.action": "បើក GitHub",
  "voice.action.start": "ចាប់ផ្តើមនិយាយតាម",
  "voice.action.stop": "ឈប់និយាយតាម",
  "voice.state.recording": "កំពុងថត",
  "voice.error.missingKey.title": "ត្រូវការសោ Deepgram",
  "voice.error.missingKey.description": "បន្ថែមសោ API របស់ Deepgram ក្នុងការកំណត់ ដើម្បីប្រើការបញ្ចូលដោយសំឡេង។",
  "voice.error.connection.title": "ការតភ្ជាប់សំឡេងបរាជ័យ",
  "voice.error.connection.description": "ការតភ្ជាប់ទៅ Deepgram ត្រូវបានផ្អាក។",
  "voice.error.microphone.title": "មីក្រូហ្វូនមិនអាចប្រើបាន",
  "voice.error.microphone.description": "Prisme មិនអាចចូលប្រើមីក្រូហ្វូនរបស់អ្នកបានទេ។",
}
