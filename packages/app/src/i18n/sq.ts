export const dict = {
  ...
  "toast.file.notFound.title": "Skedari nuk u gjet",
  "notes.empty.title": "Asnjë shënim i hapur",
  "notes.empty.description": "Zgjidhni një skedar nga eksploruesi ose krijoni një shënim Markdown.",
  "notes.empty.create": "Krijo shënim",
  "notes.create.prompt": "Emri i shënimit",
  "notes.create.defaultName": "Shënim pa titull",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Krijo shënim",
  "dialog.note.create.name.label": "Emri i shënimit",
  "dialog.note.create.name.placeholder": "Idetë e mia",
  "dialog.note.create.confirm": "Krijo",
  "dialog.note.create.error.exists": "Një shënim me këtë emër ekziston tashmë.",
  "dialog.file.rename.title": "Riemërto skedarin",
  "dialog.file.rename.name.label": "Emër i ri",
  "dialog.file.rename.confirm": "Riemërto",
  "dialog.file.rename.error.exists": "Një skedar me këtë emër ekziston tashmë.",
  "dialog.file.delete.title": "Fshi skedarin",
  "dialog.file.delete.description": "Jeni i sigurt që doni të fshini „{{name}}“? Ky veprim nuk mund të zhbëhet.",
  "dialog.file.delete.confirm": "Fshi",
  "dialog.file.create.title": "Skedar i ri",
  "dialog.file.create.name.label": "Emri i skedarit",
  "dialog.file.create.name.placeholder": "shembull.md",
  "dialog.file.create.confirm": "Krijo",
  "dialog.file.create.error.exists": "Një skedar me këtë emër ekziston tashmë.",
  "dialog.directory.create.title": "Dosje e re",
  "dialog.directory.create.name.label": "Emri i dosjes",
  "dialog.directory.create.name.placeholder": "Dosja ime",
  "dialog.directory.create.confirm": "Krijo",
  "dialog.directory.create.error.exists": "Një dosje me këtë emër ekziston tashmë.",
  "dialog.directory.create.defaultName": "Dosje e re",
  "dialog.directory.rename.title": "Riemërto dosjen",
  "dialog.directory.delete.title": "Fshi dosjen",
  "dialog.directory.delete.description": "Të fshihet „{{name}}“ dhe gjithë përmbajtja e saj? Ky veprim nuk mund të zhbëhet.",
  "dialog.directory.delete.confirm": "Fshi",
  "fileTree.action.rename": "Riemërto",
  "fileTree.action.delete": "Fshi",
  "fileTree.action.newFile": "Skedar i ri",
  "fileTree.action.newDirectory": "Dosje e re",
  "fileTree.action.newSubDirectory": "Nëndosje e re",
  "toast.file.rename.failed.title": "Riemërtimi i skedarit dështoi",
  "toast.file.delete.failed.title": "Fshirja e skedarit dështoi",
  "toast.file.create.failed.title": "Krijimi i skedarit dështoi",
  "toast.directory.create.failed.title": "Krijimi i dosjes dështoi",
  "toast.directory.delete.failed.title": "Fshirja e dosjes dështoi",
  "toast.directory.rename.failed.title": "Riemërtimi i dosjes dështoi",
  "settings.general.section.voice": "Zëri",
  "settings.general.voice.deepgramKey.title": "Çelësi API i Deepgram",
  "settings.general.voice.deepgramKey.description": "Përdor Deepgram për të transkriptuar diktimin në prompt.",
  "settings.general.voice.deepgramKey.placeholder": "Ngjisni një çelës Deepgram",
  "settings.general.voice.language.title": "Gjuha e zërit",
  "settings.general.voice.language.description": "Kodi i gjuhës së Deepgram i përdorur për transkriptimin.",
  "settings.general.voice.model.title": "Modeli i zërit",
  "settings.general.voice.model.description": "Modeli i Deepgram i përdorur për transkriptimin.",
  "settings.general.section.support": "Raporto një defekt",
  "settings.support.row.bugEmail.title": "Me email",
  "settings.support.row.bugEmail.description": "Dërgojini ekipit të Prisme një mesazh me të dhënat e instalimit tuaj.",
  "settings.support.row.bugEmail.action": "Shkruaj email",
  "settings.support.row.bugIssue.title": "Në GitHub",
  "settings.support.row.bugIssue.description": "Hap një formular GitHub të parambushur (kërkohet llogari GitHub).",
  "settings.support.row.bugIssue.action": "Hap GitHub",
  "voice.action.start": "Fillo diktimin",
  "voice.action.stop": "Ndalo diktimin",
  "voice.state.recording": "Duke regjistruar",
  "voice.error.missingKey.title": "Kërkohet çelësi i Deepgram",
  "voice.error.missingKey.description": "Shtoni çelësin tuaj API të Deepgram te cilësimet për të përdorur hyrjen me zë.",
  "voice.error.connection.title": "Lidhja me zë dështoi",
  "voice.error.connection.description": "Lidhja me Deepgram u ndërpre.",
  "voice.error.microphone.title": "Mikrofoni nuk është i disponueshëm",
  "voice.error.microphone.description": "Prisme nuk mundi të hyjë në mikrofonin tuaj.",
}
