export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Prisme",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Prisme.",
  ...
  "provider.connect.opencodeZen.line1":
    "Prisme Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Prisme.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Prisme.",
  ...
  "dialog.server.description": "Changez le serveur Prisme auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Prisme ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Prisme",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Prisme ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Prisme inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Prisme dans WSL sur Windows.",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Prisme sur votre appareil",
  ...
  "settings.general.row.theme.description": "Personnaliser le thème d'Prisme.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Prisme",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Prisme.",
