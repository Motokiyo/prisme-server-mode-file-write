export const dict = {
  ...
  "settings.general.section.support": "Support",
  "settings.support.row.bugEmail.title": "Signaler un bug par email",
  ...
  "settings.support.row.bugIssue.title": "Ouvrir une issue GitHub",
  "settings.support.row.bugIssue.description": "Créer un rapport public sur le dépôt Prisme",
