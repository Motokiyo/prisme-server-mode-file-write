...
export const dict = {
  ...
  "toast.file.notFound.title": "Skráin fannst ekki",
  "notes.empty.title": "Engin minnispunktur opinn",
  "notes.empty.description": "Veldu skrá í skráasafninu eða búðu til Markdown-minnispunkt.",
  "notes.empty.create": "Búa til minnispunkt",
  "notes.create.prompt": "Heiti minnispunkts",
  "notes.create.defaultName": "Ónefndur minnispunktur",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Búa til minnispunkt",
  "dialog.note.create.name.label": "Heiti minnispunkts",
  "dialog.note.create.name.placeholder": "Hugmyndir mínar",
  "dialog.note.create.confirm": "Búa til",
  "dialog.note.create.error.exists": "Minnispunktur með þessu heiti er þegar til.",
  "dialog.file.rename.title": "Endurnefna skrá",
  "dialog.file.rename.name.label": "Nýtt heiti",
  "dialog.file.rename.confirm": "Endurnefna",
  "dialog.file.rename.error.exists": "Skrá með þessu heiti er þegar til.",
  "dialog.file.delete.title": "Eyða skrá",
  "dialog.file.delete.description": "Ertu viss um að þú viljir eyða „{{name}}“? Þessi aðgerð verður ekki afturkölluð.",
  "dialog.file.delete.confirm": "Eyða",
  "dialog.file.create.title": "Ný skrá",
  "dialog.file.create.name.label": "Heiti skrár",
  "dialog.file.create.name.placeholder": "daemi.md",
  "dialog.file.create.confirm": "Búa til",
  "dialog.file.create.error.exists": "Skrá með þessu heiti er þegar til.",
  "dialog.directory.create.title": "Ný mappa",
  "dialog.directory.create.name.label": "Heiti möppu",
  "dialog.directory.create.name.placeholder": "Mappan mín",
  "dialog.directory.create.confirm": "Búa til",
  "dialog.directory.create.error.exists": "Mappa með þessu heiti er þegar til.",
  "dialog.directory.create.defaultName": "Ný mappa",
  "dialog.directory.rename.title": "Endurnefna möppu",
  "dialog.directory.delete.title": "Eyða möppu",
  "dialog.directory.delete.description": "Eyða „{{name}}“ og öllu innihaldi hennar? Þessi aðgerð verður ekki afturkölluð.",
  "dialog.directory.delete.confirm": "Eyða",
  "fileTree.action.rename": "Endurnefna",
  "fileTree.action.delete": "Eyða",
  "fileTree.action.newFile": "Ný skrá",
  "fileTree.action.newDirectory": "Ný mappa",
  "fileTree.action.newSubDirectory": "Ný undirmappa",
  "toast.file.rename.failed.title": "Tókst ekki að endurnefna skrána",
  "toast.file.delete.failed.title": "Tókst ekki að eyða skránni",
  "toast.file.create.failed.title": "Tókst ekki að búa til skrána",
  "toast.directory.create.failed.title": "Tókst ekki að búa til möppuna",
  "toast.directory.delete.failed.title": "Tókst ekki að eyða möppunni",
  "toast.directory.rename.failed.title": "Tókst ekki að endurnefna möppuna",
  "settings.general.section.voice": "Rödd",
  "settings.general.voice.deepgramKey.title": "Deepgram API-lykill",
  "settings.general.voice.deepgramKey.description": "Nota Deepgram til að umrita upplestur í skipanareitnum.",
  "settings.general.voice.deepgramKey.placeholder": "Límdu inn Deepgram-lykil",
  "settings.general.voice.language.title": "Tungumál raddar",
  "settings.general.voice.language.description": "Tungumálskóði Deepgram sem notaður er við umritun.",
  "settings.general.voice.model.title": "Raddlíkan",
  "settings.general.voice.model.description": "Deepgram-líkan sem notað er við umritun.",
  "settings.general.section.support": "Tilkynna villu",
  "settings.support.row.bugEmail.title": "Með tölvupósti",
  "settings.support.row.bugEmail.description": "Sendu Prisme-teyminu skilaboð með upplýsingum um uppsetninguna þína.",
  "settings.support.row.bugEmail.action": "Semja tölvupóst",
  "settings.support.row.bugIssue.title": "Á GitHub",
  "settings.support.row.bugIssue.description": "Opna forútfyllt GitHub-eyðublað (GitHub-reikningur nauðsynlegur).",
  "settings.support.row.bugIssue.action": "Opna GitHub",
  "voice.action.start": "Hefja upplestur",
  "voice.action.stop": "Stöðva upplestur",
  "voice.state.recording": "Tekur upp",
  "voice.error.missingKey.title": "Deepgram-lykill nauðsynlegur",
  "voice.error.missingKey.description": "Bættu Deepgram API-lyklinum þínum við í stillingum til að nota raddinnslátt.",
  "voice.error.connection.title": "Raddtenging mistókst",
  "voice.error.connection.description": "Tengingin við Deepgram rofnaði.",
  "voice.error.microphone.title": "Hljóðnemi ekki tiltækur",
  "voice.error.microphone.description": "Prisme fékk ekki aðgang að hljóðnemanum þínum.",
}
