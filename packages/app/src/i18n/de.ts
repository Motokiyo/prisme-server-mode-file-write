...
export const dict = {
  ...
  "toast.file.notFound.title": "Datei nicht gefunden",
  "notes.empty.title": "Keine Notiz geöffnet",
  "notes.empty.description": "Wählen Sie eine Datei im Explorer aus oder erstellen Sie eine Markdown-Notiz.",
  "notes.empty.create": "Notiz erstellen",
  "notes.create.prompt": "Notizname",
  "notes.create.defaultName": "Unbenannte Notiz",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Notiz erstellen",
  "dialog.note.create.name.label": "Notizname",
  "dialog.note.create.name.placeholder": "Meine Ideen",
  "dialog.note.create.confirm": "Erstellen",
  "dialog.note.create.error.exists": "Eine Notiz mit diesem Namen existiert bereits.",
  "dialog.file.rename.title": "Datei umbenennen",
  "dialog.file.rename.name.label": "Neuer Name",
  "dialog.file.rename.confirm": "Umbenennen",
  "dialog.file.rename.error.exists": "Eine Datei mit diesem Namen existiert bereits.",
  "dialog.file.delete.title": "Datei löschen",
  "dialog.file.delete.description": "Möchten Sie „{{name}}“ wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden.",
  "dialog.file.delete.confirm": "Löschen",
  "dialog.file.create.title": "Neue Datei",
  "dialog.file.create.name.label": "Dateiname",
  "dialog.file.create.name.placeholder": "beispiel.md",
  "dialog.file.create.confirm": "Erstellen",
  "dialog.file.create.error.exists": "Eine Datei mit diesem Namen existiert bereits.",
  "dialog.directory.create.title": "Neuer Ordner",
  "dialog.directory.create.name.label": "Ordnername",
  "dialog.directory.create.name.placeholder": "Mein Ordner",
  "dialog.directory.create.confirm": "Erstellen",
  "dialog.directory.create.error.exists": "Ein Ordner mit diesem Namen existiert bereits.",
  "dialog.directory.create.defaultName": "Neuer Ordner",
  "dialog.directory.rename.title": "Ordner umbenennen",
  "dialog.directory.delete.title": "Ordner löschen",
  "dialog.directory.delete.description": "„{{name}}“ und den gesamten Inhalt löschen? Diese Aktion kann nicht rückgängig gemacht werden.",
  "dialog.directory.delete.confirm": "Löschen",
  "fileTree.action.rename": "Umbenennen",
  "fileTree.action.delete": "Löschen",
  "fileTree.action.newFile": "Neue Datei",
  "fileTree.action.newDirectory": "Neuer Ordner",
  "fileTree.action.newSubDirectory": "Neuer Unterordner",
  "toast.file.rename.failed.title": "Datei konnte nicht umbenannt werden",
  "toast.file.delete.failed.title": "Datei konnte nicht gelöscht werden",
  "toast.file.create.failed.title": "Datei konnte nicht erstellt werden",
  "toast.directory.create.failed.title": "Ordner konnte nicht erstellt werden",
  "toast.directory.delete.failed.title": "Ordner konnte nicht gelöscht werden",
  "toast.directory.rename.failed.title": "Ordner konnte nicht umbenannt werden",
  "settings.general.section.voice": "Spracheingabe",
  "settings.general.voice.deepgramKey.title": "Deepgram-API-Schlüssel",
  "settings.general.voice.deepgramKey.description": "Deepgram für die Transkription des Diktats verwenden.",
  "settings.general.voice.deepgramKey.placeholder": "Deepgram-Schlüssel einfügen",
  "settings.general.voice.language.title": "Diktatsprache",
  "settings.general.voice.language.description": "Deepgram-Sprachcode für die Transkription.",
  "settings.general.voice.model.title": "Diktatmodell",
  "settings.general.voice.model.description": "Deepgram-Modell für die Transkription.",
  "settings.general.section.support": "Fehler melden",
  "settings.support.row.bugEmail.title": "Per E-Mail",
  "settings.support.row.bugEmail.description": "Senden Sie dem Prisme-Team eine Nachricht mit Ihren Installationsinformationen.",
  "settings.support.row.bugEmail.action": "E-Mail verfassen",
  "settings.support.row.bugIssue.title": "Auf GitHub",
  "settings.support.row.bugIssue.description": "Ein vorausgefülltes GitHub-Formular öffnen (GitHub-Konto erforderlich).",
  "settings.support.row.bugIssue.action": "GitHub öffnen",
  "voice.action.start": "Diktat starten",
  "voice.action.stop": "Diktat beenden",
  "voice.state.recording": "Aufnahme",
  "voice.error.missingKey.title": "Deepgram-Schlüssel erforderlich",
  "voice.error.missingKey.description": "Fügen Sie Ihren Deepgram-API-Schlüssel in den Einstellungen hinzu, um die Spracheingabe zu nutzen.",
  "voice.error.connection.title": "Sprachverbindung fehlgeschlagen",
  "voice.error.connection.description": "Die Deepgram-Verbindung wurde unterbrochen.",
  "voice.error.microphone.title": "Mikrofon nicht verfügbar",
  "voice.error.microphone.description": "Prisme konnte nicht auf Ihr Mikrofon zugreifen.",
