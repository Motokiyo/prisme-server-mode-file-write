export const dict = {
  ...
  "toast.file.notFound.title": "Файл не найден",
  "notes.empty.title": "Нет открытых заметок",
  "notes.empty.description": "Выберите файл в проводнике или создайте заметку в формате Markdown.",
  "notes.empty.create": "Создать заметку",
  "notes.create.prompt": "Название заметки",
  "notes.create.defaultName": "Заметка без названия",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Создать заметку",
  "dialog.note.create.name.label": "Название заметки",
  "dialog.note.create.name.placeholder": "Мои идеи",
  "dialog.note.create.confirm": "Создать",
  "dialog.note.create.error.exists": "Заметка с таким названием уже существует.",
  "dialog.file.rename.title": "Переименовать файл",
  "dialog.file.rename.name.label": "Новое название",
  "dialog.file.rename.confirm": "Переименовать",
  "dialog.file.rename.error.exists": "Файл с таким названием уже существует.",
  "dialog.file.delete.title": "Удалить файл",
  "dialog.file.delete.description": "Вы уверены, что хотите удалить «{{name}}»? Это действие нельзя отменить.",
  "dialog.file.delete.confirm": "Удалить",
  "dialog.file.create.title": "Новый файл",
  "dialog.file.create.name.label": "Название файла",
  "dialog.file.create.name.placeholder": "primer.md",
  "dialog.file.create.confirm": "Создать",
  "dialog.file.create.error.exists": "Файл с таким названием уже существует.",
  "dialog.directory.create.title": "Новая папка",
  "dialog.directory.create.name.label": "Название папки",
  "dialog.directory.create.name.placeholder": "Моя папка",
  "dialog.directory.create.confirm": "Создать",
  "dialog.directory.create.error.exists": "Папка с таким названием уже существует.",
  "dialog.directory.create.defaultName": "Новая папка",
  "dialog.directory.rename.title": "Переименовать папку",
  "dialog.directory.delete.title": "Удалить папку",
  "dialog.directory.delete.description": "Удалить «{{name}}» и всё её содержимое? Это действие нельзя отменить.",
  "dialog.directory.delete.confirm": "Удалить",
  "fileTree.action.rename": "Переименовать",
  "fileTree.action.delete": "Удалить",
  "fileTree.action.newFile": "Новый файл",
  "fileTree.action.newDirectory": "Новая папка",
  "fileTree.action.newSubDirectory": "Новая вложенная папка",
  "toast.file.rename.failed.title": "Не удалось переименовать файл",
  "toast.file.delete.failed.title": "Не удалось удалить файл",
  "toast.file.create.failed.title": "Не удалось создать файл",
  "toast.directory.create.failed.title": "Не удалось создать папку",
  "toast.directory.delete.failed.title": "Не удалось удалить папку",
  "toast.directory.rename.failed.title": "Не удалось переименовать папку",
  "settings.general.section.voice": "Голос",
  "settings.general.voice.deepgramKey.title": "API-ключ Deepgram",
  "settings.general.voice.deepgramKey.description": "Использовать Deepgram для расшифровки диктовки в запросе.",
  "settings.general.voice.deepgramKey.placeholder": "Вставьте ключ Deepgram",
  "settings.general.voice.language.title": "Язык голоса",
  "settings.general.voice.language.description": "Код языка Deepgram, используемый для расшифровки.",
  "settings.general.voice.model.title": "Голосовая модель",
  "settings.general.voice.model.description": "Модель Deepgram, используемая для расшифровки.",
  "settings.general.section.support": "Сообщить об ошибке",
  "settings.support.row.bugEmail.title": "По электронной почте",
  "settings.support.row.bugEmail.description": "Отправьте команде Prisme сообщение со сведениями о вашей установке.",
  "settings.support.row.bugEmail.action": "Написать письмо",
  "settings.support.row.bugIssue.title": "На GitHub",
  "settings.support.row.bugIssue.description": "Открыть предзаполненную форму на GitHub (требуется аккаунт GitHub).",
  "settings.support.row.bugIssue.action": "Открыть GitHub",
  "voice.action.start": "Начать диктовку",
  "voice.action.stop": "Остановить диктовку",
  "voice.state.recording": "Идёт запись",
  "voice.error.missingKey.title": "Требуется ключ Deepgram",
  "voice.error.missingKey.description": "Добавьте свой API-ключ Deepgram в настройках, чтобы использовать голосовой ввод.",
  "voice.error.connection.title": "Не удалось установить голосовое соединение",
  "voice.error.connection.description": "Соединение с Deepgram было прервано.",
  "voice.error.microphone.title": "Микрофон недоступен",
  "voice.error.microphone.description": "Prisme не удалось получить доступ к микрофону.",
}
