export const dict = {
  ...
  "toast.file.notFound.title": "Filen hittades inte",
  "notes.empty.title": "Ingen anteckning öppen",
  "notes.empty.description": "Välj en fil i utforskaren eller skapa en Markdown-anteckning.",
  "notes.empty.create": "Skapa anteckning",
  "notes.create.prompt": "Anteckningens namn",
  "notes.create.defaultName": "Namnlös anteckning",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Skapa anteckning",
  "dialog.note.create.name.label": "Anteckningens namn",
  "dialog.note.create.name.placeholder": "Mina idéer",
  "dialog.note.create.confirm": "Skapa",
  "dialog.note.create.error.exists": "Det finns redan en anteckning med det här namnet.",
  "dialog.file.rename.title": "Byt namn på filen",
  "dialog.file.rename.name.label": "Nytt namn",
  "dialog.file.rename.confirm": "Byt namn",
  "dialog.file.rename.error.exists": "Det finns redan en fil med det här namnet.",
  "dialog.file.delete.title": "Radera fil",
  "dialog.file.delete.description": "Är du säker på att du vill radera ”{{name}}”? Åtgärden kan inte ångras.",
  "dialog.file.delete.confirm": "Radera",
  "dialog.file.create.title": "Ny fil",
  "dialog.file.create.name.label": "Filnamn",
  "dialog.file.create.name.placeholder": "exempel.md",
  "dialog.file.create.confirm": "Skapa",
  "dialog.file.create.error.exists": "Det finns redan en fil med det här namnet.",
  "dialog.directory.create.title": "Ny mapp",
  "dialog.directory.create.name.label": "Mappnamn",
  "dialog.directory.create.name.placeholder": "Min mapp",
  "dialog.directory.create.confirm": "Skapa",
  "dialog.directory.create.error.exists": "Det finns redan en mapp med det här namnet.",
  "dialog.directory.create.defaultName": "Ny mapp",
  "dialog.directory.rename.title": "Byt namn på mappen",
  "dialog.directory.delete.title": "Radera mapp",
  "dialog.directory.delete.description": "Radera ”{{name}}” och allt innehåll? Åtgärden kan inte ångras.",
  "dialog.directory.delete.confirm": "Radera",
  "fileTree.action.rename": "Byt namn",
  "fileTree.action.delete": "Radera",
  "fileTree.action.newFile": "Ny fil",
  "fileTree.action.newDirectory": "Ny mapp",
  "fileTree.action.newSubDirectory": "Ny undermapp",
  "toast.file.rename.failed.title": "Det gick inte att byta namn på filen",
  "toast.file.delete.failed.title": "Det gick inte att radera filen",
  "toast.file.create.failed.title": "Det gick inte att skapa filen",
  "toast.directory.create.failed.title": "Det gick inte att skapa mappen",
  "toast.directory.delete.failed.title": "Det gick inte att radera mappen",
  "toast.directory.rename.failed.title": "Det gick inte att byta namn på mappen",
  "settings.general.section.voice": "Röst",
  "settings.general.voice.deepgramKey.title": "Deepgram API-nyckel",
  "settings.general.voice.deepgramKey.description": "Använd Deepgram för att transkribera diktering i prompten.",
  "settings.general.voice.deepgramKey.placeholder": "Klistra in en Deepgram-nyckel",
  "settings.general.voice.language.title": "Röstspråk",
  "settings.general.voice.language.description": "Deepgram-språkkod som används för transkribering.",
  "settings.general.voice.model.title": "Röstmodell",
  "settings.general.voice.model.description": "Deepgram-modell som används för transkribering.",
  "settings.general.section.support": "Rapportera ett fel",
  "settings.support.row.bugEmail.title": "Via e-post",
  "settings.support.row.bugEmail.description": "Skicka ett meddelande till Prisme-teamet med information om din installation.",
  "settings.support.row.bugEmail.action": "Skriv e-post",
  "settings.support.row.bugIssue.title": "På GitHub",
  "settings.support.row.bugIssue.description": "Öppna ett förifyllt GitHub-formulär (GitHub-konto krävs).",
  "settings.support.row.bugIssue.action": "Öppna GitHub",
  "voice.action.start": "Starta diktering",
  "voice.action.stop": "Stoppa diktering",
  "voice.state.recording": "Spelar in",
  "voice.error.missingKey.title": "Deepgram-nyckel krävs",
  "voice.error.missingKey.description": "Lägg till din Deepgram API-nyckel i inställningarna för att använda röstinmatning.",
  "voice.error.connection.title": "Röstanslutningen misslyckades",
  "voice.error.connection.description": "Anslutningen till Deepgram avbröts.",
  "voice.error.microphone.title": "Mikrofonen är inte tillgänglig",
  "voice.error.microphone.description": "Prisme kunde inte komma åt din mikrofon.",
}
