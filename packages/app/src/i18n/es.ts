export const dict = {
  ...
  "toast.file.notFound.title": "Archivo no encontrado",
  "notes.empty.title": "Ninguna nota abierta",
  "notes.empty.description": "Elija un archivo en el explorador o cree una nota Markdown.",
  "notes.empty.create": "Crear nota",
  "notes.create.prompt": "Nombre de la nota",
  "notes.create.defaultName": "Nota sin título",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Crear nota",
  "dialog.note.create.name.label": "Nombre de la nota",
  "dialog.note.create.name.placeholder": "Mis ideas",
  "dialog.note.create.confirm": "Crear",
  "dialog.note.create.error.exists": "Ya existe una nota con este nombre.",
  "dialog.file.rename.title": "Renombrar archivo",
  "dialog.file.rename.name.label": "Nuevo nombre",
  "dialog.file.rename.confirm": "Renombrar",
  "dialog.file.rename.error.exists": "Ya existe un archivo con este nombre.",
  "dialog.file.delete.title": "Eliminar archivo",
  "dialog.file.delete.description": "¿Seguro que desea eliminar «{{name}}»? Esta acción no se puede deshacer.",
  "dialog.file.delete.confirm": "Eliminar",
  "dialog.file.create.title": "Nuevo archivo",
  "dialog.file.create.name.label": "Nombre del archivo",
  "dialog.file.create.name.placeholder": "ejemplo.md",
  "dialog.file.create.confirm": "Crear",
  "dialog.file.create.error.exists": "Ya existe un archivo con este nombre.",
  "dialog.directory.create.title": "Nueva carpeta",
  "dialog.directory.create.name.label": "Nombre de la carpeta",
  "dialog.directory.create.name.placeholder": "Mi carpeta",
  "dialog.directory.create.confirm": "Crear",
  "dialog.directory.create.error.exists": "Ya existe una carpeta con este nombre.",
  "dialog.directory.create.defaultName": "Nueva carpeta",
  "dialog.directory.rename.title": "Renombrar carpeta",
  "dialog.directory.delete.title": "Eliminar carpeta",
  "dialog.directory.delete.description": "¿Eliminar «{{name}}» y todo su contenido? Esta acción no se puede deshacer.",
  "dialog.directory.delete.confirm": "Eliminar",
  "fileTree.action.rename": "Renombrar",
  "fileTree.action.delete": "Eliminar",
  "fileTree.action.newFile": "Nuevo archivo",
  "fileTree.action.newDirectory": "Nueva carpeta",
  "fileTree.action.newSubDirectory": "Nueva subcarpeta",
  "toast.file.rename.failed.title": "No se pudo renombrar el archivo",
  "toast.file.delete.failed.title": "No se pudo eliminar el archivo",
  "toast.file.create.failed.title": "No se pudo crear el archivo",
  "toast.directory.create.failed.title": "No se pudo crear la carpeta",
  "toast.directory.delete.failed.title": "No se pudo eliminar la carpeta",
  "toast.directory.rename.failed.title": "No se pudo renombrar la carpeta",
  "settings.general.section.voice": "Voz",
  "settings.general.voice.deepgramKey.title": "Clave de API de Deepgram",
  "settings.general.voice.deepgramKey.description": "Usar Deepgram para transcribir el dictado del prompt.",
  "settings.general.voice.deepgramKey.placeholder": "Pegue una clave de Deepgram",
  "settings.general.voice.language.title": "Idioma de voz",
  "settings.general.voice.language.description": "Código de idioma de Deepgram usado para la transcripción.",
  "settings.general.voice.model.title": "Modelo de voz",
  "settings.general.voice.model.description": "Modelo de Deepgram usado para la transcripción.",
  "settings.general.section.support": "Informar de un error",
  "settings.support.row.bugEmail.title": "Por correo",
  "settings.support.row.bugEmail.description": "Envíe un mensaje al equipo de Prisme con la información de su instalación.",
  "settings.support.row.bugEmail.action": "Redactar correo",
  "settings.support.row.bugIssue.title": "En GitHub",
  "settings.support.row.bugIssue.description": "Abrir un formulario de GitHub precompletado (requiere cuenta de GitHub).",
  "settings.support.row.bugIssue.action": "Abrir GitHub",
  "voice.action.start": "Iniciar dictado",
  "voice.action.stop": "Detener dictado",
  "voice.state.recording": "Grabando",
  "voice.error.missingKey.title": "Se requiere una clave de Deepgram",
  "voice.error.missingKey.description": "Añada su clave de API de Deepgram en los ajustes para usar la entrada de voz.",
  "voice.error.connection.title": "Falló la conexión de voz",
  "voice.error.connection.description": "La conexión con Deepgram se interrumpió.",
  "voice.error.microphone.title": "Micrófono no disponible",
  "voice.error.microphone.description": "Prisme no pudo acceder a su micrófono.",
}
