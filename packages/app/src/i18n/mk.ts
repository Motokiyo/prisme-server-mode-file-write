export const dict = {
  ...
  "toast.file.notFound.title": "Датотеката не е пронајдена",
  "notes.empty.title": "Нема отворена белешка",
  "notes.empty.description": "Изберете датотека во прегледувачот или создајте Markdown белешка.",
  "notes.empty.create": "Создај белешка",
  "notes.create.prompt": "Име на белешката",
  "notes.create.defaultName": "Белешка без наслов",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Создај белешка",
  "dialog.note.create.name.label": "Име на белешката",
  "dialog.note.create.name.placeholder": "Моите идеи",
  "dialog.note.create.confirm": "Создај",
  "dialog.note.create.error.exists": "Веќе постои белешка со ова име.",
  "dialog.file.rename.title": "Преименувај датотека",
  "dialog.file.rename.name.label": "Ново име",
  "dialog.file.rename.confirm": "Преименувај",
  "dialog.file.rename.error.exists": "Веќе постои датотека со ова име.",
  "dialog.file.delete.title": "Избриши датотека",
  "dialog.file.delete.description": "Дали сте сигурни дека сакате да ја избришете „{{name}}“? Ова дејство не може да се врати.",
  "dialog.file.delete.confirm": "Избриши",
  "dialog.file.create.title": "Нова датотека",
  "dialog.file.create.name.label": "Име на датотеката",
  "dialog.file.create.name.placeholder": "primer.md",
  "dialog.file.create.confirm": "Создај",
  "dialog.file.create.error.exists": "Веќе постои датотека со ова име.",
  "dialog.directory.create.title": "Нова папка",
  "dialog.directory.create.name.label": "Име на папката",
  "dialog.directory.create.name.placeholder": "Мојата папка",
  "dialog.directory.create.confirm": "Создај",
  "dialog.directory.create.error.exists": "Веќе постои папка со ова име.",
  "dialog.directory.create.defaultName": "Нова папка",
  "dialog.directory.rename.title": "Преименувај папка",
  "dialog.directory.delete.title": "Избриши папка",
  "dialog.directory.delete.description": "Да се избрише „{{name}}“ и целата нејзина содржина? Ова дејство не може да се врати.",
  "dialog.directory.delete.confirm": "Избриши",
  "fileTree.action.rename": "Преименувај",
  "fileTree.action.delete": "Избриши",
  "fileTree.action.newFile": "Нова датотека",
  "fileTree.action.newDirectory": "Нова папка",
  "fileTree.action.newSubDirectory": "Нова потпапка",
  "toast.file.rename.failed.title": "Датотеката не можеше да се преименува",
  "toast.file.delete.failed.title": "Датотеката не можеше да се избрише",
  "toast.file.create.failed.title": "Датотеката не можеше да се создаде",
  "toast.directory.create.failed.title": "Папката не можеше да се создаде",
  "toast.directory.delete.failed.title": "Папката не можеше да се избрише",
  "toast.directory.rename.failed.title": "Папката не можеше да се преименува",
  "settings.general.section.voice": "Глас",
  "settings.general.voice.deepgramKey.title": "Deepgram API клуч",
  "settings.general.voice.deepgramKey.description": "Користи Deepgram за транскрипција на диктирањето во барањето.",
  "settings.general.voice.deepgramKey.placeholder": "Залепете Deepgram клуч",
  "settings.general.voice.language.title": "Јазик на гласот",
  "settings.general.voice.language.description": "Deepgram код на јазик што се користи за транскрипција.",
  "settings.general.voice.model.title": "Гласовен модел",
  "settings.general.voice.model.description": "Deepgram модел што се користи за транскрипција.",
  "settings.general.section.support": "Пријави грешка",
  "settings.support.row.bugEmail.title": "Преку е-пошта",
  "settings.support.row.bugEmail.description": "Испратете му порака на тимот на Prisme со информации за вашата инсталација.",
  "settings.support.row.bugEmail.action": "Состави е-пошта",
  "settings.support.row.bugIssue.title": "На GitHub",
  "settings.support.row.bugIssue.description": "Отвори однапред пополнет GitHub образец (потребна е GitHub сметка).",
  "settings.support.row.bugIssue.action": "Отвори GitHub",
  "voice.action.start": "Започни диктирање",
  "voice.action.stop": "Запри диктирање",
  "voice.state.recording": "Се снима",
  "voice.error.missingKey.title": "Потребен е Deepgram клуч",
  "voice.error.missingKey.description": "Додајте го вашиот Deepgram API клуч во поставките за да користите гласовен внес.",
  "voice.error.connection.title": "Гласовната врска не успеа",
  "voice.error.connection.description": "Врската со Deepgram беше прекината.",
  "voice.error.microphone.title": "Микрофонот не е достапен",
  "voice.error.microphone.description": "Prisme не можеше да пристапи до вашиот микрофон.",
}
