export const dict: Record<string, string> = {
  ...
  "toast.file.notFound.title": "फाइल भेटिएन",
  "notes.empty.title": "कुनै नोट खुला छैन",
  "notes.empty.description": "एक्सप्लोररबाट फाइल छान्नुहोस् वा Markdown नोट सिर्जना गर्नुहोस्।",
  "notes.empty.create": "नोट सिर्जना गर्नुहोस्",
  "notes.create.prompt": "नोटको नाम",
  "notes.create.defaultName": "शीर्षकविहीन नोट",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "नोट सिर्जना गर्नुहोस्",
  "dialog.note.create.name.label": "नोटको नाम",
  "dialog.note.create.name.placeholder": "मेरा विचारहरू",
  "dialog.note.create.confirm": "सिर्जना गर्नुहोस्",
  "dialog.note.create.error.exists": "यही नामको नोट पहिले नै छ।",
  "dialog.file.rename.title": "फाइलको नाम बदल्नुहोस्",
  "dialog.file.rename.name.label": "नयाँ नाम",
  "dialog.file.rename.confirm": "पुन: नामाकरण गर्नुहोस्",
  "dialog.file.rename.error.exists": "यही नामको फाइल पहिले नै छ।",
  "dialog.file.delete.title": "फाइल मेट्नुहोस्",
  "dialog.file.delete.description": "के तपाईं साँच्चै “{{name}}” मेट्न चाहनुहुन्छ? यो कार्य फिर्ता गर्न सकिँदैन।",
  "dialog.file.delete.confirm": "मेट्नुहोस्",
  "dialog.file.create.title": "नयाँ फाइल",
  "dialog.file.create.name.label": "फाइलको नाम",
  "dialog.file.create.name.placeholder": "udaharan.md",
  "dialog.file.create.confirm": "सिर्जना गर्नुहोस्",
  "dialog.file.create.error.exists": "यही नामको फाइल पहिले नै छ।",
  "dialog.directory.create.title": "नयाँ फोल्डर",
  "dialog.directory.create.name.label": "फोल्डरको नाम",
  "dialog.directory.create.name.placeholder": "मेरो फोल्डर",
  "dialog.directory.create.confirm": "सिर्जना गर्नुहोस्",
  "dialog.directory.create.error.exists": "यही नामको फोल्डर पहिले नै छ।",
  "dialog.directory.create.defaultName": "नयाँ फोल्डर",
  "dialog.directory.rename.title": "फोल्डरको नाम बदल्नुहोस्",
  "dialog.directory.delete.title": "फोल्डर मेट्नुहोस्",
  "dialog.directory.delete.description": "“{{name}}” र यसका सम्पूर्ण सामग्री मेट्ने? यो कार्य फिर्ता गर्न सकिँदैन।",
  "dialog.directory.delete.confirm": "मेट्नुहोस्",
  "fileTree.action.rename": "पुन: नामाकरण गर्नुहोस्",
  "fileTree.action.delete": "मेट्नुहोस्",
  "fileTree.action.newFile": "नयाँ फाइल",
  "fileTree.action.newDirectory": "नयाँ फोल्डर",
  "fileTree.action.newSubDirectory": "नयाँ उपफोल्डर",
  "toast.file.rename.failed.title": "फाइलको नाम बदल्न सकिएन",
  "toast.file.delete.failed.title": "फाइल मेट्न सकिएन",
  "toast.file.create.failed.title": "फाइल सिर्जना गर्न सकिएन",
  "toast.directory.create.failed.title": "फोल्डर सिर्जना गर्न सकिएन",
  "toast.directory.delete.failed.title": "फोल्डर मेट्न सकिएन",
  "toast.directory.rename.failed.title": "फोल्डरको नाम बदल्न सकिएन",
  "settings.general.section.voice": "आवाज",
  "settings.general.voice.deepgramKey.title": "Deepgram API कुञ्जी",
  "settings.general.voice.deepgramKey.description": "प्रम्प्टमा बोलिएको कुरा लेख्न Deepgram प्रयोग गर्नुहोस्।",
  "settings.general.voice.deepgramKey.placeholder": "Deepgram कुञ्जी टाँस्नुहोस्",
  "settings.general.voice.language.title": "आवाजको भाषा",
  "settings.general.voice.language.description": "प्रतिलेखनका लागि प्रयोग हुने Deepgram भाषा कोड।",
  "settings.general.voice.model.title": "आवाज मोडेल",
  "settings.general.voice.model.description": "प्रतिलेखनका लागि प्रयोग हुने Deepgram मोडेल।",
  "settings.general.section.support": "त्रुटि जनाउनुहोस्",
  "settings.support.row.bugEmail.title": "इमेलमार्फत",
  "settings.support.row.bugEmail.description": "आफ्नो स्थापना जानकारीसहित Prisme टोलीलाई सन्देश पठाउनुहोस्।",
  "settings.support.row.bugEmail.action": "इमेल लेख्नुहोस्",
  "settings.support.row.bugIssue.title": "GitHub मा",
  "settings.support.row.bugIssue.description": "पहिले नै भरिएको GitHub फारम खोल्नुहोस् (GitHub खाता आवश्यक)।",
  "settings.support.row.bugIssue.action": "GitHub खोल्नुहोस्",
  "voice.action.start": "बोलेर लेखाइ सुरु गर्नुहोस्",
  "voice.action.stop": "बोलेर लेखाइ रोक्नुहोस्",
  "voice.state.recording": "रेकर्ड हुँदै",
  "voice.error.missingKey.title": "Deepgram कुञ्जी आवश्यक",
  "voice.error.missingKey.description": "आवाजबाट इनपुट गर्न सेटिङहरूमा आफ्नो Deepgram API कुञ्जी थप्नुहोस्।",
  "voice.error.connection.title": "आवाज जडान असफल",
  "voice.error.connection.description": "Deepgram सँगको जडान अवरुद्ध भयो।",
  "voice.error.microphone.title": "माइक्रोफोन उपलब्ध छैन",
  "voice.error.microphone.description": "Prisme ले तपाईंको माइक्रोफोन पहुँच गर्न सकेन।",
}
