export const dict = {
  ...
  "settings.support.row.bugEmail.title": "Report a bug by email",
  ...
  "settings.support.row.bugIssue.title": "Open a GitHub issue",
  "settings.support.row.bugIssue.description": "File a public report on the Prisme repository",
