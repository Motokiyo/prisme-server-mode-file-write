export const dict = {
  ...
  "toast.file.notFound.title": "Ֆայլը չի գտնվել",
  "notes.empty.title": "Բացված նշում չկա",
  "notes.empty.description": "Ընտրեք ֆայլ դիտարկիչից կամ ստեղծեք Markdown նշում։",
  "notes.empty.create": "Ստեղծել նշում",
  "notes.create.prompt": "Նշման անունը",
  "notes.create.defaultName": "Անվերնագիր նշում",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Ստեղծել նշում",
  "dialog.note.create.name.label": "Նշման անունը",
  "dialog.note.create.name.placeholder": "Իմ գաղափարները",
  "dialog.note.create.confirm": "Ստեղծել",
  "dialog.note.create.error.exists": "Այս անունով նշում արդեն գոյություն ունի։",
  "dialog.file.rename.title": "Վերանվանել ֆայլը",
  "dialog.file.rename.name.label": "Նոր անուն",
  "dialog.file.rename.confirm": "Վերանվանել",
  "dialog.file.rename.error.exists": "Այս անունով ֆայլ արդեն գոյություն ունի։",
  "dialog.file.delete.title": "Ջնջել ֆայլը",
  "dialog.file.delete.description": "Վստա՞հ եք, որ ուզում եք ջնջել «{{name}}»-ը։ Այս գործողությունը հնարավոր չէ հետարկել։",
  "dialog.file.delete.confirm": "Ջնջել",
  "dialog.file.create.title": "Նոր ֆայլ",
  "dialog.file.create.name.label": "Ֆայլի անունը",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "Ստեղծել",
  "dialog.file.create.error.exists": "Այս անունով ֆայլ արդեն գոյություն ունի։",
  "dialog.directory.create.title": "Նոր թղթապանակ",
  "dialog.directory.create.name.label": "Թղթապանակի անունը",
  "dialog.directory.create.name.placeholder": "Իմ թղթապանակը",
  "dialog.directory.create.confirm": "Ստեղծել",
  "dialog.directory.create.error.exists": "Այս անունով թղթապանակ արդեն գոյություն ունի։",
  "dialog.directory.create.defaultName": "Նոր թղթապանակ",
  "dialog.directory.rename.title": "Վերանվանել թղթապանակը",
  "dialog.directory.delete.title": "Ջնջել թղթապանակը",
  "dialog.directory.delete.description": "Ջնջե՞լ «{{name}}»-ը և դրա ողջ պարունակությունը։ Այս գործողությունը հնարավոր չէ հետարկել։",
  "dialog.directory.delete.confirm": "Ջնջել",
  "fileTree.action.rename": "Վերանվանել",
  "fileTree.action.delete": "Ջնջել",
  "fileTree.action.newFile": "Նոր ֆայլ",
  "fileTree.action.newDirectory": "Նոր թղթապանակ",
  "fileTree.action.newSubDirectory": "Նոր ենթաթղթապանակ",
  "toast.file.rename.failed.title": "Չհաջողվեց վերանվանել ֆայլը",
  "toast.file.delete.failed.title": "Չհաջողվեց ջնջել ֆայլը",
  "toast.file.create.failed.title": "Չհաջողվեց ստեղծել ֆայլը",
  "toast.directory.create.failed.title": "Չհաջողվեց ստեղծել թղթապանակը",
  "toast.directory.delete.failed.title": "Չհաջողվեց ջնջել թղթապանակը",
  "toast.directory.rename.failed.title": "Չհաջողվեց վերանվանել թղթապանակը",
  "settings.general.section.voice": "Ձայն",
  "settings.general.voice.deepgramKey.title": "Deepgram API բանալի",
  "settings.general.voice.deepgramKey.description": "Օգտագործել Deepgram-ը հուշման թելադրությունը գրի առնելու համար։",
  "settings.general.voice.deepgramKey.placeholder": "Տեղադրեք Deepgram բանալի",
  "settings.general.voice.language.title": "Ձայնի լեզուն",
  "settings.general.voice.language.description": "Վերծանման համար օգտագործվող Deepgram-ի լեզվի կոդը։",
  "settings.general.voice.model.title": "Ձայնային մոդել",
  "settings.general.voice.model.description": "Վերծանման համար օգտագործվող Deepgram-ի մոդելը։",
  "settings.general.section.support": "Հաղորդել սխալի մասին",
  "settings.support.row.bugEmail.title": "Էլ. փոստով",
  "settings.support.row.bugEmail.description": "Ուղարկեք Prisme թիմին հաղորդագրություն՝ ձեր տեղադրման տվյալներով։",
  "settings.support.row.bugEmail.action": "Գրել նամակ",
  "settings.support.row.bugIssue.title": "GitHub-ում",
  "settings.support.row.bugIssue.description": "Բացել նախապես լրացված GitHub ձևը (անհրաժեշտ է GitHub հաշիվ)։",
  "settings.support.row.bugIssue.action": "Բացել GitHub",
  "voice.action.start": "Սկսել թելադրությունը",
  "voice.action.stop": "Դադարեցնել թելադրությունը",
  "voice.state.recording": "Ձայնագրվում է",
  "voice.error.missingKey.title": "Անհրաժեշտ է Deepgram բանալի",
  "voice.error.missingKey.description": "Ձայնային մուտքն օգտագործելու համար կարգավորումներում ավելացրեք ձեր Deepgram API բանալին։",
  "voice.error.connection.title": "Ձայնային կապը ձախողվեց",
  "voice.error.connection.description": "Deepgram-ի հետ կապն ընդհատվեց։",
  "voice.error.microphone.title": "Խոսափողն անհասանելի է",
  "voice.error.microphone.description": "Prisme-ին չհաջողվեց մուտք գործել ձեր խոսափող։",
}
