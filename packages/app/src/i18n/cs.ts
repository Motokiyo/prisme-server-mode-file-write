export const dict = {
  ...
  "toast.file.notFound.title": "Soubor nebyl nalezen",
  "notes.empty.title": "Není otevřená žádná poznámka",
  "notes.empty.description": "Vyberte soubor v průzkumníku nebo vytvořte poznámku ve formátu Markdown.",
  "notes.empty.create": "Vytvořit poznámku",
  "notes.create.prompt": "Název poznámky",
  "notes.create.defaultName": "Poznámka bez názvu",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Vytvořit poznámku",
  "dialog.note.create.name.label": "Název poznámky",
  "dialog.note.create.name.placeholder": "Mé nápady",
  "dialog.note.create.confirm": "Vytvořit",
  "dialog.note.create.error.exists": "Poznámka s tímto názvem už existuje.",
  "dialog.file.rename.title": "Přejmenovat soubor",
  "dialog.file.rename.name.label": "Nový název",
  "dialog.file.rename.confirm": "Přejmenovat",
  "dialog.file.rename.error.exists": "Soubor s tímto názvem už existuje.",
  "dialog.file.delete.title": "Odstranit soubor",
  "dialog.file.delete.description": "Opravdu chcete odstranit „{{name}}“? Tuto akci nelze vrátit zpět.",
  "dialog.file.delete.confirm": "Odstranit",
  "dialog.file.create.title": "Nový soubor",
  "dialog.file.create.name.label": "Název souboru",
  "dialog.file.create.name.placeholder": "priklad.md",
  "dialog.file.create.confirm": "Vytvořit",
  "dialog.file.create.error.exists": "Soubor s tímto názvem už existuje.",
  "dialog.directory.create.title": "Nová složka",
  "dialog.directory.create.name.label": "Název složky",
  "dialog.directory.create.name.placeholder": "Moje složka",
  "dialog.directory.create.confirm": "Vytvořit",
  "dialog.directory.create.error.exists": "Složka s tímto názvem už existuje.",
  "dialog.directory.create.defaultName": "Nová složka",
  "dialog.directory.rename.title": "Přejmenovat složku",
  "dialog.directory.delete.title": "Odstranit složku",
  "dialog.directory.delete.description": "Odstranit „{{name}}“ a celý její obsah? Tuto akci nelze vrátit zpět.",
  "dialog.directory.delete.confirm": "Odstranit",
  "fileTree.action.rename": "Přejmenovat",
  "fileTree.action.delete": "Odstranit",
  "fileTree.action.newFile": "Nový soubor",
  "fileTree.action.newDirectory": "Nová složka",
  "fileTree.action.newSubDirectory": "Nová podsložka",
  "toast.file.rename.failed.title": "Soubor se nepodařilo přejmenovat",
  "toast.file.delete.failed.title": "Soubor se nepodařilo odstranit",
  "toast.file.create.failed.title": "Soubor se nepodařilo vytvořit",
  "toast.directory.create.failed.title": "Složku se nepodařilo vytvořit",
  "toast.directory.delete.failed.title": "Složku se nepodařilo odstranit",
  "toast.directory.rename.failed.title": "Složku se nepodařilo přejmenovat",
  "settings.general.section.voice": "Hlas",
  "settings.general.voice.deepgramKey.title": "Klíč API Deepgram",
  "settings.general.voice.deepgramKey.description": "Použít Deepgram k přepisu diktování v promptu.",
  "settings.general.voice.deepgramKey.placeholder": "Vložte klíč Deepgram",
  "settings.general.voice.language.title": "Jazyk hlasu",
  "settings.general.voice.language.description": "Kód jazyka Deepgram použitý pro přepis.",
  "settings.general.voice.model.title": "Hlasový model",
  "settings.general.voice.model.description": "Model Deepgram použitý pro přepis.",
  "settings.general.section.support": "Nahlásit chybu",
  "settings.support.row.bugEmail.title": "E-mailem",
  "settings.support.row.bugEmail.description": "Pošlete týmu Prisme zprávu s informacemi o vaší instalaci.",
  "settings.support.row.bugEmail.action": "Napsat e-mail",
  "settings.support.row.bugIssue.title": "Na GitHubu",
  "settings.support.row.bugIssue.description": "Otevřít předvyplněný formulář na GitHubu (vyžaduje účet GitHub).",
  "settings.support.row.bugIssue.action": "Otevřít GitHub",
  "voice.action.start": "Spustit diktování",
  "voice.action.stop": "Zastavit diktování",
  "voice.state.recording": "Nahrávání",
  "voice.error.missingKey.title": "Je vyžadován klíč Deepgram",
  "voice.error.missingKey.description": "Chcete-li používat hlasový vstup, přidejte v nastavení svůj klíč API Deepgram.",
  "voice.error.connection.title": "Hlasové připojení selhalo",
  "voice.error.connection.description": "Připojení k Deepgram bylo přerušeno.",
  "voice.error.microphone.title": "Mikrofon není k dispozici",
  "voice.error.microphone.description": "Prisme nemohl získat přístup k mikrofonu.",
}
