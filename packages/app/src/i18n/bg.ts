export const dict = {
  ...
  "toast.file.notFound.title": "Файлът не е намерен",
  "notes.empty.title": "Няма отворена бележка",
  "notes.empty.description": "Изберете файл в браузъра или създайте бележка в Markdown.",
  "notes.empty.create": "Създаване на бележка",
  "notes.create.prompt": "Име на бележката",
  "notes.create.defaultName": "Бележка без заглавие",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Създаване на бележка",
  "dialog.note.create.name.label": "Име на бележката",
  "dialog.note.create.name.placeholder": "Моите идеи",
  "dialog.note.create.confirm": "Създаване",
  "dialog.note.create.error.exists": "Вече съществува бележка с това име.",
  "dialog.file.rename.title": "Преименуване на файла",
  "dialog.file.rename.name.label": "Ново име",
  "dialog.file.rename.confirm": "Преименуване",
  "dialog.file.rename.error.exists": "Вече съществува файл с това име.",
  "dialog.file.delete.title": "Изтриване на файла",
  "dialog.file.delete.description": "Сигурни ли сте, че искате да изтриете „{{name}}“? Това действие е необратимо.",
  "dialog.file.delete.confirm": "Изтриване",
  "dialog.file.create.title": "Нов файл",
  "dialog.file.create.name.label": "Име на файла",
  "dialog.file.create.name.placeholder": "primer.md",
  "dialog.file.create.confirm": "Създаване",
  "dialog.file.create.error.exists": "Вече съществува файл с това име.",
  "dialog.directory.create.title": "Нова папка",
  "dialog.directory.create.name.label": "Име на папката",
  "dialog.directory.create.name.placeholder": "Моята папка",
  "dialog.directory.create.confirm": "Създаване",
  "dialog.directory.create.error.exists": "Вече съществува папка с това име.",
  "dialog.directory.create.defaultName": "Нова папка",
  "dialog.directory.rename.title": "Преименуване на папката",
  "dialog.directory.delete.title": "Изтриване на папката",
  "dialog.directory.delete.description": "Да се изтрие ли „{{name}}“ заедно с цялото ѝ съдържание? Това действие е необратимо.",
  "dialog.directory.delete.confirm": "Изтриване",
  "fileTree.action.rename": "Преименуване",
  "fileTree.action.delete": "Изтриване",
  "fileTree.action.newFile": "Нов файл",
  "fileTree.action.newDirectory": "Нова папка",
  "fileTree.action.newSubDirectory": "Нова подпапка",
  "toast.file.rename.failed.title": "Файлът не можа да бъде преименуван",
  "toast.file.delete.failed.title": "Файлът не можа да бъде изтрит",
  "toast.file.create.failed.title": "Файлът не можа да бъде създаден",
  "toast.directory.create.failed.title": "Папката не можа да бъде създадена",
  "toast.directory.delete.failed.title": "Папката не можа да бъде изтрита",
  "toast.directory.rename.failed.title": "Папката не можа да бъде преименувана",
  "settings.general.section.voice": "Глас",
  "settings.general.voice.deepgramKey.title": "API ключ за Deepgram",
  "settings.general.voice.deepgramKey.description": "Използване на Deepgram за транскрибиране на диктовката в подканата.",
  "settings.general.voice.deepgramKey.placeholder": "Поставете ключ за Deepgram",
  "settings.general.voice.language.title": "Език на гласа",
  "settings.general.voice.language.description": "Езиков код на Deepgram, използван за транскрибиране.",
  "settings.general.voice.model.title": "Гласов модел",
  "settings.general.voice.model.description": "Модел на Deepgram, използван за транскрибиране.",
  "settings.general.section.support": "Докладване на грешка",
  "settings.support.row.bugEmail.title": "По имейл",
  "settings.support.row.bugEmail.description": "Изпратете съобщение до екипа на Prisme с информация за вашата инсталация.",
  "settings.support.row.bugEmail.action": "Създаване на имейл",
  "settings.support.row.bugIssue.title": "В GitHub",
  "settings.support.row.bugIssue.description": "Отваряне на предварително попълнен формуляр в GitHub (изисква се профил в GitHub).",
  "settings.support.row.bugIssue.action": "Отваряне на GitHub",
  "voice.action.start": "Начало на диктовката",
  "voice.action.stop": "Спиране на диктовката",
  "voice.state.recording": "Записва се",
  "voice.error.missingKey.title": "Изисква се ключ за Deepgram",
  "voice.error.missingKey.description": "Добавете своя API ключ за Deepgram в настройките, за да използвате гласово въвеждане.",
  "voice.error.connection.title": "Гласовата връзка е неуспешна",
  "voice.error.connection.description": "Връзката с Deepgram беше прекъсната.",
  "voice.error.microphone.title": "Микрофонът не е достъпен",
  "voice.error.microphone.description": "Prisme не можа да получи достъп до микрофона ви.",
}
