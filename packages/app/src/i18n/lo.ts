export const dict = {
  ...
  "toast.file.notFound.title": "ບໍ່ພົບໄຟລ໌",
  "notes.empty.title": "ບໍ່ມີບັນທຶກທີ່ເປີດຢູ່",
  "notes.empty.description": "ເລືອກໄຟລ໌ຈາກຕົວສຳຫຼວດ ຫຼື ສ້າງບັນທຶກ Markdown.",
  "notes.empty.create": "ສ້າງບັນທຶກ",
  "notes.create.prompt": "ຊື່ບັນທຶກ",
  "notes.create.defaultName": "ບັນທຶກທີ່ບໍ່ມີຊື່",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "ສ້າງບັນທຶກ",
  "dialog.note.create.name.label": "ຊື່ບັນທຶກ",
  "dialog.note.create.name.placeholder": "ແນວຄິດຂອງຂ້ອຍ",
  "dialog.note.create.confirm": "ສ້າງ",
  "dialog.note.create.error.exists": "ມີບັນທຶກຊື່ນີ້ຢູ່ແລ້ວ.",
  "dialog.file.rename.title": "ປ່ຽນຊື່ໄຟລ໌",
  "dialog.file.rename.name.label": "ຊື່ໃໝ່",
  "dialog.file.rename.confirm": "ປ່ຽນຊື່",
  "dialog.file.rename.error.exists": "ມີໄຟລ໌ຊື່ນີ້ຢູ່ແລ້ວ.",
  "dialog.file.delete.title": "ລຶບໄຟລ໌",
  "dialog.file.delete.description": "ທ່ານແນ່ໃຈບໍ່ວ່າຕ້ອງການລຶບ “{{name}}”? ການກະທຳນີ້ບໍ່ສາມາດຍ້ອນກັບໄດ້.",
  "dialog.file.delete.confirm": "ລຶບ",
  "dialog.file.create.title": "ໄຟລ໌ໃໝ່",
  "dialog.file.create.name.label": "ຊື່ໄຟລ໌",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "ສ້າງ",
  "dialog.file.create.error.exists": "ມີໄຟລ໌ຊື່ນີ້ຢູ່ແລ້ວ.",
  "dialog.directory.create.title": "ໂຟນເດີໃໝ່",
  "dialog.directory.create.name.label": "ຊື່ໂຟນເດີ",
  "dialog.directory.create.name.placeholder": "ໂຟນເດີຂອງຂ້ອຍ",
  "dialog.directory.create.confirm": "ສ້າງ",
  "dialog.directory.create.error.exists": "ມີໂຟນເດີຊື່ນີ້ຢູ່ແລ້ວ.",
  "dialog.directory.create.defaultName": "ໂຟນເດີໃໝ່",
  "dialog.directory.rename.title": "ປ່ຽນຊື່ໂຟນເດີ",
  "dialog.directory.delete.title": "ລຶບໂຟນເດີ",
  "dialog.directory.delete.description": "ລຶບ “{{name}}” ແລະ ເນື້ອຫາທັງໝົດຂອງມັນບໍ່? ການກະທຳນີ້ບໍ່ສາມາດຍ້ອນກັບໄດ້.",
  "dialog.directory.delete.confirm": "ລຶບ",
  "fileTree.action.rename": "ປ່ຽນຊື່",
  "fileTree.action.delete": "ລຶບ",
  "fileTree.action.newFile": "ໄຟລ໌ໃໝ່",
  "fileTree.action.newDirectory": "ໂຟນເດີໃໝ່",
  "fileTree.action.newSubDirectory": "ໂຟນເດີຍ່ອຍໃໝ່",
  "toast.file.rename.failed.title": "ປ່ຽນຊື່ໄຟລ໌ບໍ່ສຳເລັດ",
  "toast.file.delete.failed.title": "ລຶບໄຟລ໌ບໍ່ສຳເລັດ",
  "toast.file.create.failed.title": "ສ້າງໄຟລ໌ບໍ່ສຳເລັດ",
  "toast.directory.create.failed.title": "ສ້າງໂຟນເດີບໍ່ສຳເລັດ",
  "toast.directory.delete.failed.title": "ລຶບໂຟນເດີບໍ່ສຳເລັດ",
  "toast.directory.rename.failed.title": "ປ່ຽນຊື່ໂຟນເດີບໍ່ສຳເລັດ",
  "settings.general.section.voice": "ສຽງ",
  "settings.general.voice.deepgramKey.title": "ກະແຈ API ຂອງ Deepgram",
  "settings.general.voice.deepgramKey.description": "ໃຊ້ Deepgram ເພື່ອຖອດຂໍ້ຄວາມຈາກການເວົ້າໃນຊ່ອງປ້ອນ.",
  "settings.general.voice.deepgramKey.placeholder": "ວາງກະແຈ Deepgram",
  "settings.general.voice.language.title": "ພາສາຂອງສຽງ",
  "settings.general.voice.language.description": "ລະຫັດພາສາ Deepgram ທີ່ໃຊ້ໃນການຖອດຂໍ້ຄວາມ.",
  "settings.general.voice.model.title": "ຕົວແບບສຽງ",
  "settings.general.voice.model.description": "ຕົວແບບ Deepgram ທີ່ໃຊ້ໃນການຖອດຂໍ້ຄວາມ.",
  "settings.general.section.support": "ລາຍງານຂໍ້ຜິດພາດ",
  "settings.support.row.bugEmail.title": "ທາງອີເມວ",
  "settings.support.row.bugEmail.description": "ສົ່ງຂໍ້ຄວາມຫາທີມ Prisme ພ້ອມຂໍ້ມູນການຕິດຕັ້ງຂອງທ່ານ.",
  "settings.support.row.bugEmail.action": "ຂຽນອີເມວ",
  "settings.support.row.bugIssue.title": "ຢູ່ GitHub",
  "settings.support.row.bugIssue.description": "ເປີດແບບຟອມ GitHub ທີ່ຕື່ມໄວ້ລ່ວງໜ້າ (ຕ້ອງມີບັນຊີ GitHub).",
  "settings.support.row.bugIssue.action": "ເປີດ GitHub",
  "voice.action.start": "ເລີ່ມການເວົ້າ",
  "voice.action.stop": "ຢຸດການເວົ້າ",
  "voice.state.recording": "ກຳລັງບັນທຶກ",
  "voice.error.missingKey.title": "ຕ້ອງການກະແຈ Deepgram",
  "voice.error.missingKey.description": "ເພີ່ມກະແຈ API ຂອງ Deepgram ໃນການຕັ້ງຄ່າ ເພື່ອໃຊ້ການປ້ອນດ້ວຍສຽງ.",
  "voice.error.connection.title": "ການເຊື່ອມຕໍ່ສຽງລົ້ມເຫລວ",
  "voice.error.connection.description": "ການເຊື່ອມຕໍ່ກັບ Deepgram ຖືກຂັດຂວາງ.",
  "voice.error.microphone.title": "ບໍ່ສາມາດໃຊ້ໄມໂຄຣໂຟນໄດ້",
  "voice.error.microphone.description": "Prisme ບໍ່ສາມາດເຂົ້າເຖິງໄມໂຄຣໂຟນຂອງທ່ານໄດ້.",
}
