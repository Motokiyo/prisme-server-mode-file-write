export const dict = {
  ...
  "toast.file.notFound.title": "فائل نہیں ملی",
  "notes.empty.title": "کوئی نوٹ کھلا نہیں ہے",
  "notes.empty.description": "ایکسپلورر سے کوئی فائل منتخب کریں یا Markdown نوٹ بنائیں۔",
  "notes.empty.create": "نوٹ بنائیں",
  "notes.create.prompt": "نوٹ کا نام",
  "notes.create.defaultName": "بلا عنوان نوٹ",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "نوٹ بنائیں",
  "dialog.note.create.name.label": "نوٹ کا نام",
  "dialog.note.create.name.placeholder": "میرے خیالات",
  "dialog.note.create.confirm": "بنائیں",
  "dialog.note.create.error.exists": "اس نام کا نوٹ پہلے سے موجود ہے۔",
  "dialog.file.rename.title": "فائل کا نام تبدیل کریں",
  "dialog.file.rename.name.label": "نیا نام",
  "dialog.file.rename.confirm": "نام تبدیل کریں",
  "dialog.file.rename.error.exists": "اس نام کی فائل پہلے سے موجود ہے۔",
  "dialog.file.delete.title": "فائل حذف کریں",
  "dialog.file.delete.description": "کیا آپ واقعی «{{name}}» کو حذف کرنا چاہتے ہیں؟ یہ عمل واپس نہیں لیا جا سکتا۔",
  "dialog.file.delete.confirm": "حذف کریں",
  "dialog.file.create.title": "نئی فائل",
  "dialog.file.create.name.label": "فائل کا نام",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "بنائیں",
  "dialog.file.create.error.exists": "اس نام کی فائل پہلے سے موجود ہے۔",
  "dialog.directory.create.title": "نیا فولڈر",
  "dialog.directory.create.name.label": "فولڈر کا نام",
  "dialog.directory.create.name.placeholder": "میرا فولڈر",
  "dialog.directory.create.confirm": "بنائیں",
  "dialog.directory.create.error.exists": "اس نام کا فولڈر پہلے سے موجود ہے۔",
  "dialog.directory.create.defaultName": "نیا فولڈر",
  "dialog.directory.rename.title": "فولڈر کا نام تبدیل کریں",
  "dialog.directory.delete.title": "فولڈر حذف کریں",
  "dialog.directory.delete.description": "«{{name}}» اور اس کا سارا مواد حذف کریں؟ یہ عمل واپس نہیں لیا جا سکتا۔",
  "dialog.directory.delete.confirm": "حذف کریں",
  "fileTree.action.rename": "نام تبدیل کریں",
  "fileTree.action.delete": "حذف کریں",
  "fileTree.action.newFile": "نئی فائل",
  "fileTree.action.newDirectory": "نیا فولڈر",
  "fileTree.action.newSubDirectory": "نیا ذیلی فولڈر",
  "toast.file.rename.failed.title": "فائل کا نام تبدیل کرنے میں ناکامی",
  "toast.file.delete.failed.title": "فائل حذف کرنے میں ناکامی",
  "toast.file.create.failed.title": "فائل بنانے میں ناکامی",
  "toast.directory.create.failed.title": "فولڈر بنانے میں ناکامی",
  "toast.directory.delete.failed.title": "فولڈر حذف کرنے میں ناکامی",
  "toast.directory.rename.failed.title": "فولڈر کا نام تبدیل کرنے میں ناکامی",
  "settings.general.section.voice": "آواز",
  "settings.general.voice.deepgramKey.title": "Deepgram API کلید",
  "settings.general.voice.deepgramKey.description": "پرامپٹ میں املا کو متن میں بدلنے کے لیے Deepgram استعمال کریں۔",
  "settings.general.voice.deepgramKey.placeholder": "Deepgram کلید چسپاں کریں",
  "settings.general.voice.language.title": "آواز کی زبان",
  "settings.general.voice.language.description": "نقل نویسی کے لیے استعمال ہونے والا Deepgram زبان کوڈ۔",
  "settings.general.voice.model.title": "آواز کا ماڈل",
  "settings.general.voice.model.description": "نقل نویسی کے لیے استعمال ہونے والا Deepgram ماڈل۔",
  "settings.general.section.support": "خرابی کی اطلاع دیں",
  "settings.support.row.bugEmail.title": "ای میل کے ذریعے",
  "settings.support.row.bugEmail.description": "اپنی تنصیب کی معلومات کے ساتھ Prisme ٹیم کو پیغام بھیجیں۔",
  "settings.support.row.bugEmail.action": "ای میل لکھیں",
  "settings.support.row.bugIssue.title": "GitHub پر",
  "settings.support.row.bugIssue.description": "پہلے سے بھرا ہوا GitHub فارم کھولیں (GitHub اکاؤنٹ درکار ہے)۔",
  "settings.support.row.bugIssue.action": "GitHub کھولیں",
  "voice.action.start": "املا شروع کریں",
  "voice.action.stop": "املا روکیں",
  "voice.state.recording": "ریکارڈنگ جاری ہے",
  "voice.error.missingKey.title": "Deepgram کلید درکار ہے",
  "voice.error.missingKey.description": "صوتی ان پٹ استعمال کرنے کے لیے ترتیبات میں اپنی Deepgram API کلید شامل کریں۔",
  "voice.error.connection.title": "صوتی کنکشن ناکام ہو گیا",
  "voice.error.connection.description": "Deepgram سے کنکشن منقطع ہو گیا۔",
  "voice.error.microphone.title": "مائیکروفون دستیاب نہیں",
  "voice.error.microphone.description": "Prisme آپ کے مائیکروفون تک رسائی حاصل نہ کر سکا۔",
}
