export const dict = {
  ...
  "toast.file.notFound.title": "Filen blev ikke fundet",
  "notes.empty.title": "Ingen note åben",
  "notes.empty.description": "Vælg en fil i stifinderen, eller opret en Markdown-note.",
  "notes.empty.create": "Opret note",
  "notes.create.prompt": "Notenavn",
  "notes.create.defaultName": "Note uden titel",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Opret note",
  "dialog.note.create.name.label": "Notenavn",
  "dialog.note.create.name.placeholder": "Mine idéer",
  "dialog.note.create.confirm": "Opret",
  "dialog.note.create.error.exists": "Der findes allerede en note med dette navn.",
  "dialog.file.rename.title": "Omdøb fil",
  "dialog.file.rename.name.label": "Nyt navn",
  "dialog.file.rename.confirm": "Omdøb",
  "dialog.file.rename.error.exists": "Der findes allerede en fil med dette navn.",
  "dialog.file.delete.title": "Slet fil",
  "dialog.file.delete.description": "Er du sikker på, at du vil slette “{{name}}”? Denne handling kan ikke fortrydes.",
  "dialog.file.delete.confirm": "Slet",
  "dialog.file.create.title": "Ny fil",
  "dialog.file.create.name.label": "Filnavn",
  "dialog.file.create.name.placeholder": "eksempel.md",
  "dialog.file.create.confirm": "Opret",
  "dialog.file.create.error.exists": "Der findes allerede en fil med dette navn.",
  ...
  "dialog.directory.create.confirm": "Opret",
  "dialog.directory.create.error.exists": "Der findes allerede en mappe med dette navn.",
  "dialog.directory.create.defaultName": "Ny mappe",
  "dialog.directory.rename.title": "Omdøb mappe",
  "dialog.directory.delete.title": "Slet mappe",
  "dialog.directory.delete.description": "Vil du slette “{{name}}” og hele indholdet? Denne handling kan ikke fortrydes.",
  "dialog.directory.delete.confirm": "Slet",
  "fileTree.action.rename": "Omdøb",
  "fileTree.action.delete": "Slet",
  "fileTree.action.newFile": "Ny fil",
  "fileTree.action.newDirectory": "Ny mappe",
  "fileTree.action.newSubDirectory": "Ny undermappe",
  "toast.file.rename.failed.title": "Filen kunne ikke omdøbes",
  "toast.file.delete.failed.title": "Filen kunne ikke slettes",
  "toast.file.create.failed.title": "Filen kunne ikke oprettes",
  "toast.directory.create.failed.title": "Mappen kunne ikke oprettes",
  "toast.directory.delete.failed.title": "Mappen kunne ikke slettes",
  "toast.directory.rename.failed.title": "Mappen kunne ikke omdøbes",
  "settings.general.section.voice": "Stemme",
  "settings.general.voice.deepgramKey.title": "Deepgram API-nøgle",
  "settings.general.voice.deepgramKey.description": "Brug Deepgram til at transskribere diktering i prompten.",
  "settings.general.voice.deepgramKey.placeholder": "Indsæt en Deepgram-nøgle",
  "settings.general.voice.language.title": "Stemmesprog",
  "settings.general.voice.language.description": "Deepgram-sprogkode, der bruges til transskription.",
  "settings.general.voice.model.title": "Stemmemodel",
  "settings.general.voice.model.description": "Deepgram-model, der bruges til transskription.",
  "settings.general.section.support": "Del en fejl",
  "settings.support.row.bugEmail.title": "Via e-mail",
  "settings.support.row.bugEmail.description": "Send en besked til Prisme-teamet med oplysninger om din installation.",
  "settings.support.row.bugEmail.action": "Skriv e-mail",
  "settings.support.row.bugIssue.title": "På GitHub",
  "settings.support.row.bugIssue.description": "Åbn en forududfyldt GitHub-formular (GitHub-konto påkrævet).",
  "settings.support.row.bugIssue.action": "Åbn GitHub",
  "voice.action.start": "Start diktering",
  "voice.action.stop": "Stop diktering",
  "voice.state.recording": "Optager",
  "voice.error.missingKey.title": "Deepgram-nøgle påkrævet",
  "voice.error.missingKey.description": "Tilføj din Deepgram API-nøgle i Indstillinger for at bruge stemmeinput.",
  "voice.error.connection.title": "Stemmeforbindelsen mislykkedes",
  "voice.error.connection.description": "Forbindelsen til Deepgram blev afbrudt.",
  "voice.error.microphone.title": "Mikrofonen er ikke tilgængelig",
  "voice.error.microphone.description": "Prisme kunne ikke få adgang til din mikrofon.",
}
