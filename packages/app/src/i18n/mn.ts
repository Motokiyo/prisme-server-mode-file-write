export const dict = {
  ...
  "toast.file.notFound.title": "Файл олдсонгүй",
  "notes.empty.title": "Нээлттэй тэмдэглэл алга",
  "notes.empty.description": "Хөтчөөс файл сонгох эсвэл Markdown тэмдэглэл үүсгэнэ үү.",
  "notes.empty.create": "Тэмдэглэл үүсгэх",
  "notes.create.prompt": "Тэмдэглэлийн нэр",
  "notes.create.defaultName": "Гарчиггүй тэмдэглэл",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Тэмдэглэл үүсгэх",
  "dialog.note.create.name.label": "Тэмдэглэлийн нэр",
  "dialog.note.create.name.placeholder": "Миний санаанууд",
  "dialog.note.create.confirm": "Үүсгэх",
  "dialog.note.create.error.exists": "Ийм нэртэй тэмдэглэл аль хэдийн байна.",
  "dialog.file.rename.title": "Файлын нэрийг өөрчлөх",
  "dialog.file.rename.name.label": "Шинэ нэр",
  "dialog.file.rename.confirm": "Нэрээ өөрчлөх",
  "dialog.file.rename.error.exists": "Ийм нэртэй файл аль хэдийн байна.",
  "dialog.file.delete.title": "Файлыг устгах",
  "dialog.file.delete.description": "Та “{{name}}”-г устгахдаа итгэлтэй байна уу? Энэ үйлдлийг буцаах боломжгүй.",
  "dialog.file.delete.confirm": "Устгах",
  "dialog.file.create.title": "Шинэ файл",
  "dialog.file.create.name.label": "Файлын нэр",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "Үүсгэх",
  "dialog.file.create.error.exists": "Ийм нэртэй файл аль хэдийн байна.",
  "dialog.directory.create.title": "Шинэ фолдер",
  "dialog.directory.create.name.label": "Фолдерын нэр",
  "dialog.directory.create.name.placeholder": "Миний фолдер",
  "dialog.directory.create.confirm": "Үүсгэх",
  "dialog.directory.create.error.exists": "Ийм нэртэй фолдер аль хэдийн байна.",
  "dialog.directory.create.defaultName": "Шинэ фолдер",
  "dialog.directory.rename.title": "Фолдерын нэрийг өөрчлөх",
  "dialog.directory.delete.title": "Фолдерыг устгах",
  "dialog.directory.delete.description": "“{{name}}” болон түүний бүх агуулгыг устгах уу? Энэ үйлдлийг буцаах боломжгүй.",
  "dialog.directory.delete.confirm": "Устгах",
  "fileTree.action.rename": "Нэрээ өөрчлөх",
  "fileTree.action.delete": "Устгах",
  "fileTree.action.newFile": "Шинэ файл",
  "fileTree.action.newDirectory": "Шинэ фолдер",
  "fileTree.action.newSubDirectory": "Шинэ дэд фолдер",
  "toast.file.rename.failed.title": "Файлын нэрийг өөрчилж чадсангүй",
  "toast.file.delete.failed.title": "Файлыг устгаж чадсангүй",
  "toast.file.create.failed.title": "Файлыг үүсгэж чадсангүй",
  "toast.directory.create.failed.title": "Фолдерыг үүсгэж чадсангүй",
  "toast.directory.delete.failed.title": "Фолдерыг устгаж чадсангүй",
  "toast.directory.rename.failed.title": "Фолдерын нэрийг өөрчилж чадсангүй",
  "settings.general.section.voice": "Дуу хоолой",
  "settings.general.voice.deepgramKey.title": "Deepgram API түлхүүр",
  "settings.general.voice.deepgramKey.description": "Хүсэлтийн талбарт хэлснийг бичвэр болгохын тулд Deepgram ашиглана.",
  "settings.general.voice.deepgramKey.placeholder": "Deepgram түлхүүр буулгана уу",
  "settings.general.voice.language.title": "Дуу хоолойн хэл",
  "settings.general.voice.language.description": "Бичвэр болгоход ашиглагдах Deepgram хэлний код.",
  "settings.general.voice.model.title": "Дуу хоолойн загвар",
  "settings.general.voice.model.description": "Бичвэр болгоход ашиглагдах Deepgram загвар.",
  "settings.general.section.support": "Алдаа мэдэгдэх",
  "settings.support.row.bugEmail.title": "Имэйлээр",
  "settings.support.row.bugEmail.description": "Суулгацын мэдээллийн хамт Prisme багт мессеж илгээнэ үү.",
  "settings.support.row.bugEmail.action": "Имэйл бичих",
  "settings.support.row.bugIssue.title": "GitHub дээр",
  "settings.support.row.bugIssue.description": "Урьдчилан бөглөсөн GitHub маягтыг нээх (GitHub бүртгэл шаардлагатай).",
  "settings.support.row.bugIssue.action": "GitHub нээх",
  "voice.action.start": "Бичүүлж эхлэх",
  "voice.action.stop": "Бичүүлэхийг зогсоох",
  "voice.state.recording": "Бичиж байна",
  "voice.error.missingKey.title": "Deepgram түлхүүр шаардлагатай",
  "voice.error.missingKey.description": "Дуут оролтыг ашиглахын тулд тохиргоонд Deepgram API түлхүүрээ нэмнэ үү.",
  "voice.error.connection.title": "Дуут холболт амжилтгүй боллоо",
  "voice.error.connection.description": "Deepgram-тай холболт тасарлаа.",
  "voice.error.microphone.title": "Микрофон боломжгүй",
  "voice.error.microphone.description": "Prisme таны микрофонд хандаж чадсангүй.",
}
