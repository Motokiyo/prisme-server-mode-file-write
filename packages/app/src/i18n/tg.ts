export const dict = {
  ...
  "toast.file.notFound.title": "Файл ёфт нашуд",
  "notes.empty.title": "Ягон қайд кушода нест",
  "notes.empty.description": "Аз браузер файлеро интихоб кунед ё қайди Markdown созед.",
  "notes.empty.create": "Эҷоди қайд",
  "notes.create.prompt": "Номи қайд",
  "notes.create.defaultName": "Қайди беном",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Эҷоди қайд",
  "dialog.note.create.name.label": "Номи қайд",
  "dialog.note.create.name.placeholder": "Ғояҳои ман",
  "dialog.note.create.confirm": "Эҷод кардан",
  "dialog.note.create.error.exists": "Қайде бо ин ном аллакай мавҷуд аст.",
  "dialog.file.rename.title": "Номи файлро иваз кунед",
  "dialog.file.rename.name.label": "Номи нав",
  "dialog.file.rename.confirm": "Номи дигар",
  "dialog.file.rename.error.exists": "Файле бо ин ном аллакай мавҷуд аст.",
  "dialog.file.delete.title": "Файлро нобуд кунед",
  "dialog.file.delete.description": "Оё мутмаин ҳастед, ки мехоҳед «{{name}}»-ро нобуд кунед? Ин амалро бозгардонидан мумкин нест.",
  "dialog.file.delete.confirm": "Нобуд кунед",
  "dialog.file.create.title": "Файли нав",
  "dialog.file.create.name.label": "Номи файл",
  "dialog.file.create.name.placeholder": "namuna.md",
  "dialog.file.create.confirm": "Эҷод кардан",
  "dialog.file.create.error.exists": "Файле бо ин ном аллакай мавҷуд аст.",
  "dialog.directory.create.title": "Ҷузвдони нав",
  "dialog.directory.create.name.label": "Номи ҷузвдон",
  "dialog.directory.create.name.placeholder": "Ҷузвдони ман",
  "dialog.directory.create.confirm": "Эҷод кардан",
  "dialog.directory.create.error.exists": "Ҷузвдоне бо ин ном аллакай мавҷуд аст.",
  "dialog.directory.create.defaultName": "Ҷузвдони нав",
  "dialog.directory.rename.title": "Номи ҷузвдонро иваз кунед",
  "dialog.directory.delete.title": "Ҷузвдонро нобуд кунед",
  "dialog.directory.delete.description": "«{{name}}» ва тамоми мундариҷаи он нобуд карда шавад? Ин амалро бозгардонидан мумкин нест.",
  "dialog.directory.delete.confirm": "Нобуд кунед",
  "fileTree.action.rename": "Номи дигар",
  "fileTree.action.delete": "Нобуд кунед",
  "fileTree.action.newFile": "Файли нав",
  "fileTree.action.newDirectory": "Ҷузвдони нав",
  "fileTree.action.newSubDirectory": "Зерҷузвдони нав",
  "toast.file.rename.failed.title": "Номи файлро иваз кардан нашуд",
  "toast.file.delete.failed.title": "Файлро нобуд кардан нашуд",
  "toast.file.create.failed.title": "Файлро эҷод кардан нашуд",
  "toast.directory.create.failed.title": "Ҷузвдонро эҷод кардан нашуд",
  "toast.directory.delete.failed.title": "Ҷузвдонро нобуд кардан нашуд",
  "toast.directory.rename.failed.title": "Номи ҷузвдонро иваз кардан нашуд",
  "settings.general.section.voice": "Овоз",
  "settings.general.voice.deepgramKey.title": "Калиди API-и Deepgram",
  "settings.general.voice.deepgramKey.description": "Барои ба матн табдил додани нутқ дар майдони дархост Deepgram-ро истифода баред.",
  "settings.general.voice.deepgramKey.placeholder": "Калиди Deepgram-ро гузоред",
  "settings.general.voice.language.title": "Забони овоз",
  "settings.general.voice.language.description": "Рамзи забони Deepgram, ки барои табдил ба матн истифода мешавад.",
  "settings.general.voice.model.title": "Модели овоз",
  "settings.general.voice.model.description": "Модели Deepgram, ки барои табдил ба матн истифода мешавад.",
  "settings.general.section.support": "Хабар додан дар бораи хато",
  "settings.support.row.bugEmail.title": "Тавассути почтаи электронӣ",
  "settings.support.row.bugEmail.description": "Ба дастаи Prisme бо маълумоти насби худ паём фиристед.",
  "settings.support.row.bugEmail.action": "Навиштани нома",
  "settings.support.row.bugIssue.title": "Дар GitHub",
  "settings.support.row.bugIssue.description": "Варақаи пешакӣ пуркардашудаи GitHub-ро кушоед (ҳисоби GitHub лозим аст).",
  "settings.support.row.bugIssue.action": "Кушодани GitHub",
  "voice.action.start": "Оғози дикта",
  "voice.action.stop": "Қатъи дикта",
  "voice.state.recording": "Сабт шуда истодааст",
  "voice.error.missingKey.title": "Калиди Deepgram лозим аст",
  "voice.error.missingKey.description": "Барои истифодаи вуруди овозӣ калиди API-и Deepgram-ро дар танзимот илова кунед.",
  "voice.error.connection.title": "Пайвасти овозӣ муваффақ нашуд",
  "voice.error.connection.description": "Пайваст бо Deepgram қатъ гардид.",
  "voice.error.microphone.title": "Микрофон дастрас нест",
  "voice.error.microphone.description": "Prisme ба микрофони шумо дастрасӣ пайдо карда натавонист.",
}
