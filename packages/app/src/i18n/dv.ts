export const dict = {
  ...
  "toast.file.notFound.title": "ފައިލް ނުފެނުނެވެ",
  "notes.empty.title": "ހުޅުވާފައިވާ ނޯޓެއް ނެތެވެ",
  "notes.empty.description": "އެކްސްޕްލޯރާއިން ފައިލެއް ޚިޔާރުކުރައްވާ ނުވަތަ Markdown ނޯޓެއް އުފައްދަވާށެވެ",
  "notes.empty.create": "ނޯޓް އުފެއްދުން",
  "notes.create.prompt": "ނޯޓްގެ ނަން",
  "notes.create.defaultName": "ނަން ނެތް ނޯޓް",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "ނޯޓް އުފެއްދުން",
  "dialog.note.create.name.label": "ނޯޓްގެ ނަން",
  "dialog.note.create.name.placeholder": "އަޅުގަނޑުގެ ޚިޔާލުތައް",
  "dialog.note.create.confirm": "އުފެއްދުން",
  "dialog.note.create.error.exists": "މި ނަމުގައި ނޯޓެއް ކުރިންވެސް އެބައޮތެވެ",
  "dialog.file.rename.title": "ފައިލްގެ ނަން ބަދަލުކުރުން",
  "dialog.file.rename.name.label": "އާ ނަން",
  "dialog.file.rename.confirm": "ނަން ބަދަލުކުރުން",
  "dialog.file.rename.error.exists": "މި ނަމުގައި ފައިލެއް ކުރިންވެސް އެބައޮތެވެ",
  "dialog.file.delete.title": "ފައިލް ފުހެލުން",
  "dialog.file.delete.description": "«{{name}}» ފުހެލަން ޔަގީންތޯއެވެ؟ މި ޢަމަލު އަނބުރާ ނުގެނެވޭނެއެވެ",
  "dialog.file.delete.confirm": "ފުހެލުން",
  "dialog.file.create.title": "އާ ފައިލް",
  "dialog.file.create.name.label": "ފައިލްގެ ނަން",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "އުފެއްދުން",
  "dialog.file.create.error.exists": "މި ނަމުގައި ފައިލެއް ކުރިންވެސް އެބައޮތެވެ",
  "dialog.directory.create.title": "އާ ފޯލްޑަރ",
  "dialog.directory.create.name.label": "ފޯލްޑަރގެ ނަން",
  "dialog.directory.create.name.placeholder": "އަޅުގަނޑުގެ ފޯލްޑަރ",
  "dialog.directory.create.confirm": "އުފެއްދުން",
  "dialog.directory.create.error.exists": "މި ނަމުގައި ފޯލްޑަރެއް ކުރިންވެސް އެބައޮތެވެ",
  "dialog.directory.create.defaultName": "އާ ފޯލްޑަރ",
  "dialog.directory.rename.title": "ފޯލްޑަރގެ ނަން ބަދަލުކުރުން",
  "dialog.directory.delete.title": "ފޯލްޑަރ ފުހެލުން",
  "dialog.directory.delete.description": "«{{name}}» އާއި އޭގެ ހުރިހާ އެއްޗެއް ފުހެލަންތޯއެވެ؟ މި ޢަމަލު އަނބުރާ ނުގެނެވޭނެއެވެ",
  "dialog.directory.delete.confirm": "ފުހެލުން",
  "fileTree.action.rename": "ނަން ބަދަލުކުރުން",
  "fileTree.action.delete": "ފުހެލުން",
  "fileTree.action.newFile": "އާ ފައިލް",
  "fileTree.action.newDirectory": "އާ ފޯލްޑަރ",
  "fileTree.action.newSubDirectory": "އާ ސަބްފޯލްޑަރ",
  "toast.file.rename.failed.title": "ފައިލްގެ ނަން ބަދަލުކުރެވޭގޮތް ނުވިއެވެ",
  "toast.file.delete.failed.title": "ފައިލް ފުހެލެވޭގޮތް ނުވިއެވެ",
  "toast.file.create.failed.title": "ފައިލް އުފެއްދޭގޮތް ނުވިއެވެ",
  "toast.directory.create.failed.title": "ފޯލްޑަރ އުފެއްދޭގޮތް ނުވިއެވެ",
  "toast.directory.delete.failed.title": "ފޯލްޑަރ ފުހެލެވޭގޮތް ނުވިއެވެ",
  "toast.directory.rename.failed.title": "ފޯލްޑަރގެ ނަން ބަދަލުކުރެވޭގޮތް ނުވިއެވެ",
  "settings.general.section.voice": "އަޑު",
  "settings.general.voice.deepgramKey.title": "Deepgram API ކީ",
  "settings.general.voice.deepgramKey.description": "ޕްރޮމްޕްޓްގައި ދައްކާ ވާހަކަ ލިޔުމަށް ބަދަލުކުރުމަށް Deepgram ބޭނުންކުރުން",
  "settings.general.voice.deepgramKey.placeholder": "Deepgram ކީއެއް ޕޭސްޓްކުރައްވާ",
  "settings.general.voice.language.title": "އަޑުގެ ބަސް",
  "settings.general.voice.language.description": "ލިޔުމަށް ބަދަލުކުރުމަށް ބޭނުންކުރާ Deepgram ބަހުގެ ކޯޑް",
  "settings.general.voice.model.title": "އަޑުގެ މޮޑެލް",
  "settings.general.voice.model.description": "ލިޔުމަށް ބަދަލުކުރުމަށް ބޭނުންކުރާ Deepgram މޮޑެލް",
  "settings.general.section.support": "މައްސަލައެއް ރިޕޯޓްކުރުން",
  "settings.support.row.bugEmail.title": "އީމެއިލް މެދުވެރިކޮށް",
  "settings.support.row.bugEmail.description": "ތިޔަބޭފުޅާގެ އިންސްޓޮލޭޝަން މަޢުލޫމާތާއެކު Prisme ޓީމަށް މެސެޖެއް ފޮނުއްވާށެވެ",
  "settings.support.row.bugEmail.action": "އީމެއިލް ލިޔުން",
  "settings.support.row.bugIssue.title": "GitHub ގައި",
  "settings.support.row.bugIssue.description": "ކުރިން ފުރާފައިވާ GitHub ފޯމެއް ހުޅުވުން (GitHub އެކައުންޓެއް ބޭނުންވެއެވެ)",
  "settings.support.row.bugIssue.action": "GitHub ހުޅުވުން",
  "voice.action.start": "ބުނެދިނުން ފެށުން",
  "voice.action.stop": "ބުނެދިނުން ހުއްޓާލުން",
  "voice.state.recording": "ރެކޯޑްކުރަނީ",
  "voice.error.missingKey.title": "Deepgram ކީ ބޭނުންވެއެވެ",
  "voice.error.missingKey.description": "އަޑުން ލިޔުމަށް، ސެޓިންގސްގައި ތިޔަބޭފުޅާގެ Deepgram API ކީ އިތުރުކުރައްވާށެވެ",
  "voice.error.connection.title": "އަޑުގެ ގުޅުން ނާކާމިޔާބުވިއެވެ",
  "voice.error.connection.description": "Deepgram އާ އޮތް ގުޅުން ކެނޑިއްޖެއެވެ",
  "voice.error.microphone.title": "މައިކްރޮފޯން ލިބެން ނެތެވެ",
  "voice.error.microphone.description": "Prisme އަށް ތިޔަބޭފުޅާގެ މައިކްރޮފޯނަށް ވަދެވޭގޮތް ނުވިއެވެ",
}
