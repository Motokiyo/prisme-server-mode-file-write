...
export const dict = {
  ...
  "toast.file.notFound.title": "找不到檔案",
  "notes.empty.title": "未開啟任何筆記",
  "notes.empty.description": "在檔案總管中選擇檔案，或建立一則 Markdown 筆記。",
  "notes.empty.create": "建立筆記",
  "notes.create.prompt": "筆記名稱",
  "notes.create.defaultName": "未命名筆記",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "建立筆記",
  "dialog.note.create.name.label": "筆記名稱",
  "dialog.note.create.name.placeholder": "我的想法",
  "dialog.note.create.confirm": "建立",
  "dialog.note.create.error.exists": "已存在同名的筆記。",
  "dialog.file.rename.title": "重新命名檔案",
  "dialog.file.rename.name.label": "新名稱",
  "dialog.file.rename.confirm": "重新命名",
  "dialog.file.rename.error.exists": "已存在同名的檔案。",
  "dialog.file.delete.title": "刪除檔案",
  "dialog.file.delete.description": "確定要刪除「{{name}}」嗎？此操作無法復原。",
  "dialog.file.delete.confirm": "刪除",
  "dialog.file.create.title": "新增檔案",
  "dialog.file.create.name.label": "檔案名稱",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "建立",
  "dialog.file.create.error.exists": "已存在同名的檔案。",
  "dialog.directory.create.title": "新增檔案夾",
  "dialog.directory.create.name.label": "檔案夾名稱",
  "dialog.directory.create.name.placeholder": "我的檔案夾",
  "dialog.directory.create.confirm": "建立",
  "dialog.directory.create.error.exists": "已存在同名的檔案夾。",
  "dialog.directory.create.defaultName": "新增檔案夾",
  "dialog.directory.rename.title": "重新命名檔案夾",
  "dialog.directory.delete.title": "刪除檔案夾",
  "dialog.directory.delete.description": "刪除「{{name}}」及其所有內容？此操作無法復原。",
  "dialog.directory.delete.confirm": "刪除",
  "fileTree.action.rename": "重新命名",
  "fileTree.action.delete": "刪除",
  "fileTree.action.newFile": "新增檔案",
  "fileTree.action.newDirectory": "新增檔案夾",
  "fileTree.action.newSubDirectory": "新增子檔案夾",
  "toast.file.rename.failed.title": "重新命名檔案失敗",
  "toast.file.delete.failed.title": "刪除檔案失敗",
  "toast.file.create.failed.title": "建立檔案失敗",
  "toast.directory.create.failed.title": "建立檔案夾失敗",
  "toast.directory.delete.failed.title": "刪除檔案夾失敗",
  "toast.directory.rename.failed.title": "重新命名檔案夾失敗",
  "settings.general.section.voice": "語音",
  "settings.general.voice.deepgramKey.title": "Deepgram API 金鑰",
  "settings.general.voice.deepgramKey.description": "使用 Deepgram 轉寫提示詞中的口述內容。",
  "settings.general.voice.deepgramKey.placeholder": "貼上 Deepgram 金鑰",
  "settings.general.voice.language.title": "語音語言",
  "settings.general.voice.language.description": "用於轉寫的 Deepgram 語言代碼。",
  "settings.general.voice.model.title": "語音模型",
  "settings.general.voice.model.description": "用於轉寫的 Deepgram 模型。",
  "settings.general.section.support": "回報問題",
  "settings.support.row.bugEmail.title": "透過電子郵件",
  "settings.support.row.bugEmail.description": "向 Prisme 團隊傳送一則包含安裝資訊的訊息。",
  "settings.support.row.bugEmail.action": "撰寫電子郵件",
  "settings.support.row.bugIssue.title": "在 GitHub 上",
  "settings.support.row.bugIssue.description": "開啟預先填寫的 GitHub 表單（需要 GitHub 帳號）。",
  "settings.support.row.bugIssue.action": "開啟 GitHub",
  "voice.action.start": "開始口述",
  "voice.action.stop": "停止口述",
  "voice.state.recording": "錄音中",
  "voice.error.missingKey.title": "需要 Deepgram 金鑰",
  "voice.error.missingKey.description": "請在設定中新增你的 Deepgram API 金鑰以使用語音輸入。",
  "voice.error.connection.title": "語音連線失敗",
  "voice.error.connection.description": "與 Deepgram 的連線已中斷。",
  "voice.error.microphone.title": "麥克風無法使用",
  "voice.error.microphone.description": "Prisme 無法存取你的麥克風。",
