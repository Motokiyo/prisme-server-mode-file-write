export const dict = {
  ...
  "toast.file.notFound.title": "Fayl tapılmadı",
  "notes.empty.title": "Açıq qeyd yoxdur",
  "notes.empty.description": "Bələdçidən bir fayl seçin və ya Markdown qeydi yaradın.",
  "notes.empty.create": "Qeyd yarat",
  "notes.create.prompt": "Qeydin adı",
  "notes.create.defaultName": "Adsız qeyd",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Qeyd yarat",
  "dialog.note.create.name.label": "Qeydin adı",
  "dialog.note.create.name.placeholder": "Fikirlərim",
  "dialog.note.create.confirm": "Yarat",
  "dialog.note.create.error.exists": "Bu adda qeyd artıq mövcuddur.",
  "dialog.file.rename.title": "Faylın adını dəyiş",
  "dialog.file.rename.name.label": "Yeni ad",
  "dialog.file.rename.confirm": "Adını dəyiş",
  "dialog.file.rename.error.exists": "Bu adda fayl artıq mövcuddur.",
  "dialog.file.delete.title": "Faylı sil",
  "dialog.file.delete.description": "“{{name}}” faylını silmək istədiyinizə əminsiniz? Bu əməliyyat geri qaytarıla bilməz.",
  "dialog.file.delete.confirm": "Sil",
  "dialog.file.create.title": "Yeni fayl",
  "dialog.file.create.name.label": "Faylın adı",
  "dialog.file.create.name.placeholder": "numune.md",
  "dialog.file.create.confirm": "Yarat",
  "dialog.file.create.error.exists": "Bu adda fayl artıq mövcuddur.",
  "dialog.directory.create.title": "Yeni qovluq",
  "dialog.directory.create.name.label": "Qovluğun adı",
  "dialog.directory.create.name.placeholder": "Qovluğum",
  "dialog.directory.create.confirm": "Yarat",
  "dialog.directory.create.error.exists": "Bu adda qovluq artıq mövcuddur.",
  "dialog.directory.create.defaultName": "Yeni qovluq",
  "dialog.directory.rename.title": "Qovluğun adını dəyiş",
  "dialog.directory.delete.title": "Qovluğu sil",
  "dialog.directory.delete.description": "“{{name}}” qovluğu və bütün məzmunu silinsin? Bu əməliyyat geri qaytarıla bilməz.",
  "dialog.directory.delete.confirm": "Sil",
  "fileTree.action.rename": "Adını dəyiş",
  "fileTree.action.delete": "Sil",
  "fileTree.action.newFile": "Yeni fayl",
  "fileTree.action.newDirectory": "Yeni qovluq",
  "fileTree.action.newSubDirectory": "Yeni alt qovluq",
  "toast.file.rename.failed.title": "Faylın adı dəyişdirilə bilmədi",
  "toast.file.delete.failed.title": "Fayl silinə bilmədi",
  "toast.file.create.failed.title": "Fayl yaradıla bilmədi",
  "toast.directory.create.failed.title": "Qovluq yaradıla bilmədi",
  "toast.directory.delete.failed.title": "Qovluq silinə bilmədi",
  "toast.directory.rename.failed.title": "Qovluğun adı dəyişdirilə bilmədi",
  "settings.general.section.voice": "Səs",
  "settings.general.voice.deepgramKey.title": "Deepgram API açarı",
  "settings.general.voice.deepgramKey.description": "Sorğu sahəsindəki diktəni mətnə çevirmək üçün Deepgram istifadə edin.",
  "settings.general.voice.deepgramKey.placeholder": "Deepgram açarını yapışdırın",
  "settings.general.voice.language.title": "Səs dili",
  "settings.general.voice.language.description": "Mətnə çevirmə üçün istifadə olunan Deepgram dil kodu.",
  "settings.general.voice.model.title": "Səs modeli",
  "settings.general.voice.model.description": "Mətnə çevirmə üçün istifadə olunan Deepgram modeli.",
  "settings.general.section.support": "Xəta bildir",
  "settings.support.row.bugEmail.title": "E-poçt ilə",
  "settings.support.row.bugEmail.description": "Quraşdırma məlumatlarınızla birlikdə Prisme komandasına mesaj göndərin.",
  "settings.support.row.bugEmail.action": "E-poçt yaz",
  "settings.support.row.bugIssue.title": "GitHub-da",
  "settings.support.row.bugIssue.description": "Əvvəlcədən doldurulmuş GitHub formasını açın (GitHub hesabı tələb olunur).",
  "settings.support.row.bugIssue.action": "GitHub-ı aç",
  "voice.action.start": "Diktəni başlat",
  "voice.action.stop": "Diktəni dayandır",
  "voice.state.recording": "Yazılır",
  "voice.error.missingKey.title": "Deepgram açarı tələb olunur",
  "voice.error.missingKey.description": "Səsli girişdən istifadə etmək üçün tənzimləmələrdə Deepgram API açarınızı əlavə edin.",
  "voice.error.connection.title": "Səs bağlantısı alınmadı",
  "voice.error.connection.description": "Deepgram bağlantısı kəsildi.",
  "voice.error.microphone.title": "Mikrofon əlçatan deyil",
  "voice.error.microphone.description": "Prisme mikrofonunuza daxil ola bilmədi.",
}
