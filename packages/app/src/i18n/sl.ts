export const dict = {
  ...
  "toast.file.notFound.title": "Datoteke ni mogoče najti",
  "notes.empty.title": "Nobena beležka ni odprta",
  "notes.empty.description": "Izberite datoteko v raziskovalcu ali ustvarite beležko Markdown.",
  "notes.empty.create": "Ustvari beležko",
  "notes.create.prompt": "Ime beležke",
  "notes.create.defaultName": "Neimenovana beležka",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Ustvari beležko",
  "dialog.note.create.name.label": "Ime beležke",
  "dialog.note.create.name.placeholder": "Moje ideje",
  "dialog.note.create.confirm": "Ustvari",
  "dialog.note.create.error.exists": "Beležka s tem imenom že obstaja.",
  "dialog.file.rename.title": "Preimenuj datoteko",
  "dialog.file.rename.name.label": "Novo ime",
  "dialog.file.rename.confirm": "Preimenuj",
  "dialog.file.rename.error.exists": "Datoteka s tem imenom že obstaja.",
  "dialog.file.delete.title": "Izbriši datoteko",
  "dialog.file.delete.description": "Ali ste prepričani, da želite izbrisati »{{name}}«? Tega dejanja ni mogoče razveljaviti.",
  "dialog.file.delete.confirm": "Izbriši",
  "dialog.file.create.title": "Nova datoteka",
  "dialog.file.create.name.label": "Ime datoteke",
  "dialog.file.create.name.placeholder": "primer.md",
  "dialog.file.create.confirm": "Ustvari",
  "dialog.file.create.error.exists": "Datoteka s tem imenom že obstaja.",
  "dialog.directory.create.title": "Nova mapa",
  "dialog.directory.create.name.label": "Ime mape",
  "dialog.directory.create.name.placeholder": "Moja mapa",
  "dialog.directory.create.confirm": "Ustvari",
  "dialog.directory.create.error.exists": "Mapa s tem imenom že obstaja.",
  "dialog.directory.create.defaultName": "Nova mapa",
  "dialog.directory.rename.title": "Preimenuj mapo",
  "dialog.directory.delete.title": "Izbriši mapo",
  "dialog.directory.delete.description": "Ali želite izbrisati »{{name}}« in vso njeno vsebino? Tega dejanja ni mogoče razveljaviti.",
  ...
  "toast.file.rename.failed.title": "Datoteke ni bilo mogoče preimenovati",
  "toast.file.delete.failed.title": "Datoteke ni bilo mogoče izbrisati",
  "toast.file.create.failed.title": "Datoteke ni bilo mogoče ustvariti",
  "toast.directory.create.failed.title": "Mape ni bilo mogoče ustvariti",
  "toast.directory.delete.failed.title": "Mape ni bilo mogoče izbrisati",
  "toast.directory.rename.failed.title": "Mape ni bilo mogoče preimenovati",
  "settings.general.section.voice": "Glas",
  "settings.general.voice.deepgramKey.title": "Ključ API Deepgram",
  "settings.general.voice.deepgramKey.description": "Uporabi Deepgram za prepis narekovanja v pozivu.",
  "settings.general.voice.deepgramKey.placeholder": "Prilepite ključ Deepgram",
  "settings.general.voice.language.title": "Jezik glasu",
  "settings.general.voice.language.description": "Koda jezika Deepgram, uporabljena za prepis.",
  "settings.general.voice.model.title": "Glasovni model",
  "settings.general.voice.model.description": "Model Deepgram, uporabljen za prepis.",
  "settings.general.section.support": "Prijavi napako",
  "settings.support.row.bugEmail.title": "Po e-pošti",
  "settings.support.row.bugEmail.description": "Pošljite ekipi Prisme sporočilo s podatki o svoji namestitvi.",
  "settings.support.row.bugEmail.action": "Sestavi e-pošto",
  "settings.support.row.bugIssue.title": "Na GitHubu",
  "settings.support.row.bugIssue.description": "Odpri vnaprej izpolnjen obrazec GitHub (potreben je račun GitHub).",
  "settings.support.row.bugIssue.action": "Odpri GitHub",
  "voice.action.start": "Začni narekovanje",
  "voice.action.stop": "Ustavi narekovanje",
  "voice.state.recording": "Snemanje",
  "voice.error.missingKey.title": "Potreben je ključ Deepgram",
  "voice.error.missingKey.description": "Za uporabo glasovnega vnosa dodajte svoj ključ API Deepgram v nastavitvah.",
  "voice.error.connection.title": "Glasovna povezava ni uspela",
  "voice.error.connection.description": "Povezava z Deepgramom je bila prekinjena.",
  "voice.error.microphone.title": "Mikrofon ni na voljo",
  "voice.error.microphone.description": "Prisme ni mogel dostopati do vašega mikrofona.",
}
