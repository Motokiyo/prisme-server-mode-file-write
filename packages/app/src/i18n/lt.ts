...
export const dict = {
  ...
  "toast.file.notFound.title": "Failas nerastas",
  "notes.empty.title": "Neatidarytas joks užrašas",
  "notes.empty.description": "Pasirinkite failą naršyklėje arba sukurkite Markdown užrašą.",
  "notes.empty.create": "Sukurti užrašą",
  "notes.create.prompt": "Užrašo pavadinimas",
  "notes.create.defaultName": "Užrašas be pavadinimo",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Sukurti užrašą",
  "dialog.note.create.name.label": "Užrašo pavadinimas",
  "dialog.note.create.name.placeholder": "Mano idėjos",
  "dialog.note.create.confirm": "Sukurti",
  "dialog.note.create.error.exists": "Užrašas tokiu pavadinimu jau yra.",
  "dialog.file.rename.title": "Pervardyti failą",
  "dialog.file.rename.name.label": "Naujas pavadinimas",
  "dialog.file.rename.confirm": "Pervardyti",
  "dialog.file.rename.error.exists": "Failas tokiu pavadinimu jau yra.",
  "dialog.file.delete.title": "Ištrinti failą",
  "dialog.file.delete.description": "Ar tikrai norite ištrinti „{{name}}“? Šio veiksmo atšaukti negalima.",
  "dialog.file.delete.confirm": "Ištrinti",
  "dialog.file.create.title": "Naujas failas",
  "dialog.file.create.name.label": "Failo pavadinimas",
  "dialog.file.create.name.placeholder": "pavyzdys.md",
  "dialog.file.create.confirm": "Sukurti",
  "dialog.file.create.error.exists": "Failas tokiu pavadinimu jau yra.",
  "dialog.directory.create.title": "Naujas aplankas",
  "dialog.directory.create.name.label": "Aplanko pavadinimas",
  "dialog.directory.create.name.placeholder": "Mano aplankas",
  "dialog.directory.create.confirm": "Sukurti",
  "dialog.directory.create.error.exists": "Aplankas tokiu pavadinimu jau yra.",
  "dialog.directory.create.defaultName": "Naujas aplankas",
  "dialog.directory.rename.title": "Pervardyti aplanką",
  "dialog.directory.delete.title": "Ištrinti aplanką",
  "dialog.directory.delete.description": "Ištrinti „{{name}}“ ir visą jo turinį? Šio veiksmo atšaukti negalima.",
  "dialog.directory.delete.confirm": "Ištrinti",
  "fileTree.action.rename": "Pervardyti",
  "fileTree.action.delete": "Ištrinti",
  "fileTree.action.newFile": "Naujas failas",
  "fileTree.action.newDirectory": "Naujas aplankas",
  "fileTree.action.newSubDirectory": "Naujas poaplankis",
  "toast.file.rename.failed.title": "Nepavyko pervardyti failo",
  "toast.file.delete.failed.title": "Nepavyko ištrinti failo",
  "toast.file.create.failed.title": "Nepavyko sukurti failo",
  "toast.directory.create.failed.title": "Nepavyko sukurti aplanko",
  "toast.directory.delete.failed.title": "Nepavyko ištrinti aplanko",
  "toast.directory.rename.failed.title": "Nepavyko pervardyti aplanko",
  "settings.general.section.voice": "Balsas",
  "settings.general.voice.deepgramKey.title": "Deepgram API raktas",
  "settings.general.voice.deepgramKey.description": "Naudoti Deepgram diktavimui užklausoje transkribuoti.",
  "settings.general.voice.deepgramKey.placeholder": "Įklijuokite Deepgram raktą",
  "settings.general.voice.language.title": "Balso kalba",
  "settings.general.voice.language.description": "Transkripcijai naudojamas Deepgram kalbos kodas.",
  "settings.general.voice.model.title": "Balso modelis",
  "settings.general.voice.model.description": "Transkripcijai naudojamas Deepgram modelis.",
  "settings.general.section.support": "Pranešti apie klaidą",
  "settings.support.row.bugEmail.title": "El. paštu",
  "settings.support.row.bugEmail.description": "Išsiųskite Prisme komandai žinutę su savo diegimo informacija.",
  "settings.support.row.bugEmail.action": "Rašyti el. laišką",
  "settings.support.row.bugIssue.title": "GitHub platformoje",
  "settings.support.row.bugIssue.description": "Atidaryti iš anksto užpildytą GitHub formą (reikia GitHub paskyros).",
  "settings.support.row.bugIssue.action": "Atidaryti GitHub",
  "voice.action.start": "Pradėti diktavimą",
  "voice.action.stop": "Stabdyti diktavimą",
  "voice.state.recording": "Įrašoma",
  "voice.error.missingKey.title": "Reikalingas Deepgram raktas",
  "voice.error.missingKey.description": "Kad galėtumėte naudoti balso įvestį, nuostatose pridėkite savo Deepgram API raktą.",
  "voice.error.connection.title": "Nepavyko balso ryšys",
  "voice.error.connection.description": "Ryšys su Deepgram buvo nutrauktas.",
  "voice.error.microphone.title": "Mikrofonas nepasiekiamas",
  "voice.error.microphone.description": "Prisme nepavyko pasiekti jūsų mikrofono.",
}
