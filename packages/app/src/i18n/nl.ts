export const dict = {
  ...
  "toast.file.notFound.title": "Bestand niet gevonden",
  "notes.empty.title": "Geen notitie geopend",
  "notes.empty.description": "Kies een bestand in de verkenner of maak een Markdown-notitie.",
  "notes.empty.create": "Notitie maken",
  "notes.create.prompt": "Notitienaam",
  "notes.create.defaultName": "Naamloze notitie",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Notitie maken",
  "dialog.note.create.name.label": "Notitienaam",
  "dialog.note.create.name.placeholder": "Mijn ideeën",
  "dialog.note.create.confirm": "Maken",
  "dialog.note.create.error.exists": "Er bestaat al een notitie met deze naam.",
  "dialog.file.rename.title": "Bestand hernoemen",
  "dialog.file.rename.name.label": "Nieuwe naam",
  "dialog.file.rename.confirm": "Hernoemen",
  "dialog.file.rename.error.exists": "Er bestaat al een bestand met deze naam.",
  "dialog.file.delete.title": "Bestand verwijderen",
  "dialog.file.delete.description": "Weet u zeker dat u ‘{{name}}’ wilt verwijderen? Deze actie kan niet ongedaan worden gemaakt.",
  "dialog.file.delete.confirm": "Verwijderen",
  "dialog.file.create.title": "Nieuw bestand",
  "dialog.file.create.name.label": "Bestandsnaam",
  "dialog.file.create.name.placeholder": "voorbeeld.md",
  "dialog.file.create.confirm": "Maken",
  "dialog.file.create.error.exists": "Er bestaat al een bestand met deze naam.",
  "dialog.directory.create.title": "Nieuwe map",
  "dialog.directory.create.name.label": "Mapnaam",
  "dialog.directory.create.name.placeholder": "Mijn map",
  "dialog.directory.create.confirm": "Maken",
  "dialog.directory.create.error.exists": "Er bestaat al een map met deze naam.",
  "dialog.directory.create.defaultName": "Nieuwe map",
  "dialog.directory.rename.title": "Map hernoemen",
  "dialog.directory.delete.title": "Map verwijderen",
  "dialog.directory.delete.description": "‘{{name}}’ en alle inhoud verwijderen? Deze actie kan niet ongedaan worden gemaakt.",
  "dialog.directory.delete.confirm": "Verwijderen",
  "fileTree.action.rename": "Hernoemen",
  "fileTree.action.delete": "Verwijderen",
  "fileTree.action.newFile": "Nieuw bestand",
  "fileTree.action.newDirectory": "Nieuwe map",
  "fileTree.action.newSubDirectory": "Nieuwe submap",
  "toast.file.rename.failed.title": "Bestand hernoemen mislukt",
  "toast.file.delete.failed.title": "Bestand verwijderen mislukt",
  "toast.file.create.failed.title": "Bestand maken mislukt",
  "toast.directory.create.failed.title": "Map maken mislukt",
  "toast.directory.delete.failed.title": "Map verwijderen mislukt",
  "toast.directory.rename.failed.title": "Map hernoemen mislukt",
  "settings.general.section.voice": "Spraak",
  "settings.general.voice.deepgramKey.title": "Deepgram API-sleutel",
  "settings.general.voice.deepgramKey.description": "Gebruik Deepgram om dictaat in de prompt te transcriberen.",
  "settings.general.voice.deepgramKey.placeholder": "Plak een Deepgram-sleutel",
  "settings.general.voice.language.title": "Spraaktaal",
  "settings.general.voice.language.description": "Deepgram-taalcode die voor transcriptie wordt gebruikt.",
  "settings.general.voice.model.title": "Spraakmodel",
  "settings.general.voice.model.description": "Deepgram-model dat voor transcriptie wordt gebruikt.",
  "settings.general.section.support": "Een bug melden",
  "settings.support.row.bugEmail.title": "Per e-mail",
  "settings.support.row.bugEmail.description": "Stuur het Prisme-team een bericht met uw installatiegegevens.",
  "settings.support.row.bugEmail.action": "E-mail opstellen",
  "settings.support.row.bugIssue.title": "Op GitHub",
  "settings.support.row.bugIssue.description": "Open een vooraf ingevuld GitHub-formulier (GitHub-account vereist).",
  "settings.support.row.bugIssue.action": "GitHub openen",
  "voice.action.start": "Dictaat starten",
  "voice.action.stop": "Dictaat stoppen",
  "voice.state.recording": "Opnemen",
  "voice.error.missingKey.title": "Deepgram-sleutel vereist",
  "voice.error.missingKey.description": "Voeg uw Deepgram API-sleutel toe in de instellingen om spraakinvoer te gebruiken.",
  "voice.error.connection.title": "Spraakverbinding mislukt",
  "voice.error.connection.description": "De verbinding met Deepgram is onderbroken.",
  "voice.error.microphone.title": "Microfoon niet beschikbaar",
  "voice.error.microphone.description": "Prisme kon geen toegang krijgen tot uw microfoon.",
}
