export const dict = {
  ...
  "toast.file.notFound.title": "Faýl tapylmady",
  "notes.empty.title": "Açyk bellik ýok",
  "notes.empty.description": "Gözlegçiden faýl saýlaň ýa-da Markdown belligi dörediň.",
  "notes.empty.create": "Bellik döret",
  "notes.create.prompt": "Belligiň ady",
  "notes.create.defaultName": "Atsyz bellik",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Bellik döret",
  "dialog.note.create.name.label": "Belligiň ady",
  "dialog.note.create.name.placeholder": "Meniň pikirlerim",
  "dialog.note.create.confirm": "Döret",
  "dialog.note.create.error.exists": "Bu atly bellik eýýäm bar.",
  "dialog.file.rename.title": "Faýlyň adyny üýtget",
  "dialog.file.rename.name.label": "Täze at",
  "dialog.file.rename.confirm": "Adyny üýtgetmek",
  "dialog.file.rename.error.exists": "Bu atly faýl eýýäm bar.",
  "dialog.file.delete.title": "Faýly poz",
  "dialog.file.delete.description": "“{{name}}” faýlyny pozmak isleýändigiňize ynanýarsyňyzmy? Bu hereketi yzyna gaýtaryp bolmaz.",
  "dialog.file.delete.confirm": "Poz",
  "dialog.file.create.title": "Täze faýl",
  "dialog.file.create.name.label": "Faýlyň ady",
  "dialog.file.create.name.placeholder": "mysal.md",
  "dialog.file.create.confirm": "Döret",
  "dialog.file.create.error.exists": "Bu atly faýl eýýäm bar.",
  "dialog.directory.create.title": "Täze bukja",
  "dialog.directory.create.name.label": "Bukjanyň ady",
  "dialog.directory.create.name.placeholder": "Meniň bukjam",
  "dialog.directory.create.confirm": "Döret",
  "dialog.directory.create.error.exists": "Bu atly bukja eýýäm bar.",
  "dialog.directory.create.defaultName": "Täze bukja",
  "dialog.directory.rename.title": "Bukjanyň adyny üýtget",
  "dialog.directory.delete.title": "Bukjany poz",
  "dialog.directory.delete.description": "“{{name}}” bukjasy we onuň ähli mazmuny pozulsynmy? Bu hereketi yzyna gaýtaryp bolmaz.",
  "dialog.directory.delete.confirm": "Poz",
  "fileTree.action.rename": "Adyny üýtgetmek",
  "fileTree.action.delete": "Poz",
  "fileTree.action.newFile": "Täze faýl",
  "fileTree.action.newDirectory": "Täze bukja",
  "fileTree.action.newSubDirectory": "Täze kiçi bukja",
  "toast.file.rename.failed.title": "Faýlyň ady üýtgedilip bilinmedi",
  "toast.file.delete.failed.title": "Faýl pozulyp bilinmedi",
  "toast.file.create.failed.title": "Faýl döredilip bilinmedi",
  "toast.directory.create.failed.title": "Bukja döredilip bilinmedi",
  "toast.directory.delete.failed.title": "Bukja pozulyp bilinmedi",
  "toast.directory.rename.failed.title": "Bukjanyň ady üýtgedilip bilinmedi",
  "settings.general.section.voice": "Ses",
  "settings.general.voice.deepgramKey.title": "Deepgram API açary",
  "settings.general.voice.deepgramKey.description": "Soragdaky diktowkany ýazga geçirmek üçin Deepgram ulanyň.",
  "settings.general.voice.deepgramKey.placeholder": "Deepgram açaryny goýuň",
  "settings.general.voice.language.title": "Sesiň dili",
  "settings.general.voice.language.description": "Ýazga geçirmek üçin ulanylýan Deepgram dil kody.",
  "settings.general.voice.model.title": "Ses modeli",
  "settings.general.voice.model.description": "Ýazga geçirmek üçin ulanylýan Deepgram modeli.",
  "settings.general.section.support": "Ýalňyşlyk barada habar ber",
  "settings.support.row.bugEmail.title": "E-poçta arkaly",
  "settings.support.row.bugEmail.description": "Gurnama maglumatlaryňyz bilen Prisme toparyna habar iberiň.",
  "settings.support.row.bugEmail.action": "E-poçta ýaz",
  "settings.support.row.bugIssue.title": "GitHub-da",
  "settings.support.row.bugIssue.description": "Öňünden doldurylan GitHub formasyny açyň (GitHub hasaby gerek).",
  "settings.support.row.bugIssue.action": "GitHub-y aç",
  "voice.action.start": "Diktowkany başlat",
  "voice.action.stop": "Diktowkany duruz",
  "voice.state.recording": "Ýazga alynýar",
  "voice.error.missingKey.title": "Deepgram açary gerek",
  "voice.error.missingKey.description": "Ses girişini ulanmak üçin sazlamalarda Deepgram API açaryňyzy goşuň.",
  "voice.error.connection.title": "Ses baglanyşygy başartmady",
  "voice.error.connection.description": "Deepgram bilen baglanyşyk kesildi.",
  "voice.error.microphone.title": "Mikrofon elýeterli däl",
  "voice.error.microphone.description": "Prisme mikrofonyňyza girip bilmedi.",
}
