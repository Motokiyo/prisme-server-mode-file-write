export const dict = {
  ...
  "toast.file.notFound.title": "Fail tidak dijumpai",
  "notes.empty.title": "Tiada nota dibuka",
  "notes.empty.description": "Pilih fail dalam penjelajah atau cipta nota Markdown.",
  "notes.empty.create": "Cipta nota",
  "notes.create.prompt": "Nama nota",
  "notes.create.defaultName": "Nota tanpa tajuk",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Cipta nota",
  "dialog.note.create.name.label": "Nama nota",
  "dialog.note.create.name.placeholder": "Idea saya",
  "dialog.note.create.confirm": "Cipta",
  "dialog.note.create.error.exists": "Nota dengan nama ini sudah wujud.",
  "dialog.file.rename.title": "Tukar nama fail",
  "dialog.file.rename.name.label": "Nama baharu",
  "dialog.file.rename.confirm": "Tukar nama",
  "dialog.file.rename.error.exists": "Fail dengan nama ini sudah wujud.",
  "dialog.file.delete.title": "Padam fail",
  "dialog.file.delete.description": "Adakah anda pasti mahu memadam “{{name}}”? Tindakan ini tidak boleh dibatalkan.",
  "dialog.file.delete.confirm": "Padam",
  "dialog.file.create.title": "Fail baharu",
  "dialog.file.create.name.label": "Nama fail",
  "dialog.file.create.name.placeholder": "contoh.md",
  "dialog.file.create.confirm": "Cipta",
  "dialog.file.create.error.exists": "Fail dengan nama ini sudah wujud.",
  "dialog.directory.create.title": "Folder baharu",
  "dialog.directory.create.name.label": "Nama folder",
  "dialog.directory.create.name.placeholder": "Folder saya",
  "dialog.directory.create.confirm": "Cipta",
  "dialog.directory.create.error.exists": "Folder dengan nama ini sudah wujud.",
  "dialog.directory.create.defaultName": "Folder baharu",
  "dialog.directory.rename.title": "Tukar nama folder",
  "dialog.directory.delete.title": "Padam folder",
  "dialog.directory.delete.description": "Padam “{{name}}” dan semua kandungannya? Tindakan ini tidak boleh dibatalkan.",
  "dialog.directory.delete.confirm": "Padam",
  "fileTree.action.rename": "Tukar nama",
  "fileTree.action.delete": "Padam",
  "fileTree.action.newFile": "Fail baharu",
  "fileTree.action.newDirectory": "Folder baharu",
  "fileTree.action.newSubDirectory": "Subfolder baharu",
  "toast.file.rename.failed.title": "Gagal menukar nama fail",
  "toast.file.delete.failed.title": "Gagal memadam fail",
  "toast.file.create.failed.title": "Gagal mencipta fail",
  "toast.directory.create.failed.title": "Gagal mencipta folder",
  "toast.directory.delete.failed.title": "Gagal memadam folder",
  "toast.directory.rename.failed.title": "Gagal menukar nama folder",
  "settings.general.section.voice": "Suara",
  "settings.general.voice.deepgramKey.title": "Kunci API Deepgram",
  "settings.general.voice.deepgramKey.description": "Gunakan Deepgram untuk mentranskripsi imlak pada gesaan.",
  "settings.general.voice.deepgramKey.placeholder": "Tampal kunci Deepgram",
  "settings.general.voice.language.title": "Bahasa suara",
  "settings.general.voice.language.description": "Kod bahasa Deepgram yang digunakan untuk transkripsi.",
  "settings.general.voice.model.title": "Model suara",
  "settings.general.voice.model.description": "Model Deepgram yang digunakan untuk transkripsi.",
  "settings.general.section.support": "Laporkan pepijat",
  "settings.support.row.bugEmail.title": "Melalui e-mel",
  "settings.support.row.bugEmail.description": "Hantar mesej kepada pasukan Prisme berserta maklumat pemasangan anda.",
  "settings.support.row.bugEmail.action": "Karang e-mel",
  "settings.support.row.bugIssue.title": "Di GitHub",
  "settings.support.row.bugIssue.description": "Buka borang GitHub yang telah diisi (akaun GitHub diperlukan).",
  "settings.support.row.bugIssue.action": "Buka GitHub",
  "voice.action.start": "Mula imlak",
  "voice.action.stop": "Henti imlak",
  "voice.state.recording": "Merakam",
  "voice.error.missingKey.title": "Kunci Deepgram diperlukan",
  "voice.error.missingKey.description": "Tambah kunci API Deepgram anda dalam Tetapan untuk menggunakan input suara.",
  "voice.error.connection.title": "Sambungan suara gagal",
  "voice.error.connection.description": "Sambungan ke Deepgram telah terputus.",
  "voice.error.microphone.title": "Mikrofon tidak tersedia",
  "voice.error.microphone.description": "Prisme tidak dapat mengakses mikrofon anda.",
}
