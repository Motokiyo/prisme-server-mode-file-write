export const dict = {
  ...
  "toast.file.notFound.title": "Файл не знайдено",
  "notes.empty.title": "Немає відкритих нотаток",
  "notes.empty.description": "Виберіть файл у провіднику або створіть нотатку у форматі Markdown.",
  "notes.empty.create": "Створити нотатку",
  "notes.create.prompt": "Назва нотатки",
  "notes.create.defaultName": "Нотатка без назви",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Створити нотатку",
  "dialog.note.create.name.label": "Назва нотатки",
  "dialog.note.create.name.placeholder": "Мої ідеї",
  "dialog.note.create.confirm": "Створити",
  "dialog.note.create.error.exists": "Нотатка з такою назвою вже існує.",
  "dialog.file.rename.title": "Перейменувати файл",
  "dialog.file.rename.name.label": "Нова назва",
  "dialog.file.rename.confirm": "Перейменувати",
  "dialog.file.rename.error.exists": "Файл з такою назвою вже існує.",
  "dialog.file.delete.title": "Видалити файл",
  "dialog.file.delete.description": "Ви впевнені, що хочете видалити «{{name}}»? Цю дію неможливо скасувати.",
  "dialog.file.delete.confirm": "Видалити",
  "dialog.file.create.title": "Новий файл",
  "dialog.file.create.name.label": "Назва файлу",
  "dialog.file.create.name.placeholder": "pryklad.md",
  "dialog.file.create.confirm": "Створити",
  "dialog.file.create.error.exists": "Файл з такою назвою вже існує.",
  "dialog.directory.create.title": "Нова папка",
  "dialog.directory.create.name.label": "Назва папки",
  "dialog.directory.create.name.placeholder": "Моя папка",
  "dialog.directory.create.confirm": "Створити",
  "dialog.directory.create.error.exists": "Папка з такою назвою вже існує.",
  "dialog.directory.create.defaultName": "Нова папка",
  "dialog.directory.rename.title": "Перейменувати папку",
  "dialog.directory.delete.title": "Видалити папку",
  "dialog.directory.delete.description": "Видалити «{{name}}» і весь її вміст? Цю дію неможливо скасувати.",
  "dialog.directory.delete.confirm": "Видалити",
  "fileTree.action.rename": "Перейменувати",
  "fileTree.action.delete": "Видалити",
  "fileTree.action.newFile": "Новий файл",
  "fileTree.action.newDirectory": "Нова папка",
  "fileTree.action.newSubDirectory": "Нова вкладена папка",
  "toast.file.rename.failed.title": "Не вдалося перейменувати файл",
  "toast.file.delete.failed.title": "Не вдалося видалити файл",
  "toast.file.create.failed.title": "Не вдалося створити файл",
  "toast.directory.create.failed.title": "Не вдалося створити папку",
  "toast.directory.delete.failed.title": "Не вдалося видалити папку",
  "toast.directory.rename.failed.title": "Не вдалося перейменувати папку",
  "settings.general.section.voice": "Голос",
  "settings.general.voice.deepgramKey.title": "API-ключ Deepgram",
  "settings.general.voice.deepgramKey.description": "Використовувати Deepgram для розшифрування диктування в запиті.",
  "settings.general.voice.deepgramKey.placeholder": "Вставте ключ Deepgram",
  "settings.general.voice.language.title": "Мова голосу",
  "settings.general.voice.language.description": "Код мови Deepgram, що використовується для розшифрування.",
  "settings.general.voice.model.title": "Голосова модель",
  "settings.general.voice.model.description": "Модель Deepgram, що використовується для розшифрування.",
  "settings.general.section.support": "Повідомити про помилку",
  "settings.support.row.bugEmail.title": "Електронною поштою",
  "settings.support.row.bugEmail.description": "Надішліть команді Prisme повідомлення з даними про вашу інсталяцію.",
  "settings.support.row.bugEmail.action": "Написати лист",
  "settings.support.row.bugIssue.title": "На GitHub",
  "settings.support.row.bugIssue.description": "Відкрити попередньо заповнену форму на GitHub (потрібен обліковий запис GitHub).",
  "settings.support.row.bugIssue.action": "Відкрити GitHub",
  "voice.action.start": "Почати диктування",
  "voice.action.stop": "Зупинити диктування",
  "voice.state.recording": "Триває запис",
  "voice.error.missingKey.title": "Потрібен ключ Deepgram",
  "voice.error.missingKey.description": "Додайте свій API-ключ Deepgram у налаштуваннях, щоб використовувати голосове введення.",
  "voice.error.connection.title": "Не вдалося встановити голосове з'єднання",
  "voice.error.connection.description": "З'єднання з Deepgram було перервано.",
  "voice.error.microphone.title": "Мікрофон недоступний",
  "voice.error.microphone.description": "Prisme не вдалося отримати доступ до мікрофона.",
}
