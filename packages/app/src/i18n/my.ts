export const dict = {
  ...
  "toast.file.notFound.title": "ဖိုင်ကို ရှာမတွေ့ပါ",
  "notes.empty.title": "ဖွင့်ထားသော မှတ်စုမရှိပါ",
  "notes.empty.description": "ရှာဖွေရေးမှ ဖိုင်တစ်ခုကို ရွေးပါ သို့မဟုတ် Markdown မှတ်စုတစ်ခု ဖန်တီးပါ။",
  "notes.empty.create": "မှတ်စု ဖန်တီးရန်",
  "notes.create.prompt": "မှတ်စုအမည်",
  "notes.create.defaultName": "အမည်မဲ့ မှတ်စု",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "မှတ်စု ဖန်တီးရန်",
  "dialog.note.create.name.label": "မှတ်စုအမည်",
  "dialog.note.create.name.placeholder": "ကျွန်ုပ်၏ အကြံဉာဏ်များ",
  "dialog.note.create.confirm": "ဖန်တီးရန်",
  "dialog.note.create.error.exists": "ဤအမည်ဖြင့် မှတ်စုတစ်ခု ရှိပြီးဖြစ်သည်။",
  "dialog.file.rename.title": "ဖိုင်အမည်ပြောင်းရန်",
  "dialog.file.rename.name.label": "အမည်သစ်",
  "dialog.file.rename.confirm": "အမည်ပြောင်း",
  "dialog.file.rename.error.exists": "ဤအမည်ဖြင့် ဖိုင်တစ်ခု ရှိပြီးဖြစ်သည်။",
  "dialog.file.delete.title": "ဖိုင်ဖျက်ရန်",
  "dialog.file.delete.description": "“{{name}}” ကို ဖျက်ရန် သေချာပါသလား။ ဤလုပ်ဆောင်ချက်ကို ပြန်ဖျက်၍မရပါ။",
  "dialog.file.delete.confirm": "ဖျက်ပါ",
  "dialog.file.create.title": "ဖိုင်အသစ်",
  "dialog.file.create.name.label": "ဖိုင်အမည်",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "ဖန်တီးရန်",
  "dialog.file.create.error.exists": "ဤအမည်ဖြင့် ဖိုင်တစ်ခု ရှိပြီးဖြစ်သည်။",
  "dialog.directory.create.title": "ဖိုင်တွဲအသစ်",
  "dialog.directory.create.name.label": "ဖိုင်တွဲအမည်",
  "dialog.directory.create.name.placeholder": "ကျွန်ုပ်၏ ဖိုင်တွဲ",
  "dialog.directory.create.confirm": "ဖန်တီးရန်",
  "dialog.directory.create.error.exists": "ဤအမည်ဖြင့် ဖိုင်တွဲတစ်ခု ရှိပြီးဖြစ်သည်။",
  "dialog.directory.create.defaultName": "ဖိုင်တွဲအသစ်",
  "dialog.directory.rename.title": "ဖိုင်တွဲအမည်ပြောင်းရန်",
  "dialog.directory.delete.title": "ဖိုင်တွဲဖျက်ရန်",
  "dialog.directory.delete.description": "“{{name}}” နှင့် ၎င်း၏ အကြောင်းအရာအားလုံးကို ဖျက်မလား။ ဤလုပ်ဆောင်ချက်ကို ပြန်ဖျက်၍မရပါ။",
  "dialog.directory.delete.confirm": "ဖျက်ပါ",
  "fileTree.action.rename": "အမည်ပြောင်း",
  "fileTree.action.delete": "ဖျက်ပါ",
  "fileTree.action.newFile": "ဖိုင်အသစ်",
  "fileTree.action.newDirectory": "ဖိုင်တွဲအသစ်",
  "fileTree.action.newSubDirectory": "ဖိုင်တွဲခွဲအသစ်",
  "toast.file.rename.failed.title": "ဖိုင်အမည်ပြောင်းခြင်း မအောင်မြင်ပါ",
  "toast.file.delete.failed.title": "ဖိုင်ဖျက်ခြင်း မအောင်မြင်ပါ",
  "toast.file.create.failed.title": "ဖိုင်ဖန်တီးခြင်း မအောင်မြင်ပါ",
  "toast.directory.create.failed.title": "ဖိုင်တွဲဖန်တီးခြင်း မအောင်မြင်ပါ",
  "toast.directory.delete.failed.title": "ဖိုင်တွဲဖျက်ခြင်း မအောင်မြင်ပါ",
  "toast.directory.rename.failed.title": "ဖိုင်တွဲအမည်ပြောင်းခြင်း မအောင်မြင်ပါ",
  "settings.general.section.voice": "အသံ",
  "settings.general.voice.deepgramKey.title": "Deepgram API သော့",
  "settings.general.voice.deepgramKey.description": "ညွှန်ကြားချက်တွင် ပြောသည်များကို စာသားအဖြစ် ပြောင်းရန် Deepgram ကို အသုံးပြုပါ။",
  "settings.general.voice.deepgramKey.placeholder": "Deepgram သော့ကို ကူးထည့်ပါ",
  "settings.general.voice.language.title": "အသံဘာသာစကား",
  "settings.general.voice.language.description": "စာသားပြောင်းရန် အသုံးပြုသည့် Deepgram ဘာသာစကားကုဒ်။",
  "settings.general.voice.model.title": "အသံမော်ဒယ်",
  "settings.general.voice.model.description": "စာသားပြောင်းရန် အသုံးပြုသည့် Deepgram မော်ဒယ်။",
  "settings.general.section.support": "ချွတ်ယွင်းချက် တင်ပြရန်",
  "settings.support.row.bugEmail.title": "အီးမေးလ်ဖြင့်",
  "settings.support.row.bugEmail.description": "သင်၏ တပ်ဆင်မှုအချက်အလက်နှင့်အတူ Prisme အဖွဲ့ထံ စာပို့ပါ။",
  "settings.support.row.bugEmail.action": "အီးမေးလ် ရေးရန်",
  "settings.support.row.bugIssue.title": "GitHub တွင်",
  "settings.support.row.bugIssue.description": "ကြိုတင်ဖြည့်ထားသော GitHub ပုံစံကို ဖွင့်ပါ (GitHub အကောင့် လိုအပ်သည်)။",
  "settings.support.row.bugIssue.action": "GitHub ဖွင့်ရန်",
  "voice.action.start": "အသံဖြင့် ရိုက်ထည့်ခြင်း စတင်ရန်",
  "voice.action.stop": "အသံဖြင့် ရိုက်ထည့်ခြင်း ရပ်ရန်",
  "voice.state.recording": "အသံဖမ်းနေသည်",
  "voice.error.missingKey.title": "Deepgram သော့ လိုအပ်သည်",
  "voice.error.missingKey.description": "အသံဖြင့် ထည့်သွင်းရန် ဆက်တင်များတွင် သင်၏ Deepgram API သော့ကို ထည့်ပါ။",
  "voice.error.connection.title": "အသံချိတ်ဆက်မှု မအောင်မြင်ပါ",
  "voice.error.connection.description": "Deepgram နှင့် ချိတ်ဆက်မှု ပြတ်တောက်သွားသည်။",
  "voice.error.microphone.title": "မိုက်ခရိုဖုန်း မရရှိနိုင်ပါ",
  "voice.error.microphone.description": "Prisme သည် သင်၏ မိုက်ခရိုဖုန်းကို အသုံးပြု၍မရပါ။",
}
