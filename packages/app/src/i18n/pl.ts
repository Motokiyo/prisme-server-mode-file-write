export const dict = {
  ...
  "toast.file.notFound.title": "Nie znaleziono pliku",
  "notes.empty.title": "Nie otwarto żadnej notatki",
  "notes.empty.description": "Wybierz plik w eksploratorze lub utwórz notatkę Markdown.",
  "notes.empty.create": "Utwórz notatkę",
  "notes.create.prompt": "Nazwa notatki",
  "notes.create.defaultName": "Notatka bez tytułu",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Utwórz notatkę",
  "dialog.note.create.name.label": "Nazwa notatki",
  "dialog.note.create.name.placeholder": "Moje pomysły",
  "dialog.note.create.confirm": "Utwórz",
  "dialog.note.create.error.exists": "Notatka o tej nazwie już istnieje.",
  "dialog.file.rename.title": "Zmień nazwę pliku",
  "dialog.file.rename.name.label": "Nowa nazwa",
  "dialog.file.rename.confirm": "Zmień nazwę",
  "dialog.file.rename.error.exists": "Plik o tej nazwie już istnieje.",
  "dialog.file.delete.title": "Usuń plik",
  "dialog.file.delete.description": "Czy na pewno chcesz usunąć „{{name}}”? Tej operacji nie można cofnąć.",
  "dialog.file.delete.confirm": "Usuń",
  "dialog.file.create.title": "Nowy plik",
  "dialog.file.create.name.label": "Nazwa pliku",
  "dialog.file.create.name.placeholder": "przyklad.md",
  "dialog.file.create.confirm": "Utwórz",
  "dialog.file.create.error.exists": "Plik o tej nazwie już istnieje.",
  "dialog.directory.create.title": "Nowy folder",
  "dialog.directory.create.name.label": "Nazwa folderu",
  "dialog.directory.create.name.placeholder": "Mój folder",
  "dialog.directory.create.confirm": "Utwórz",
  "dialog.directory.create.error.exists": "Folder o tej nazwie już istnieje.",
  "dialog.directory.create.defaultName": "Nowy folder",
  "dialog.directory.rename.title": "Zmień nazwę folderu",
  "dialog.directory.delete.title": "Usuń folder",
  "dialog.directory.delete.description": "Usunąć „{{name}}” i całą jego zawartość? Tej operacji nie można cofnąć.",
  "dialog.directory.delete.confirm": "Usuń",
  "fileTree.action.rename": "Zmień nazwę",
  "fileTree.action.delete": "Usuń",
  "fileTree.action.newFile": "Nowy plik",
  "fileTree.action.newDirectory": "Nowy folder",
  "fileTree.action.newSubDirectory": "Nowy podfolder",
  "toast.file.rename.failed.title": "Nie udało się zmienić nazwy pliku",
  "toast.file.delete.failed.title": "Nie udało się usunąć pliku",
  "toast.file.create.failed.title": "Nie udało się utworzyć pliku",
  "toast.directory.create.failed.title": "Nie udało się utworzyć folderu",
  "toast.directory.delete.failed.title": "Nie udało się usunąć folderu",
  "toast.directory.rename.failed.title": "Nie udało się zmienić nazwy folderu",
  "settings.general.section.voice": "Głos",
  "settings.general.voice.deepgramKey.title": "Klucz API Deepgram",
  "settings.general.voice.deepgramKey.description": "Użyj Deepgram do transkrypcji dyktowania w polu promptu.",
  "settings.general.voice.deepgramKey.placeholder": "Wklej klucz Deepgram",
  "settings.general.voice.language.title": "Język głosu",
  "settings.general.voice.language.description": "Kod języka Deepgram używany do transkrypcji.",
  "settings.general.voice.model.title": "Model głosu",
  "settings.general.voice.model.description": "Model Deepgram używany do transkrypcji.",
  "settings.general.section.support": "Zgłoś błąd",
  "settings.support.row.bugEmail.title": "E-mailem",
  "settings.support.row.bugEmail.description": "Wyślij wiadomość do zespołu Prisme wraz z informacjami o swojej instalacji.",
  "settings.support.row.bugEmail.action": "Napisz e-mail",
  "settings.support.row.bugIssue.title": "Na GitHubie",
  "settings.support.row.bugIssue.description": "Otwórz wstępnie wypełniony formularz GitHub (wymagane konto GitHub).",
  "settings.support.row.bugIssue.action": "Otwórz GitHub",
  "voice.action.start": "Rozpocznij dyktowanie",
  "voice.action.stop": "Zatrzymaj dyktowanie",
  "voice.state.recording": "Nagrywanie",
  "voice.error.missingKey.title": "Wymagany klucz Deepgram",
  "voice.error.missingKey.description": "Dodaj swój klucz API Deepgram w ustawieniach, aby korzystać z wprowadzania głosowego.",
  "voice.error.connection.title": "Połączenie głosowe nie powiodło się",
  "voice.error.connection.description": "Połączenie z Deepgram zostało przerwane.",
  "voice.error.microphone.title": "Mikrofon niedostępny",
  "voice.error.microphone.description": "Prisme nie mógł uzyskać dostępu do mikrofonu.",
}
