export const dict = {
  ...
  "toast.file.notFound.title": "ფაილი ვერ მოიძებნა",
  "notes.empty.title": "გახსნილი შენიშვნა არ არის",
  "notes.empty.description": "აირჩიეთ ფაილი მკვლევარიდან ან შექმენით Markdown შენიშვნა.",
  "notes.empty.create": "შენიშვნის შექმნა",
  "notes.create.prompt": "შენიშვნის სახელი",
  "notes.create.defaultName": "უსათაურო შენიშვნა",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "შენიშვნის შექმნა",
  "dialog.note.create.name.label": "შენიშვნის სახელი",
  "dialog.note.create.name.placeholder": "ჩემი იდეები",
  "dialog.note.create.confirm": "შექმნა",
  "dialog.note.create.error.exists": "ამ სახელით შენიშვნა უკვე არსებობს.",
  "dialog.file.rename.title": "ფაილის გადარქმევა",
  "dialog.file.rename.name.label": "ახალი სახელი",
  "dialog.file.rename.confirm": "გადარქმევა",
  "dialog.file.rename.error.exists": "ამ სახელით ფაილი უკვე არსებობს.",
  "dialog.file.delete.title": "ფაილის წაშლა",
  "dialog.file.delete.description": "დარწმუნებული ხართ, რომ გსურთ „{{name}}“-ის წაშლა? ამ მოქმედების გაუქმება შეუძლებელია.",
  "dialog.file.delete.confirm": "წაშლა",
  "dialog.file.create.title": "ახალი ფაილი",
  "dialog.file.create.name.label": "ფაილის სახელი",
  "dialog.file.create.name.placeholder": "magaliti.md",
  "dialog.file.create.confirm": "შექმნა",
  "dialog.file.create.error.exists": "ამ სახელით ფაილი უკვე არსებობს.",
  "dialog.directory.create.title": "ახალი საქაღალდე",
  "dialog.directory.create.name.label": "საქაღალდის სახელი",
  "dialog.directory.create.name.placeholder": "ჩემი საქაღალდე",
  "dialog.directory.create.confirm": "შექმნა",
  "dialog.directory.create.error.exists": "ამ სახელით საქაღალდე უკვე არსებობს.",
  "dialog.directory.create.defaultName": "ახალი საქაღალდე",
  "dialog.directory.rename.title": "საქაღალდის გადარქმევა",
  "dialog.directory.delete.title": "საქაღალდის წაშლა",
  "dialog.directory.delete.description": "წაიშალოს „{{name}}“ და მისი მთელი შიგთავსი? ამ მოქმედების გაუქმება შეუძლებელია.",
  "dialog.directory.delete.confirm": "წაშლა",
  "fileTree.action.rename": "გადარქმევა",
  "fileTree.action.delete": "წაშლა",
  "fileTree.action.newFile": "ახალი ფაილი",
  "fileTree.action.newDirectory": "ახალი საქაღალდე",
  "fileTree.action.newSubDirectory": "ახალი ქვესაქაღალდე",
  "toast.file.rename.failed.title": "ფაილის გადარქმევა ვერ მოხერხდა",
  "toast.file.delete.failed.title": "ფაილის წაშლა ვერ მოხერხდა",
  "toast.file.create.failed.title": "ფაილის შექმნა ვერ მოხერხდა",
  "toast.directory.create.failed.title": "საქაღალდის შექმნა ვერ მოხერხდა",
  "toast.directory.delete.failed.title": "საქაღალდის წაშლა ვერ მოხერხდა",
  "toast.directory.rename.failed.title": "საქაღალდის გადარქმევა ვერ მოხერხდა",
  "settings.general.section.voice": "ხმა",
  "settings.general.voice.deepgramKey.title": "Deepgram API გასაღები",
  "settings.general.voice.deepgramKey.description": "გამოიყენეთ Deepgram მოთხოვნის ველში ნაკარნახევის ტექსტად გადასაყვანად.",
  "settings.general.voice.deepgramKey.placeholder": "ჩასვით Deepgram გასაღები",
  "settings.general.voice.language.title": "ხმის ენა",
  "settings.general.voice.language.description": "ტრანსკრიფციისთვის გამოყენებული Deepgram ენის კოდი.",
  "settings.general.voice.model.title": "ხმის მოდელი",
  "settings.general.voice.model.description": "ტრანსკრიფციისთვის გამოყენებული Deepgram მოდელი.",
  "settings.general.section.support": "შეცდომის შეტყობინება",
  "settings.support.row.bugEmail.title": "ელფოსტით",
  "settings.support.row.bugEmail.description": "გაუგზავნეთ Prisme-ის გუნდს შეტყობინება თქვენი ინსტალაციის ინფორმაციით.",
  "settings.support.row.bugEmail.action": "ელფოსტის დაწერა",
  "settings.support.row.bugIssue.title": "GitHub-ზე",
  "settings.support.row.bugIssue.description": "გახსენით წინასწარ შევსებული GitHub ფორმა (საჭიროა GitHub ანგარიში).",
  "settings.support.row.bugIssue.action": "GitHub-ის გახსნა",
  "voice.action.start": "კარნახის დაწყება",
  "voice.action.stop": "კარნახის შეჩერება",
  "voice.state.recording": "მიმდინარეობს ჩაწერა",
  "voice.error.missingKey.title": "საჭიროა Deepgram გასაღები",
  "voice.error.missingKey.description": "ხმოვანი შეყვანის გამოსაყენებლად დაამატეთ თქვენი Deepgram API გასაღები პარამეტრებში.",
  "voice.error.connection.title": "ხმოვანი კავშირი ვერ დამყარდა",
  "voice.error.connection.description": "Deepgram-თან კავშირი შეწყდა.",
  "voice.error.microphone.title": "მიკროფონი მიუწვდომელია",
  "voice.error.microphone.description": "Prisme-მა ვერ შეძლო თქვენს მიკროფონზე წვდომა.",
}
