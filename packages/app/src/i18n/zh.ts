...
export const dict = {
  ...
  "toast.file.notFound.title": "未找到文件",
  "notes.empty.title": "未打开任何笔记",
  "notes.empty.description": "在资源管理器中选择文件，或创建一个 Markdown 笔记。",
  "notes.empty.create": "创建笔记",
  "notes.create.prompt": "笔记名称",
  "notes.create.defaultName": "未命名笔记",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "创建笔记",
  "dialog.note.create.name.label": "笔记名称",
  "dialog.note.create.name.placeholder": "我的想法",
  "dialog.note.create.confirm": "创建",
  "dialog.note.create.error.exists": "已存在同名笔记。",
  "dialog.file.rename.title": "重命名文件",
  "dialog.file.rename.name.label": "新名称",
  "dialog.file.rename.confirm": "重命名",
  "dialog.file.rename.error.exists": "已存在同名文件。",
  "dialog.file.delete.title": "删除文件",
  "dialog.file.delete.description": "确定要删除“{{name}}”吗？此操作无法撤消。",
  "dialog.file.delete.confirm": "删除",
  "dialog.file.create.title": "新建文件",
  "dialog.file.create.name.label": "文件名",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "创建",
  "dialog.file.create.error.exists": "已存在同名文件。",
  "dialog.directory.create.title": "新建文件夹",
  "dialog.directory.create.name.label": "文件夹名称",
  "dialog.directory.create.name.placeholder": "我的文件夹",
  "dialog.directory.create.confirm": "创建",
  "dialog.directory.create.error.exists": "已存在同名文件夹。",
  "dialog.directory.create.defaultName": "新建文件夹",
  "dialog.directory.rename.title": "重命名文件夹",
  "dialog.directory.delete.title": "删除文件夹",
  "dialog.directory.delete.description": "删除“{{name}}”及其全部内容？此操作无法撤消。",
  "dialog.directory.delete.confirm": "删除",
  "fileTree.action.rename": "重命名",
  "fileTree.action.delete": "删除",
  "fileTree.action.newFile": "新建文件",
  "fileTree.action.newDirectory": "新建文件夹",
  "fileTree.action.newSubDirectory": "新建子文件夹",
  "toast.file.rename.failed.title": "重命名文件失败",
  "toast.file.delete.failed.title": "删除文件失败",
  "toast.file.create.failed.title": "创建文件失败",
  "toast.directory.create.failed.title": "创建文件夹失败",
  "toast.directory.delete.failed.title": "删除文件夹失败",
  "toast.directory.rename.failed.title": "重命名文件夹失败",
  "settings.general.section.voice": "语音",
  "settings.general.voice.deepgramKey.title": "Deepgram API 密钥",
  "settings.general.voice.deepgramKey.description": "使用 Deepgram 转写提示词中的口述内容。",
  "settings.general.voice.deepgramKey.placeholder": "粘贴 Deepgram 密钥",
  "settings.general.voice.language.title": "语音语言",
  "settings.general.voice.language.description": "用于转写的 Deepgram 语言代码。",
  "settings.general.voice.model.title": "语音模型",
  "settings.general.voice.model.description": "用于转写的 Deepgram 模型。",
  "settings.general.section.support": "反馈问题",
  "settings.support.row.bugEmail.title": "通过邮件",
  "settings.support.row.bugEmail.description": "向 Prisme 团队发送一条包含安装信息的消息。",
  "settings.support.row.bugEmail.action": "撰写邮件",
  "settings.support.row.bugIssue.title": "在 GitHub 上",
  "settings.support.row.bugIssue.description": "打开预填写的 GitHub 表单（需要 GitHub 账号）。",
  "settings.support.row.bugIssue.action": "打开 GitHub",
  "voice.action.start": "开始口述",
  "voice.action.stop": "停止口述",
  "voice.state.recording": "正在录音",
  "voice.error.missingKey.title": "需要 Deepgram 密钥",
  "voice.error.missingKey.description": "请在设置中添加你的 Deepgram API 密钥以使用语音输入。",
  "voice.error.connection.title": "语音连接失败",
  "voice.error.connection.description": "与 Deepgram 的连接已中断。",
  "voice.error.microphone.title": "麦克风不可用",
  "voice.error.microphone.description": "Prisme 无法访问你的麦克风。",
