export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Prisme",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Prisme. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja Prisme",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego Prisme CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
