export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Prisme",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Prisme، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق Prisme",
  ...
  "desktop.cli.error.sidecarMissing": "ملف Prisme CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
