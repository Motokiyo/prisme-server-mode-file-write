export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Prisme",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Prisme wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das Prisme CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
