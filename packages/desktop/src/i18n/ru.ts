export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию Prisme",
  ...
  "desktop.updater.downloaded.prompt": "Версия Prisme {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.menu.help.documentation": "Документация Prisme",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл Prisme CLI. Попробуйте переустановить настольное приложение.",
