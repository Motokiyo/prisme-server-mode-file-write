export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Prisme-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Prisme-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "Prisme Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka Prisme CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
