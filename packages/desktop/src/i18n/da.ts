export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Prisme",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Prisme er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.menu.help.documentation": "Prisme Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "Prisme CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
