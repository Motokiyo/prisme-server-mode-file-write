export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Prisme",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Prisme er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "Prisme Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Prisme CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
