export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Prisme",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Prisme. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de Prisme",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Prisme. Intenta reinstalar la aplicación de escritorio.",
