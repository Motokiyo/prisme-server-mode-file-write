export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Prisme を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Prisme のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.menu.help.documentation": "Prisme ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "Prisme CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
