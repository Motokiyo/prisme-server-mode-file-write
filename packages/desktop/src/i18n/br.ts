export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Prisme",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Prisme foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do Prisme",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Prisme está ausente. Tente reinstalar o aplicativo de desktop.",
