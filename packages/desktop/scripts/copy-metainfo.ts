...
const appId = channel === "prod" ? "ai.prisme.desktop" : `ai.prisme.desktop.${channel}`
const productName = channel === "prod" ? "Prisme" : `Prisme ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
